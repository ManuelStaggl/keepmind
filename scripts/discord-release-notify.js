...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/ManuelStaggl/keepmind';

  const payload = {
    embeds: [
      {
        title: `🚀 keepmind ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[keepmind on GitHub](https://github.com/ManuelStaggl/keepmind)',
            inline: true,
          },
        ],
        footer: {
          text: 'keepmind • Persistent memory for Claude Code',
        },
