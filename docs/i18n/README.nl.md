...
📚 **[Bekijk Volledige Documentatie](https://github.com/ManuelStaggl/keepmind)** - Bladeren op de officiële website

### Aan de Slag

- **[Installatiegids](https://github.com/ManuelStaggl/keepmind)** - Snel starten & geavanceerde installatie
- **[Gebruikersgids](https://github.com/ManuelStaggl/keepmind)** - Hoe keepmind automatisch werkt
- **[Zoektools](https://github.com/ManuelStaggl/keepmind)** - Bevraag je projectgeschiedenis met natuurlijke taal
- **[Bètafuncties](https://github.com/ManuelStaggl/keepmind)** - Probeer experimentele functies zoals Endless Mode

### Beste Praktijken

- **[Context Engineering](https://github.com/ManuelStaggl/keepmind)** - AI agent context optimalisatieprincipes
- **[Progressieve Onthulling](https://github.com/ManuelStaggl/keepmind)** - Filosofie achter keepmind's context priming strategie

### Architectuur

- **[Overzicht](https://github.com/ManuelStaggl/keepmind)** - Systeemcomponenten & gegevensstroom
- **[Architectuurevolutie](https://github.com/ManuelStaggl/keepmind)** - De reis van v3 naar v5
- **[Hooks Architectuur](https://github.com/ManuelStaggl/keepmind)** - Hoe keepmind lifecycle hooks gebruikt
- **[Hooks Referentie](https://github.com/ManuelStaggl/keepmind)** - 7 hook scripts uitgelegd
- **[Worker Service](https://github.com/ManuelStaggl/keepmind)** - HTTP API & Bun beheer
- **[Database](https://github.com/ManuelStaggl/keepmind)** - SQLite schema & FTS5 zoeken
- **[Zoekarchitectuur](https://github.com/ManuelStaggl/keepmind)** - Hybride zoeken met Chroma vector database

### Configuratie & Ontwikkeling

- **[Configuratie](https://github.com/ManuelStaggl/keepmind)** - Omgevingsvariabelen & instellingen
- **[Ontwikkeling](https://github.com/ManuelStaggl/keepmind)** - Bouwen, testen, bijdragen
- **[Probleemoplossing](https://github.com/ManuelStaggl/keepmind)** - Veelvoorkomende problemen & oplossingen
...
Zie [Architectuuroverzicht](https://github.com/ManuelStaggl/keepmind) voor details.

---

## mem-search Vaardigheid

keepmind biedt intelligent zoeken via de mem-search vaardigheid die automatisch wordt aangeroepen wanneer je vraagt over eerder werk:
...
Zie [Zoektools Gids](https://github.com/ManuelStaggl/keepmind) voor gedetailleerde voorbeelden.

---

## Bètafuncties

keepmind biedt een **bètakanaal** met experimentele functies zoals **Endless Mode** (biomimetische geheugenarchitectuur voor uitgebreide sessies). Schakel tussen stabiele en bètaversies vanuit de web viewer UI op http://localhost:37777 → Settings.

Zie **[Bètafuncties Documentatie](https://github.com/ManuelStaggl/keepmind)** voor details over Endless Mode en hoe je het kunt proberen.
...
Instellingen worden beheerd in `~/.keepmind/settings.json` (automatisch aangemaakt met standaardinstellingen bij eerste run). Configureer AI model, worker poort, data directory, logniveau en context injectie-instellingen.

Zie de **[Configuratiegids](https://github.com/ManuelStaggl/keepmind)** voor alle beschikbare instellingen en voorbeelden.

---

## Ontwikkeling

Zie de **[Ontwikkelingsgids](https://github.com/ManuelStaggl/keepmind)** voor bouwinstructies, testen en bijdrageworkflow.
...
Zie de **[Probleemoplossingsgids](https://github.com/ManuelStaggl/keepmind)** voor veelvoorkomende problemen en oplossingen.
...
Zie [Ontwikkelingsgids](https://github.com/ManuelStaggl/keepmind) voor bijdrageworkflow.
