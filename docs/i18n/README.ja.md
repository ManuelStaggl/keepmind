...
<p align="center">
  keepmindは、ツール使用の観察を自動的にキャプチャし、セマンティックサマリーを生成して将来のセッションで利用可能にすることで、セッション間のコンテキストをシームレスに保持します。これにより、Claudeはセッションが終了または再接続された後でも、プロジェクトに関する知識の連続性を維持できます。
</p>
...
📚 **[完全なドキュメントを見る](https://github.com/ManuelStaggl/keepmind)** - 公式ウェブサイトで閲覧

### はじめに

- **[インストールガイド](https://github.com/ManuelStaggl/keepmind)** - クイックスタートと高度なインストール
- **[使用ガイド](https://github.com/ManuelStaggl/keepmind)** - keepmindが自動的に動作する仕組み
- **[検索ツール](https://github.com/ManuelStaggl/keepmind)** - 自然言語でプロジェクト履歴をクエリ
- **[ベータ機能](https://github.com/ManuelStaggl/keepmind)** - Endless Modeなどの実験的機能を試す

### ベストプラクティス

- **[コンテキストエンジニアリング](https://github.com/ManuelStaggl/keepmind)** - AIエージェントのコンテキスト最適化原則
- **[プログレッシブディスクロージャー](https://github.com/ManuelStaggl/keepmind)** - keepmindのコンテキストプライミング戦略の背後にある哲学

### アーキテクチャ

- **[概要](https://github.com/ManuelStaggl/keepmind)** - システムコンポーネントとデータフロー
- **[アーキテクチャの進化](https://github.com/ManuelStaggl/keepmind)** - v3からv5への道のり
- **[フックアーキテクチャ](https://github.com/ManuelStaggl/keepmind)** - keepmindがライフサイクルフックを使用する方法
- **[フックリファレンス](https://github.com/ManuelStaggl/keepmind)** - 7つのフックスクリプトの説明
- **[ワーカーサービス](https://github.com/ManuelStaggl/keepmind)** - HTTP APIとBun管理
- **[データベース](https://github.com/ManuelStaggl/keepmind)** - SQLiteスキーマとFTS5検索
- **[検索アーキテクチャ](https://github.com/ManuelStaggl/keepmind)** - Chromaベクトルデータベースを使用したハイブリッド検索

### 設定と開発

- **[設定](https://github.com/ManuelStaggl/keepmind)** - 環境変数と設定
- **[開発](https://github.com/ManuelStaggl/keepmind)** - ビルド、テスト、コントリビューション
- **[トラブルシューティング](https://github.com/ManuelStaggl/keepmind)** - よくある問題と解決策
...
詳細は[アーキテクチャ概要](https://github.com/ManuelStaggl/keepmind)を参照してください。

---

## mem-searchスキル

keepmindは、過去の作業について尋ねると自動的に呼び出されるmem-searchスキルを通じてインテリジェント検索を提供します:
...
詳細な例は[検索ツールガイド](https://github.com/ManuelStaggl/keepmind)を参照してください。

---

## ベータ機能

keepmindは、**Endless Mode**(拡張セッション用の生体模倣メモリアーキテクチャ)などの実験的機能を備えた**ベータチャネル**を提供します。http://localhost:37777 → SettingsのWebビューアUIから安定版とベータ版を切り替えます。

Endless Modeと試用方法の詳細については、**[ベータ機能ドキュメント](https://github.com/ManuelStaggl/keepmind)** を参照してください。
...
設定は`~/.keepmind/settings.json`で管理されます(初回実行時にデフォルト値で自動作成)。AIモデル、ワーカーポート、データディレクトリ、ログレベル、コンテキスト注入設定を構成します。

利用可能なすべての設定と例については、**[設定ガイド](https://github.com/ManuelStaggl/keepmind)** を参照してください。

---

## 開発

ビルド手順、テスト、コントリビューションワークフローについては、**[開発ガイド](https://github.com/ManuelStaggl/keepmind)** を参照してください。
...
よくある問題と解決策については、**[トラブルシューティングガイド](https://github.com/ManuelStaggl/keepmind)** を参照してください。
...
コントリビューションワークフローについては[開発ガイド](https://github.com/ManuelStaggl/keepmind)を参照してください。
