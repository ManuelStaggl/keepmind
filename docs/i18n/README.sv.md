...
📚 **[Visa fullständig dokumentation](https://github.com/ManuelStaggl/keepmind)** - Bläddra på den officiella webbplatsen

### Komma igång

- **[Installationsguide](https://github.com/ManuelStaggl/keepmind)** - Snabbstart och avancerad installation
- **[Användarguide](https://github.com/ManuelStaggl/keepmind)** - Hur keepmind fungerar automatiskt
- **[Sökverktyg](https://github.com/ManuelStaggl/keepmind)** - Sök i din projekthistorik med naturligt språk
- **[Betafunktioner](https://github.com/ManuelStaggl/keepmind)** - Testa experimentella funktioner som Endless Mode

### Bästa praxis

- **[Context Engineering](https://github.com/ManuelStaggl/keepmind)** - Optimeringsmetoder för AI-agentkontext
- **[Progressiv visning](https://github.com/ManuelStaggl/keepmind)** - Filosofin bakom keepminds kontextpriming-strategi

### Arkitektur

- **[Översikt](https://github.com/ManuelStaggl/keepmind)** - Systemkomponenter och dataflöde
- **[Arkitekturutveckling](https://github.com/ManuelStaggl/keepmind)** - Resan från v3 till v5
- **[Hooks-arkitektur](https://github.com/ManuelStaggl/keepmind)** - Hur keepmind använder livscykelkrokar
- **[Hooks-referens](https://github.com/ManuelStaggl/keepmind)** - 7 hook-skript förklarade
- **[Worker Service](https://github.com/ManuelStaggl/keepmind)** - HTTP API och Bun-hantering
- **[Databas](https://github.com/ManuelStaggl/keepmind)** - SQLite-schema och FTS5-sökning
- **[Sökarkitektur](https://github.com/ManuelStaggl/keepmind)** - Hybridsökning med Chroma-vektordatabas

### Konfiguration och utveckling

- **[Konfiguration](https://github.com/ManuelStaggl/keepmind)** - Miljövariabler och inställningar
- **[Utveckling](https://github.com/ManuelStaggl/keepmind)** - Bygga, testa, bidra
- **[Felsökning](https://github.com/ManuelStaggl/keepmind)** - Vanliga problem och lösningar
...
Se [Arkitekturöversikt](https://github.com/ManuelStaggl/keepmind) för detaljer.

---

## mem-search-färdighet

keepmind tillhandahåller intelligent sökning genom mem-search-färdigheten som automatiskt aktiveras när du frågar om tidigare arbete:
...
Se [Sökverktygsguide](https://github.com/ManuelStaggl/keepmind) för detaljerade exempel.

---

## Betafunktioner

keepmind erbjuder en **betakanal** med experimentella funktioner som **Endless Mode** (biomimetisk minnesarkitektur för utökade sessioner). Växla mellan stabila och betaversioner från webbvy-gränssnittet på http://localhost:37777 → Settings.

Se **[Dokumentation för betafunktioner](https://github.com/ManuelStaggl/keepmind)** för detaljer om Endless Mode och hur du testar det.
...
Inställningar hanteras i `~/.keepmind/settings.json` (skapas automatiskt med standardvärden vid första körning). Konfigurera AI-modell, worker-port, datakatalog, loggnivå och kontextinjektionsinställningar.

Se **[Konfigurationsguide](https://github.com/ManuelStaggl/keepmind)** för alla tillgängliga inställningar och exempel.

---

## Utveckling

Se **[Utvecklingsguide](https://github.com/ManuelStaggl/keepmind)** för bygginstruktioner, testning och bidragsarbetsflöde.
...
Se **[Felsökningsguide](https://github.com/ManuelStaggl/keepmind)** för vanliga problem och lösningar.
...
Se [Utvecklingsguide](https://github.com/ManuelStaggl/keepmind) för bidragsarbetsflöde.
...
- **Problem**: [GitHub Issues](https://github.com/ManuelStaggl/keepmind/issues)
