...
📚 **[Voir la documentation complète](https://github.com/ManuelStaggl/keepmind)** - Parcourir sur le site officiel

### Pour commencer

- **[Guide d'installation](https://github.com/ManuelStaggl/keepmind)** - Démarrage rapide et installation avancée
- **[Guide d'utilisation](https://github.com/ManuelStaggl/keepmind)** - Comment keepmind fonctionne automatiquement
- **[Outils de recherche](https://github.com/ManuelStaggl/keepmind)** - Interrogez l'historique de votre projet en langage naturel
- **[Fonctionnalités bêta](https://github.com/ManuelStaggl/keepmind)** - Essayez des fonctionnalités expérimentales comme le mode Endless

### Bonnes pratiques

- **[Ingénierie du contexte](https://github.com/ManuelStaggl/keepmind)** - Principes d'optimisation du contexte pour les agents IA
- **[Divulgation progressive](https://github.com/ManuelStaggl/keepmind)** - Philosophie derrière la stratégie d'amorçage du contexte de keepmind

### Architecture

- **[Vue d'ensemble](https://github.com/ManuelStaggl/keepmind)** - Composants du système et flux de données
- **[Évolution de l'architecture](https://github.com/ManuelStaggl/keepmind)** - Le parcours de la v3 à la v5
- **[Architecture des hooks](https://github.com/ManuelStaggl/keepmind)** - Comment keepmind utilise les hooks de cycle de vie
- **[Référence des hooks](https://github.com/ManuelStaggl/keepmind)** - Explication des 7 scripts de hooks
- **[Service Worker](https://github.com/ManuelStaggl/keepmind)** - API HTTP et gestion Bun
- **[Base de données](https://github.com/ManuelStaggl/keepmind)** - Schéma SQLite et recherche FTS5
- **[Architecture de recherche](https://github.com/ManuelStaggl/keepmind)** - Recherche hybride avec la base de données vectorielle Chroma

### Configuration et développement

- **[Configuration](https://github.com/ManuelStaggl/keepmind)** - Variables d'environnement et paramètres
- **[Développement](https://github.com/ManuelStaggl/keepmind)** - Compilation, tests, contribution
- **[Dépannage](https://github.com/ManuelStaggl/keepmind)** - Problèmes courants et solutions
...
Voir [Vue d'ensemble de l'architecture](https://github.com/ManuelStaggl/keepmind) pour plus de détails.

---

## Compétence mem-search

keepmind fournit une recherche intelligente via la compétence mem-search qui s'invoque automatiquement lorsque vous posez des questions sur le travail passé :
...
Voir le [Guide des outils de recherche](https://github.com/ManuelStaggl/keepmind) pour des exemples détaillés.

---

## Fonctionnalités bêta

keepmind propose un **canal bêta** avec des fonctionnalités expérimentales comme le **mode Endless** (architecture de mémoire biomimétique pour les sessions étendues). Basculez entre les versions stables et bêta depuis l'interface web de visualisation à http://localhost:37777 → Paramètres.

Voir la **[Documentation des fonctionnalités bêta](https://github.com/ManuelStaggl/keepmind)** pour plus de détails sur le mode Endless et comment l'essayer.
...
Les paramètres sont gérés dans `~/.keepmind/settings.json` (créé automatiquement avec les valeurs par défaut au premier lancement). Configurez le modèle IA, le port du worker, le répertoire de données, le niveau de journalisation et les paramètres d'injection de contexte.

Voir le **[Guide de configuration](https://github.com/ManuelStaggl/keepmind)** pour tous les paramètres disponibles et des exemples.

---

## Développement

Voir le **[Guide de développement](https://github.com/ManuelStaggl/keepmind)** pour les instructions de compilation, les tests et le flux de contribution.
...
Voir le **[Guide de dépannage](https://github.com/ManuelStaggl/keepmind)** pour les problèmes courants et les solutions.
...
Voir le [Guide de développement](https://github.com/ManuelStaggl/keepmind) pour le flux de contribution.
