...
<p align="center">
  keepmind preserva el contexto sin interrupciones entre sesiones al capturar automáticamente observaciones de uso de herramientas, generar resúmenes semánticos y ponerlos a disposición de sesiones futuras. Esto permite a Claude mantener la continuidad del conocimiento sobre proyectos incluso después de que las sesiones terminen o se reconecten.
</p>
...
📚 **[Ver Documentación Completa](https://github.com/ManuelStaggl/keepmind)** - Navegar en el sitio web oficial

### Primeros Pasos

- **[Guía de Instalación](https://github.com/ManuelStaggl/keepmind)** - Inicio rápido e instalación avanzada
- **[Guía de Uso](https://github.com/ManuelStaggl/keepmind)** - Cómo funciona keepmind automáticamente
- **[Herramientas de Búsqueda](https://github.com/ManuelStaggl/keepmind)** - Consulta el historial de tu proyecto con lenguaje natural
- **[Características Beta](https://github.com/ManuelStaggl/keepmind)** - Prueba características experimentales como Endless Mode

### Mejores Prácticas

- **[Ingeniería de Contexto](https://github.com/ManuelStaggl/keepmind)** - Principios de optimización de contexto para agentes de IA
- **[Divulgación Progresiva](https://github.com/ManuelStaggl/keepmind)** - Filosofía detrás de la estrategia de preparación de contexto de keepmind

### Arquitectura

- **[Descripción General](https://github.com/ManuelStaggl/keepmind)** - Componentes del sistema y flujo de datos
- **[Evolución de la Arquitectura](https://github.com/ManuelStaggl/keepmind)** - El viaje de v3 a v5
- **[Arquitectura de Hooks](https://github.com/ManuelStaggl/keepmind)** - Cómo keepmind usa hooks de ciclo de vida
- **[Referencia de Hooks](https://github.com/ManuelStaggl/keepmind)** - 7 scripts de hooks explicados
- **[Servicio Worker](https://github.com/ManuelStaggl/keepmind)** - API HTTP y gestión de Bun
- **[Base de Datos](https://github.com/ManuelStaggl/keepmind)** - Esquema SQLite y búsqueda FTS5
- **[Arquitectura de Búsqueda](https://github.com/ManuelStaggl/keepmind)** - Búsqueda híbrida con base de datos vectorial Chroma

### Configuración y Desarrollo

- **[Configuración](https://github.com/ManuelStaggl/keepmind)** - Variables de entorno y ajustes
- **[Desarrollo](https://github.com/ManuelStaggl/keepmind)** - Compilación, pruebas y contribución
- **[Solución de Problemas](https://github.com/ManuelStaggl/keepmind)** - Problemas comunes y soluciones
...
Ver [Descripción General de la Arquitectura](https://github.com/ManuelStaggl/keepmind) para más detalles.

---

## Habilidad mem-search

keepmind proporciona búsqueda inteligente a través de la habilidad mem-search que se invoca automáticamente cuando preguntas sobre trabajo previo:
...
Ver [Guía de Herramientas de Búsqueda](https://github.com/ManuelStaggl/keepmind) para ejemplos detallados.

---

## Características Beta

keepmind ofrece un **canal beta** con características experimentales como **Endless Mode** (arquitectura de memoria biomimética para sesiones extendidas). Cambia entre versiones estables y beta desde la interfaz del visor web en http://localhost:37777 → Settings.

Ver **[Documentación de Características Beta](https://github.com/ManuelStaggl/keepmind)** para detalles sobre Endless Mode y cómo probarlo.
...
Los ajustes se gestionan en `~/.keepmind/settings.json` (se crea automáticamente con valores predeterminados en la primera ejecución). Configura el modelo de IA, puerto del worker, directorio de datos, nivel de registro y ajustes de inyección de contexto.

Ver la **[Guía de Configuración](https://github.com/ManuelStaggl/keepmind)** para todos los ajustes disponibles y ejemplos.

---

## Desarrollo

Ver la **[Guía de Desarrollo](https://github.com/ManuelStaggl/keepmind)** para instrucciones de compilación, pruebas y flujo de contribución.
...
Ver la **[Guía de Solución de Problemas](https://github.com/ManuelStaggl/keepmind)** para problemas comunes y soluciones.
...
Ver [Guía de Desarrollo](https://github.com/ManuelStaggl/keepmind) para el flujo de contribución.
...
- **Problemas**: [GitHub Issues](https://github.com/ManuelStaggl/keepmind/issues)
