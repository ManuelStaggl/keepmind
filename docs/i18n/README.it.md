...
📚 **[Visualizza Documentazione Completa](https://github.com/ManuelStaggl/keepmind)** - Sfoglia sul sito ufficiale

### Per Iniziare

- **[Guida all'Installazione](https://github.com/ManuelStaggl/keepmind)** - Avvio rapido e installazione avanzata
- **[Guida all'Uso](https://github.com/ManuelStaggl/keepmind)** - Come funziona automaticamente keepmind
- **[Strumenti di Ricerca](https://github.com/ManuelStaggl/keepmind)** - Interroga la cronologia del progetto con linguaggio naturale
- **[Funzionalità Beta](https://github.com/ManuelStaggl/keepmind)** - Prova funzionalità sperimentali come Endless Mode

### Best Practice

- **[Context Engineering](https://github.com/ManuelStaggl/keepmind)** - Principi di ottimizzazione del contesto per agenti AI
- **[Progressive Disclosure](https://github.com/ManuelStaggl/keepmind)** - Filosofia alla base della strategia di priming del contesto di keepmind

### Architettura

- **[Panoramica](https://github.com/ManuelStaggl/keepmind)** - Componenti del sistema e flusso dei dati
- **[Evoluzione dell'Architettura](https://github.com/ManuelStaggl/keepmind)** - Il percorso dalla v3 alla v5
- **[Architettura degli Hook](https://github.com/ManuelStaggl/keepmind)** - Come keepmind utilizza gli hook del ciclo di vita
- **[Riferimento Hook](https://github.com/ManuelStaggl/keepmind)** - Spiegazione dei 7 script hook
- **[Servizio Worker](https://github.com/ManuelStaggl/keepmind)** - API HTTP e gestione Bun
- **[Database](https://github.com/ManuelStaggl/keepmind)** - Schema SQLite e ricerca FTS5
- **[Architettura di Ricerca](https://github.com/ManuelStaggl/keepmind)** - Ricerca ibrida con database vettoriale Chroma

### Configurazione e Sviluppo

- **[Configurazione](https://github.com/ManuelStaggl/keepmind)** - Variabili d'ambiente e impostazioni
- **[Sviluppo](https://github.com/ManuelStaggl/keepmind)** - Build, test e flusso di contribuzione
- **[Risoluzione dei Problemi](https://github.com/ManuelStaggl/keepmind)** - Problemi comuni e soluzioni
...
Vedi [Panoramica dell'Architettura](https://github.com/ManuelStaggl/keepmind) per i dettagli.

---

## Skill mem-search

keepmind fornisce una ricerca intelligente tramite la skill mem-search che si attiva automaticamente quando chiedi del lavoro passato:
...
Vedi [Guida agli Strumenti di Ricerca](https://github.com/ManuelStaggl/keepmind) per esempi dettagliati.

---

## Funzionalità Beta

keepmind offre un **canale beta** con funzionalità sperimentali come **Endless Mode** (architettura di memoria biomimetica per sessioni estese). Passa dalla versione stabile a quella beta dall'interfaccia web viewer su http://localhost:37777 → Settings.

Vedi **[Documentazione delle Funzionalità Beta](https://github.com/ManuelStaggl/keepmind)** per dettagli su Endless Mode e come provarlo.
...
Le impostazioni sono gestite in `~/.keepmind/settings.json` (creato automaticamente con valori predefiniti alla prima esecuzione). Configura il modello AI, la porta del worker, la directory dei dati, il livello di log e le impostazioni di iniezione del contesto.

Vedi la **[Guida alla Configurazione](https://github.com/ManuelStaggl/keepmind)** per tutte le impostazioni disponibili ed esempi.

---

## Sviluppo

Vedi la **[Guida allo Sviluppo](https://github.com/ManuelStaggl/keepmind)** per le istruzioni di build, test e flusso di contribuzione.
...
Vedi la **[Guida alla Risoluzione dei Problemi](https://github.com/ManuelStaggl/keepmind)** per problemi comuni e soluzioni.
...
Vedi [Guida allo Sviluppo](https://github.com/ManuelStaggl/keepmind) per il flusso di contribuzione.
...
- **Problemi**: [GitHub Issues](https://github.com/ManuelStaggl/keepmind/issues)
