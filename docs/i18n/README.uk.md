...
<p align="center">
  keepmind безперешкодно зберігає контекст між сесіями, автоматично фіксуючи спостереження за використанням інструментів, генеруючи семантичні резюме та роблячи їх доступними для майбутніх сесій. Це дозволяє Claude підтримувати безперервність знань про проєкти навіть після завершення або повторного підключення сесій.
</p>
...
📚 **[Переглянути повну документацію](https://github.com/ManuelStaggl/keepmind)** - Переглянути на офіційному сайті

### Початок роботи

- **[Посібник з встановлення](https://github.com/ManuelStaggl/keepmind)** - Швидкий старт і розширене встановлення
- **[Посібник з використання](https://github.com/ManuelStaggl/keepmind)** - Як keepmind працює автоматично
- **[Інструменти пошуку](https://github.com/ManuelStaggl/keepmind)** - Запитуйте історію свого проєкту природною мовою
- **[Бета-функції](https://github.com/ManuelStaggl/keepmind)** - Спробуйте експериментальні функції, як-от режим Endless Mode

### Найкращі практики

- **[Інженерія контексту](https://github.com/ManuelStaggl/keepmind)** - Принципи оптимізації контексту AI-агента
- **[Прогресивне розкриття](https://github.com/ManuelStaggl/keepmind)** - Філософія стратегії підготовки контексту keepmind

### Архітектура

- **[Огляд](https://github.com/ManuelStaggl/keepmind)** - Компоненти системи та потік даних
- **[Еволюція архітектури](https://github.com/ManuelStaggl/keepmind)** - Шлях від v3 до v5
- **[Архітектура хуків](https://github.com/ManuelStaggl/keepmind)** - Як keepmind використовує хуки життєвого циклу
- **[Довідник хуків](https://github.com/ManuelStaggl/keepmind)** - Пояснення 7 скриптів хуків
- **[Сервіс воркера](https://github.com/ManuelStaggl/keepmind)** - HTTP API та управління Bun
- **[База даних](https://github.com/ManuelStaggl/keepmind)** - Схема SQLite та пошук FTS5
- **[Архітектура пошуку](https://github.com/ManuelStaggl/keepmind)** - Гібридний пошук з векторною базою даних Chroma

### Конфігурація та розробка

- **[Конфігурація](https://github.com/ManuelStaggl/keepmind)** - Змінні середовища та налаштування
- **[Розробка](https://github.com/ManuelStaggl/keepmind)** - Збірка, тестування, внесок
- **[Усунення несправностей](https://github.com/ManuelStaggl/keepmind)** - Поширені проблеми та рішення
...
Дивіться [Огляд архітектури](https://github.com/ManuelStaggl/keepmind) для деталей.

---

## Навичка mem-search

keepmind надає інтелектуальний пошук через навичку mem-search, яка автоматично викликається, коли ви запитуєте про минулу роботу:
...
Дивіться [Посібник з інструментів пошуку](https://github.com/ManuelStaggl/keepmind) для детальних прикладів.

---

## Бета-функції

keepmind пропонує **бета-канал** з експериментальними функціями, як-от **режим Endless Mode** (біоміметична архітектура пам'яті для тривалих сесій). Перемикайтеся між стабільною та бета-версіями з веб-інтерфейсу перегляду на http://localhost:37777 → Налаштування.

Дивіться **[Документацію бета-функцій](https://github.com/ManuelStaggl/keepmind)** для деталей про режим Endless Mode та як його спробувати.
...
Налаштування керуються в `~/.keepmind/settings.json` (автоматично створюється зі стандартними значеннями при першому запуску). Налаштуйте модель AI, порт воркера, каталог даних, рівень журналювання та параметри впровадження контексту.

Дивіться **[Посібник з конфігурації](https://github.com/ManuelStaggl/keepmind)** для всіх доступних налаштувань та прикладів.

---

## Розробка

Дивіться **[Посібник з розробки](https://github.com/ManuelStaggl/keepmind)** для інструкцій зі збірки, тестування та робочого процесу внеску.
...
Дивіться **[Посібник з усунення несправностей](https://github.com/ManuelStaggl/keepmind)** для поширених проблем та рішень.
...
Дивіться [Посібник з розробки](https://github.com/ManuelStaggl/keepmind) для робочого процесу внеску.
...
- **Проблеми**: [GitHub Issues](https://github.com/ManuelStaggl/keepmind/issues)
