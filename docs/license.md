...
keepmind is licensed under the Apache License 2.0.

The Apache-2.0 license applies to the open-source core, including the memory
engine, keepmind Server, CLI, SDKs, adapters, MCP tools, schemas, tests,
...
keepmind is intended to be embedded broadly inside developer tools, local
...
keepmind Server v0.1 does not ship hosted cloud, team sync, enterprise
