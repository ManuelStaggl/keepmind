...
description: "Learn how keepmind works automatically in the background"
---

# Getting Started with keepmind

## Automatic Operation

keepmind works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, keepmind captures it:
...
Context is stored in SQLite database at `~/.keepmind/keepmind.db`.
...
keepmind supports sessions that span multiple user prompts:
...
keepmind provides MCP tools for querying your project history. Simply ask naturally:
