...
description: "Use keepmind in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up keepmind in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
{
  "KEEPMIND_PROVIDER": "gemini",
  "KEEPMIND_GEMINI_API_KEY": "your-key",
  "KEEPMIND_GEMINI_MODEL": "gemini-2.5-flash"
}
```

## Rate Limiting

keepmind automatically handles rate limiting for free tier usage:
