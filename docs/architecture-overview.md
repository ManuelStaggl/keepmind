# keepmind Architecture Overview
...
+-----------------------------------------------------------+
|  Storage Layer                                            |
|  +-- SQLite (keepmind.db) -- structured data            |
...
|-------|---------|-------------|---------|
| Setup | version-check.js | Sub-100ms version-marker check; prompts `npx keepmind repair` on mismatch | 60s |
