...
The Worker Service is an Express HTTP server that handles all keepmind operations. It runs on port 37777 (configurable via `KEEPMIND_WORKER_PORT`) and is managed by PM2.
