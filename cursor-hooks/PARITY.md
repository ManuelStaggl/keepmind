# Feature Parity: keepmind Hooks vs Cursor Hooks

This document compares keepmind's Claude Code hooks with the Cursor hooks implementation to ensure feature parity.
...
**How it works**:
- Hook writes context to `.cursor/rules/keepmind-context.mdc`
...
### Tag Stripping
- **Claude Code**: Worker handles `<private>` and `<keepmind-context>` tags
...
**Overall**: The Cursor hooks implementation achieves **full functional parity** with keepmind's Claude Code hooks:
