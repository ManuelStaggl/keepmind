# keepmind for Cursor (No Claude Code Required)

> **Persistent AI Memory for Cursor - Zero Cost to Start**

## Overview

Use keepmind's persistent memory in Cursor without a Claude Code subscription. Choose between free-tier providers (Gemini, OpenRouter) or paid options.
...
**Why This Matters**: Every Cursor session starts fresh. keepmind bridges that gap - your AI agent builds cumulative knowledge about your codebase, decisions, and patterns over time.
...
Since you don't have Claude Code, you need to configure an AI provider for keepmind's summarization engine.
...
cat > ~/.keepmind/settings.json << 'EOF'
{
...
```bash
# From the keepmind repo directory (recommended - all projects)
...
- Visit https://github.com/ManuelStaggl/keepmind for full documentation
...
$settingsDir = "$env:USERPROFILE\.keepmind"
