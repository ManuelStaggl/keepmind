...
If you want to add custom instructions about keepmind (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/keepmind-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using keepmind memory system"
---

# Memory System Usage

You have access to keepmind, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/keepmind-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/keepmind-instructions.mdc` | MCP tool instructions | You (optional) |
