# Quick Start: keepmind + Cursor Integration

> **Give your Cursor AI persistent memory in under 5 minutes**

## What This Does

Connects keepmind to Cursor so that:
...
keepmind settings set KEEPMIND_PROVIDER gemini
keepmind settings set KEEPMIND_GEMINI_API_KEY your-api-key

# Option B: OpenRouter (free models available)
keepmind settings set KEEPMIND_PROVIDER openrouter
keepmind settings set KEEPMIND_OPENROUTER_API_KEY your-api-key
```
...
- keepmind provides search tools via MCP
...
- Check logs: `tail -f ~/.keepmind/logs/worker-$(date +%Y-%m-%d).log`
...
- Visit [the keepmind repo](https://github.com/ManuelStaggl/keepmind) for full feature set
