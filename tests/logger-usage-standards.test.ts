...
const EXCLUDED_PATTERNS = [
  ...
  /cli\/hook-client-entry\.ts$/,  // Hook-client process entry point (P1 slim hook path): console.error prints a usage message to a visible stderr right before process.exit(1) — own process, not a background service (mirrors transcript-watcher-entry)
