"use strict";var cs=Object.create;var le=Object.defineProperty;var us=Object.getOwnPropertyDescriptor;var ls=Object.getOwnPropertyNames;var ps=Object.getPrototypeOf,_s=Object.prototype.hasOwnProperty;var ms=(s,e)=>{for(var t in e)le(s,t,{get:e[t],enumerable:!0})},ut=(s,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ls(e))!_s.call(s,n)&&n!==t&&le(s,n,{get:()=>e[n],enumerable:!(r=us(e,n))||r.enumerable});return s};var J=(s,e,t)=>(t=s!=null?cs(ps(s)):{},ut(e||!s||!s.__esModule?le(t,"default",{value:s,enumerable:!0}):t,s)),Es=s=>ut(le({},"__esModule",{value:!0}),s);var Fn={};ms(Fn,{generateContext:()=>ds,generateContextWithStats:()=>dt});module.exports=Es(Fn);var os=J(require("path"),1),is=require("os"),as=require("fs");var _t=require("node:sqlite");function lt(s){return typeof s=="bigint"?Number(s):s}function gs(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)&&!(s instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(s))}function pt(s){return s===void 0?null:typeof s=="boolean"?s?1:0:s}function pe(s){let e=s;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&gs(e[0])){let t=e[0],r={};for(let n of Object.keys(t))r[n]=pt(t[n]);return[r]}return e.map(pt)}var we=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...pe(e))}get(...e){return this.stmt.get(...pe(e))??null}run(...e){let t=this.stmt.run(...pe(e));return{changes:lt(t.changes),lastInsertRowid:lt(t.lastInsertRowid)}}values(...e){return this.stmt.all(...pe(e)).map(r=>Object.values(r))}finalize(){}},Q=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let r=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new _t.DatabaseSync(n,{readOnly:r,allowExtension:!0}),!r&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new we(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let r=this.prepare(e);return this.queryCache.set(e,r),r}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let r=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;r?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,r?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,r?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var h=require("path"),Ke=require("os"),L=require("fs");var Tt=require("url");var mt="KEEPMIND_",Et="CLAUDE_MEM_";function gt(s){return s.startsWith(mt)?Et+s.slice(mt.length):null}function y(s,e=process.env){let t=e[s];if(t!==void 0)return t;let r=gt(s);return r?e[r]:void 0}function W(s,e){let t=e[s];if(t!==void 0)return t;let r=gt(s);return r?e[r]:void 0}function ft(s){return Object.keys(s).some(e=>e.startsWith(Et))}var w=require("fs"),Fe=require("path");var fs=null;function Ts(s){return(fs??process.stderr.write.bind(process.stderr))(s)}function ke(s){Ts(s)}var bs=14,$e=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))($e||{}),Ue=null,hs=6e4,Ss=500,z=new Map;function Ns(s,e){try{let t="";if(s){for(let r of Object.keys(s).sort())if(t+=`${r}=${String(s[r])};`,t.length>200)break}return e instanceof Error?t+=`E:${e.message}`:typeof e=="string"||typeof e=="number"||typeof e=="boolean"?t+=`D:${e}`:e&&(t+="D:obj"),t.slice(0,200)}catch{return""}}function Rs(s,e,t,r,n,o){let i=`${s}|${e}|${t}|${Ns(n,o)}`,a=z.get(i);if(a&&r-a.windowStartedAt<hs)return a.suppressed++,null;if(!a&&z.size>=Ss){let l=z.keys().next();l.done||z.delete(l.value)}let d=a?.suppressed??0,c=a?Math.round((r-a.windowStartedAt)/1e3):0;return z.set(i,{windowStartedAt:r,suppressed:0}),d>0?` (repeated ${d}\xD7 in the previous ${c}s)`:""}var je=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=B.logsDir();(0,w.existsSync)(e)||(0,w.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Fe.join)(e,`keepmind-${t}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let t=Date.now()-bs*24*60*60*1e3;for(let r of(0,w.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(r);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<t)try{(0,w.unlinkSync)((0,Fe.join)(e,r))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=B.settings();if((0,w.existsSync)(e)){let t=(0,w.readFileSync)(e,"utf-8"),n=(JSON.parse(t).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=$e[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let r=t;if(typeof t=="string")try{r=JSON.parse(t)}catch{r=t}if(e==="Bash"&&r.command)return`${e}(${r.command})`;if(r.file_path)return`${e}(${r.file_path})`;if(r.notebook_path)return`${e}(${r.notebook_path})`;if(e==="Glob"&&r.pattern)return`${e}(${r.pattern})`;if(e==="Grep"&&r.pattern)return`${e}(${r.pattern})`;if(r.url)return`${e}(${r.url})`;if(r.query)return`${e}(${r.query})`;if(e==="Task"){if(r.subagent_type)return`${e}(${r.subagent_type})`;if(r.description)return`${e}(${r.description})`}return e==="Skill"&&r.skill?`${e}(${r.skill})`:e==="LSP"&&r.operation?`${e}(${r.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${r}-${n} ${o}:${i}:${a}.${d}`}log(e,t,r,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let S=Rs(e,t,r,Date.now(),n,o);if(S===null)return;i=S}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=$e[e].padEnd(5),c=t.padEnd(6),l="";n?.correlationId?l=`[${n.correlationId}] `:n?.sessionId&&(l=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let m="";if(n){let{sessionId:S,memorySessionId:O,correlationId:T,...g}=n;Object.keys(g).length>0&&(m=` {${Object.entries(g).map(([P,R])=>`${P}=${R}`).join(", ")}}`)}let f=`[${a}] [${d}] [${c}] ${l}${r}${i}${m}${_}`;if(this.logFilePath)try{(0,w.appendFileSync)(this.logFilePath,f+`
`,"utf8")}catch(S){ke(`[LOGGER] Failed to write to log file: ${S instanceof Error?S.message:String(S)}
`)}else ke(f+`
...
`).map(r=>r.trim()).find(r=>r.length>0)??"Session checkpoint").replace(/^#+\s*/,"").replace(/^\*+\s*/,"").replace(/\*+$/,"").trim();return t?t.length>80?`${t.slice(0,80).trimEnd()}\u2026`:t:"Session checkpoint"}var Zs=/^0\d{3}$/,en=/^V-\d{4}$/;function tn(s){let e=s?`${s}.`:"";return`COALESCE(json_extract(${e}metadata, '$.record_id'), json_extract(${e}metadata, '$.vorgang_id'))`}var k=tn();function rn(s){let e=s.trim();return Zs.test(e)?"akte":en.test(e)?"vorgang":null}function Ft(s,e){if(s)try{if(JSON.parse(s)?.kind==="vorgang")return"vorgang"}catch{}return(e&&rn(e))==="vorgang"?"vorgang":"akte"}var $t="keepmind://curated/";var X="revised_by";function on(s,e){return{customTitle:s,platformSource:e?D(e):void 0}}var Se=class{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?Ve(e,this.redactOpts):e}rl(e){return this.redactEnabled?me(e,this.redactOpts):e}constructor(e=j){try{this.mq=fe();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=qe,this.redactEnabled=y("KEEPMIND_REDACT_SECRETS")!=="0"&&y("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof Q)this.db=e;else{e!==":memory:"&&ht(N);let t=e===j?ee():e;this.db=new Q(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns(),this.recomputeSubjectKeys(),this.addCuratedSourceColumns(),this.createDecisionEdgesTable()}createDecisionEdgesTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42),t=this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all();e&&t.length>0||(this.db.run(`
    ...
    `).all(He),t=[],r=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),r.has(i.project)||(r.add(i.project),t.push(i.project))}let o=vt(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let r=this.resolvePromptSessionDbId(e,t),n=r!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=r!==null?r:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,r,n){return Lt(this.db,e,he(t),r,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,r){let n=[e],o="";return r&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`,n.push(D(r))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,D(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}filterObservationIdsBySourceKind(e,t){let r=Be(te(t),"o");if(!r||e.length===0)return e;let n=this.db.prepare(`
      SELECT o.id FROM observations o
      WHERE o.id IN (SELECT value FROM json_each(?)) AND ${r.sql}
    `).all(JSON.stringify(e),r.param),o=new Set(n.map(i=>i.id));return e.filter(i=>o.has(i))}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:r="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:c,sourceKind:l}=t,_=r==="relevance",m=_?"":`ORDER BY o.created_at_epoch ${r==="date_asc"?"ASC":"DESC"}`,f=n&&!_?`LIMIT ${n}`:"",S=e.map(()=>"?").join(","),O=[...e],T=[];o&&(T.push("o.project = ?"),O.push(o)),i&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),O.push(D(i)));let g=Be(te(l),"o");if(g&&(T.push(g.sql),O.push(g.param)),a)if(Array.isArray(a)){let b=a.map(()=>"?").join(",");T.push(`o.type IN (${b})`),O.push(...a)}else T.push("o.type = ?"),O.push(a);if(d){let b=Array.isArray(d)?d:[d],H=b.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...b),T.push(`(${H.join(" OR ")})`)}if(c){let b=Array.isArray(c)?c:[c],H=b.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");b.forEach(ct=>{O.push(`%${ct}%`,`%${ct}%`)}),T.push(`(${H.join(" OR ")})`)}let v=T.length>0?`WHERE o.id IN (${S}) AND ${T.join(" AND ")}`:`WHERE o.id IN (${S})`,R=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${v}
      ${m}
      ${f}
    `).all(...O);if(!_)return R;let C=new Map(R.map(b=>[b.id,b])),I=e.map(b=>C.get(b)).filter(b=>!!b);return n?I.slice(0,n):I}getSummaryForSession(e,t){let r=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,r){let n=this.resolvePromptSessionDbId(e,r);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,r,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),l=r.source_kind==="curated",_=l&&r.type!==G,m=_?r.title:this.rt(r.title),f=_?r.subtitle:this.rt(r.subtitle),S=_?r.narrative:this.rt(r.narrative),O=_?r.facts:this.rl(r.facts),T=_?r.metadata??null:this.rt(r.metadata??null),g=Ge(e,m??null,S??null),v=Je({type:r.type,narrative:S,files_modified:r.files_modified}),P;if(this.mq.reconcile.enabled&&!l){let b=this.reconcileBeforeInsert(t,r.type,m??null,S??null);if(b.action==="NOOP"&&b.candidateId){let H=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(b.candidateId);if(H)return{id:H.id,createdAtEpoch:H.created_at_epoch}}else b.action==="UPDATE"&&(P=b.candidateId)}let C=this.db.prepare(`
    ...
    `).get(e,t,r.type,m,f,JSON.stringify(O),S,JSON.stringify(r.concepts),JSON.stringify(r.files_read),JSON.stringify(r.files_modified),n||null,o,r.agent_type??null,r.agent_id??null,g,c,d,a||null,T,v,d,be({title:m??null,facts:O,narrative:S??null}),r.source_kind??null,r.source_path??null,r.source_line??null,r.subject??null,r.last_verified_at??null);if(C)return P!==void 0&&this.mq.supersession.enabled&&this.supersedeObservation(P,C.id,d),{id:C.id,createdAtEpoch:C.created_at_epoch};let I=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,g);if(!I)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${g}`);return{id:I.id,createdAtEpoch:I.created_at_epoch}}storeSummary(e,t,r,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),l=this.db.prepare(`
    ...
    `).run(e,t,this.rt(r.request),this.rt(r.investigated),this.rt(r.learned),this.rt(r.completed),this.rt(r.next_steps),this.rt(r.notes),n||null,o,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,r,n,o,i=0,a,d){let c=a??Date.now(),l=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],f=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let T of r){let g=this.rt(T.title),v=this.rt(T.subtitle),P=this.rt(T.narrative),R=this.rl(T.facts),C=Ge(e,g??null,P??null),I=f.get(e,t,T.type,g,v,JSON.stringify(R),P,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,T.agent_type??null,T.agent_id??null,C,l,c,d||null,Je({type:T.type,narrative:P,files_modified:T.files_modified}),c,be({title:g??null,facts:R,narrative:P??null}));if(I){m.push(I.id);continue}let b=S.get(e,C);if(!b)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${C}`);m.push(b.id)}let O=null;if(n){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    `).run(o,d.id,e,G,d.id),u.info("DB","Saved session checkpoint",{id:d.id,project:e,title:i}),d}clearCheckpoint(e){let t=Date.now(),r=this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(COALESCE(metadata, '{}'), '$.checkpoint_cleared', 1)
       WHERE project = ? AND type = ? AND valid_to IS NULL
    `).run(t,e,G),n=Number(r.changes??0);return u.info("DB","Cleared session checkpoint(s)",{project:e,cleared:n}),{cleared:n}}getCuratedRecord(e,t,r={}){let n=r.includeClosed?"":"AND valid_to IS NULL",o=this.db.prepare(`
    ...
    `).all(..._);if(!a)return O;let T=new Map(O.map(v=>[v.id,v])),g=e.map(v=>T.get(v)).filter(v=>!!v);return n?g.slice(0,n):g}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:r="date_desc",limit:n,project:o,platformSource:i}=t,a=r==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${r==="date_asc"?"ASC":"DESC"}`,c=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),_=[...e],m=[];o&&(m.push("s.project = ?"),_.push(o)),i&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),_.push(D(i)));let f=m.length>0?`AND ${m.join(" AND ")}`:"",O=this.db.prepare(`
      ...
      ${d}
      ${c}
    `).all(..._);if(!a)return O;let T=new Map(O.map(g=>[g.id,g]));return e.map(g=>T.get(g)).filter(g=>!!g)}getTimelineAroundTimestamp(e,t=10,r=10,n,o){return this.getTimelineAroundObservation(null,e,t,r,n,o)}getTimelineAroundObservation(e,t,r=10,n=10,o,i){let a=i?D(i):void 0,d=(R,C)=>{let I=[],b=[];return o&&(I.push(`${R}.project = ?`),b.push(o)),a&&(I.push(`COALESCE(NULLIF(${C}.platform_source, ''), '${E}') = ?`),b.push(a)),{clause:I.length>0?`AND ${I.join(" AND ")}`:"",params:b}},c=d("o","src"),l=d("ss","src"),_=d("s","s"),m,f;if(e!==null){let R=`
    ...
    `,g=this.db.prepare(S).all(m,f,...c.params),v=this.db.prepare(O).all(m,f,...l.params),P=this.db.prepare(T).all(m,f,..._.params);return{observations:g,sessions:v.map(R=>({id:R.id,memory_session_id:R.memory_session_id,project:R.project,request:R.request,completed:R.completed,next_steps:R.next_steps,created_at:R.created_at,created_at_epoch:R.created_at_epoch})),prompts:P.map(R=>({id:R.id,content_session_id:R.content_session_id,prompt_number:R.prompt_number,prompt_text:R.prompt_text,project:R.project,platform_source:R.platform_source,created_at:R.created_at,created_at_epoch:R.created_at_epoch}))}}getPromptById(e){return this.db.prepare(`
      SELECT
        p.id,
...
`,"utf-8"),a;try{a=(0,A.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,A.openSync)(o,"w",a):(0,A.openSync)(o,"w");let c=0;for(;c<i.length;){let l=(0,A.writeSync)(d,i,c,i.length-c);if(l===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=l}if((0,A.fsyncSync)(d),(0,A.closeSync)(d),d=void 0,(0,A.renameSync)(o,t),!ln){let l;try{l=(0,A.openSync)(r,"r"),(0,A.fsyncSync)(l)}catch{}finally{if(l!==void 0)try{(0,A.closeSync)(l)}catch{}}}}catch(c){if(d!==void 0)try{(0,A.closeSync)(d)}catch{}try{(0,A.unlinkSync)(o)}catch{}throw c}}var Ie=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(Vt(ze.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,Oe.join)((0,qt.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_DECISION_CHECK_ENABLED:"true",KEEPMIND_DECISION_CHECK_MAX_ROWS:"3",KEEPMIND_CURATED_PROJECT:"",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_INJECT_SOURCE_KIND:"all",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:"",KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${y("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return y(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let r of Object.keys(this.DEFAULTS)){let n=this.envOverride(r);n!==void 0&&(t[r]=n)}return t}static toCanonicalKeys(e){let t={};for(let[r,n]of Object.entries(e)){if(!r.startsWith("CLAUDE_MEM_")){t[r]=n;continue}let o="KEEPMIND_"+r.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,F.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,Oe.dirname)(e);(0,F.existsSync)(d)||(0,F.mkdirSync)(d,{recursive:!0}),ne(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let r=(0,F.readFileSync)(e,"utf-8"),n=JSON.parse(r.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{ne(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=W(a,o);d!==void 0&&(i[a]=d)}if(ft(o))try{ne(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(r){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,r instanceof Error?r.message:String(r));let n=this.getAllDefaults();try{if((0,F.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,F.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}ne(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var oe=require("fs"),Ae=require("path");var M=class s{static instance=null;activeMode=null;modesDir;constructor(){let e=St(),t=y("KEEPMIND_MODES_DIR"),r=[...t?[t]:[],(0,Ae.join)(e,"modes"),(0,Ae.join)(e,"..","plugin","modes")],n=r.find(o=>(0,oe.existsSync)(o));this.modesDir=n||r[0]}static getInstance(){return s.instance||(s.instance=new s),s.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let r={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?r[n]=this.deepMerge(i,o):r[n]=o}return r}loadModeFile(e){let t=(0,Ae.join)(this.modesDir,`${e}.json`);if(!(0,oe.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let r=(0,oe.readFileSync)(t,"utf-8");return JSON.parse(r)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,u.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:r,overrideId:n}=t,o;try{o=this.loadMode(r)}catch(d){d instanceof Error?u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),u.debug("SYSTEM",`Loaded override file: ${n} for parent ${r}`)}catch(d){return d instanceof Error?u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{message:d.message}):u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return u.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${r}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,u.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${r} + ${n})`,void 0,{parent:r,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(r=>r.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(r=>r.id===e)?.work_emoji||"\u{1F4DD}"}};function Jt(){let s=B.settings(),e=Ie.loadFromFile(s),t=M.getInstance().getActiveMode(),r=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:r,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true",injectSourceKind:te(e.KEEPMIND_INJECT_SOURCE_KIND)}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},ye=4,Ze=1;function et(s){let e=(s.title?.length||0)+(s.subtitle?.length||0)+(s.narrative?.length||0)+JSON.stringify(s.facts||[]).length;return Math.ceil(e/ye)}function tt(s){let e=s.length,t=s.reduce((i,a)=>i+et(a),0),r=s.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=r-t,o=r>0?Math.round(n/r*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:r,savings:n,savingsPercent:o}}function _n(s){return M.getInstance().getWorkEmoji(s)}function ie(s,e){let t=et(s),r=s.discovery_tokens||0,n=_n(s.type),o=r>0?`${n} ${r.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:r,discoveryDisplay:o,workEmoji:n}}function De(s){return s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent}function mn(s){return gn(s)}var En=28;function gn(s){let e=(s.title?.length??8)+En;return Math.max(1,Math.ceil(e/ye))}function fn(s,e){if(!Number.isFinite(e)||e<=0)return s;let t=[],r=0;for(let n of s){let o=mn(n);r+o>e||(t.push(n),r+=o)}return t}function Qt(s,e){let t=e.now??Date.now(),r=s.map(i=>({o:i,score:Ot(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?r.slice(0,e.maxRows):r;return fn(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var zt=J(require("path"),1),Ce=require("fs");function Zt(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return s.db.prepare(`
  ...
  `).all(e,e,r??null,r??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function er(s,e,t,r){return s.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,r??null,r??null,t.sessionCount+Ze)}function tr(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return s.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
