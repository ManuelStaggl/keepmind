"use strict";var jt=Object.create;var j=Object.defineProperty;var Wt=Object.getOwnPropertyDescriptor;var Vt=Object.getOwnPropertyNames;var Yt=Object.getPrototypeOf,Kt=Object.prototype.hasOwnProperty;var qt=(r,e)=>{for(var t in e)j(r,t,{get:e[t],enumerable:!0})},be=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Vt(e))!Kt.call(r,n)&&n!==t&&j(r,n,{get:()=>e[n],enumerable:!(s=Wt(e,n))||s.enumerable});return r};var k=(r,e,t)=>(t=r!=null?jt(Yt(r)):{},be(e||!r||!r.__esModule?j(t,"default",{value:r,enumerable:!0}):t,r)),Jt=r=>be(j({},"__esModule",{value:!0}),r);var ys={};qt(ys,{generateContext:()=>Bt,generateContextWithStats:()=>Re});module.exports=Jt(ys);var Ht=k(require("path"),1),Xt=require("os"),Gt=require("fs");var Ae=require("node:sqlite");function Oe(r){return typeof r=="bigint"?Number(r):r}function Qt(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)&&!(r instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(r))}function he(r){return r===void 0?null:typeof r=="boolean"?r?1:0:r}function W(r){let e=r;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&Qt(e[0])){let t=e[0],s={};for(let n of Object.keys(t))s[n]=he(t[n]);return[s]}return e.map(he)}var re=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...W(e))}get(...e){return this.stmt.get(...W(e))??void 0}run(...e){let t=this.stmt.run(...W(e));return{changes:Oe(t.changes),lastInsertRowid:Oe(t.lastInsertRowid)}}values(...e){return this.stmt.all(...W(e)).map(s=>Object.values(s))}finalize(){}},w=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let s=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new Ae.DatabaseSync(n,{readOnly:s,allowExtension:!0}),!s&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new re(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let s=this.prepare(e);return this.queryCache.set(e,s),s}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let s=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;s?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,s?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,s?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var T=require("path"),de=require("os"),U=require("fs");var Ne=require("url");var y=require("fs"),Ie=require("path");var zt=null;function Zt(r){return(zt??process.stderr.write.bind(process.stderr))(r)}function ne(r){Zt(r)}var ie=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ie||{}),oe=null,ae=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=F.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ie.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=F.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ie[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let l="";if(n){let{sessionId:g,memorySessionId:A,correlationId:h,...f}=n;Object.keys(f).length>0&&(l=` {${Object.entries(f).map(([C,v])=>`${C}=${v}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${l}${m}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},E=new ae;var _s={};function es(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ne.fileURLToPath)(_s.url))}var ts=es();function ss(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,de.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,U.existsSync)(e)){let t=JSON.parse((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=ss(),x=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,de.homedir)(),".claude"),Hs=(0,T.join)(x,"plugins","marketplaces","thedotmack"),rs=(0,T.join)(O,"archives"),ns=(0,T.join)(O,"logs"),os=(0,T.join)(O,"trash"),is=(0,T.join)(O,"backups"),as=(0,T.join)(O,"modes"),Xs=(0,T.join)(O,"settings.json"),Ce=(0,T.join)(O,"claude-mem.db"),ds=(0,T.join)(O,"vector-db"),Le=(0,T.join)(O,"observer-sessions"),_e=(0,T.basename)(Le),Gs=(0,T.join)(x,"settings.json"),Bs=(0,T.join)(x,"commands"),js=(0,T.join)(x,"CLAUDE.md");function De(r){(0,U.mkdirSync)(r,{recursive:!0})}function Me(){return(0,T.join)(ts,"..")}var F={dataDir:()=>O,workerPid:()=>(0,T.join)(O,"worker.pid"),workerPort:()=>(0,T.join)(O,"worker.port"),serverPid:()=>(0,T.join)(O,".server-beta.pid"),serverPort:()=>(0,T.join)(O,".server-beta.port"),serverRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>(0,T.join)(O,"claude-mem.db"),chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,"supervisor.json"),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>ns,archives:()=>rs,trash:()=>os,backups:()=>is,modes:()=>as,vectorDb:()=>ds,observerSessions:()=>Le};var ye=require("crypto");function ue(r,e,t){return(0,ye.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var c="claude";function us(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function N(r){if(!r)return c;let e=us(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:c}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ue(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(a,t,o)??void 0}var we=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],xe=new RegExp(`<(${we.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Fe=/<system-reminder>[\s\S]*?<\/system-reminder>/g,ke=100;function Es(r){let e=Object.fromEntries(we.map(n=>[n,0]));xe.lastIndex=0;let t=0,s=r.replace(xe,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>ke&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:ke,contentLength:r.length}),{stripped:s.trim(),counts:e}}function Pe(r){return Es(r).stripped}var ms=["task-notification"],zs=new RegExp(`^\\s*<(${ms.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Zs=256*1024;var me=4e3;function V(r){let e=r.trim(),s=Pe(r).trim()||e;return s.length<=me?s:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:me}),`${s.slice(0,me-1)}\u2026`)}function ps(r,e){return{customTitle:r,platformSource:e?N(e):void 0}}var Y=class{db;constructor(e=Ce){e instanceof w?this.db=e:(e!==":memory:"&&De(O),this.db=new w(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?N(s):void 0;return n?this.db.prepare(`
    ...
    `).all(_e),t=[],s=new Set,n={};for(let i of e){let a=N(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=ve(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return Ue(this.db,e,V(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`,n.push(N(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,N(t))||null:this.db.prepare(`
      ...
      ${l}
      ${p}
    `).all(...A);if(!m)return C;let v=new Map(C.map(I=>[I.id,I])),R=e.map(I=>v.get(I)).filter(I=>!!I);return n?R.slice(0,n):R}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=ps(n,o),_=d.platformSource??c,m=V(s),l=this.db.prepare(`
    ...
    `).get(c,_,e);if(l)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,_,m,d.customTitle||null,i.toISOString(),a);return Number(p.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=V(s),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),A=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let S=ue(e,f.title,f.narrative),C=g.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,S,m,_,d||null);if(C){p.push(C.id);continue}let v=A.get(e,S);if(!v)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${S}`);p.push(v.id)}let h=null;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,_);h=Number(S.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("ss.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(N(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
      FROM session_summaries ss
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(C=>[C.id,C])),S=e.map(C=>f.get(C)).filter(C=>!!C);return n?S.slice(0,n):S}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("s.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(N(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?N(i):void 0,d=(R,I)=>{let b=[],L=[];return o&&(b.push(`${R}.project = ?`),L.push(o)),a&&(b.push(`COALESCE(NULLIF(${I}.platform_source, ''), '${c}') = ?`),L.push(a)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:L}},_=d("o","src"),m=d("ss","src"),l=d("s","s"),p,g;if(e!==null){let R=`
  ...
  `).all(e,e,s??null,s??null,...n,...i,t.totalObservationCount)}function Qe(r,e,t,s){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.sessionCount+le)}function ze(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function Mt(r,e,t,s){let n=[];return s?n.push(...gt(r)):n.push(...ot(r)),s?n.push(...St()):n.push(...it()),s&&(n.push(...ft()),n.push(...Rt())),z(t)&&(s?n.push(...bt(e,t)):n.push(...at(e,t))),n}var ge=k(require("path"),1);function se(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Se(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function fe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function vt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function yt(r,e){return ge.default.isAbsolute(r)?ge.default.relative(e,r):r}function Ut(r,e,t){let s=se(r);if(s.length>0)return yt(s[0],e);if(t){let n=se(t);if(n.length>0)return yt(n[0],e)}return"General"}function bs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=vt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function xt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?se(r.facts).join(`
`):null}function Os(r,e,t,s){let n=[];n.push(...dt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Se(a.displayTime);n.push(...mt(a,d))}else{let a=i.data,d=fe(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let p=xt(a,s);n.push(...Et(a,m,p,s))}else n.push(ut(a,m,s))}return n}function hs(r,e,t,s,n){let o=[];o.push(...Ot(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=Se(_.displayTime);o.push(...Nt(_,m))}else{let _=d.data,m=Ut(_.files_modified,n,_.files_read),l=fe(_.created_at),p=l!==a;a=l;let g=t.has(_.id);if(m!==i&&(o.push(...ht(m)),i=m),g){let A=xt(_,s);o.push(...It(_,l,p,A,s))}else o.push(At(_,l,p,s))}return o.push(""),o}function As(r,e,t,s,n,o){return o?hs(r,e,t,s,n):Os(r,e,t,s)}function kt(r,e,t,s,n){let o=[],i=bs(r);for(let[a,d]of i)o.push(...As(a,d,e,t,s,n));return o}function wt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ft(r,e){let t=[];return e?(t.push(...B("Investigated",r.investigated,u.blue)),t.push(...B("Learned",r.learned,u.yellow)),t.push(...B("Completed",r.completed,u.green)),t.push(...B("Next Steps",r.next_steps,u.magenta))):(t.push(...G("Investigated",r.investigated)),t.push(...G("Learned",r.learned)),t.push(...G("Completed",r.completed)),t.push(...G("Next Steps",r.next_steps))),t}function Pt(r,e){return e?Ct(r):pt(r)}function $t(r,e,t){return!z(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Lt(r.totalDiscoveryTokens,r.totalReadTokens):ct(r.totalDiscoveryTokens,r.totalReadTokens)}var Is=Ht.default.join((0,Xt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ns(){try{return new Y}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Gt.unlinkSync)(Is)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Cs(r,e){return e?Dt(r):lt(r)}function Ls(r,e,t,s,n,o,i){let a=[],d=Te(e);a.push(...Mt(r,d,s,i));let _=t.slice(0,s.sessionCount),m=tt(_,t),l=st(e,m),p=rt(e,s.fullObservationCount);a.push(...kt(l,p,s,n,i));let g=t[0],A=e[0];wt(s,g,A)&&a.push(...Ft(g,i));let h=et(e,s,o,n);return a.push(...Pt(h,i)),a.push(...$t(d,s,i)),a.join(`
`).trimEnd()}var Ds=new Set(["bugfix","discovery","decision","refactor"]);function Ms(r,e,t){let s=Te(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=Ds.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Re(r,e=!1){let t=Ve(),s=r?.cwd??process.cwd(),n=je(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Ns();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?N(r.platformSource):void 0,_=o.length>1?ze(a,o,t,d):Je(a,i,t,d),m=o.length>1?Ze(a,o,t,d):Qe(a,i,t,d);return _.length===0&&m.length===0?{text:Cs(i,e),stats:null}:{text:Ls(i,_,m,t,s,r?.session_id,e),stats:Ms(_,m,!!r?.full)}}finally{a.close()}}async function Bt(r,e=!1){return(await Re(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
