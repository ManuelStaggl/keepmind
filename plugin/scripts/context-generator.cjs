"use strict";var Ls=Object.create;var te=Object.defineProperty;var Ms=Object.getOwnPropertyDescriptor;var xs=Object.getOwnPropertyNames;var Ps=Object.getPrototypeOf,ws=Object.prototype.hasOwnProperty;var ks=(r,e)=>{for(var t in e)te(r,t,{get:e[t],enumerable:!0})},qe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of xs(e))!ws.call(r,n)&&n!==t&&te(r,n,{get:()=>e[n],enumerable:!(s=Ms(e,n))||s.enumerable});return r};var B=(r,e,t)=>(t=r!=null?Ls(Ps(r)):{},qe(e||!r||!r.__esModule?te(t,"default",{value:r,enumerable:!0}):t,r)),Us=r=>qe(te({},"__esModule",{value:!0}),r);var Jr={};ks(Jr,{generateContext:()=>Cs,generateContextWithStats:()=>Ye});module.exports=Us(Jr);var Ds=B(require("path"),1),ys=require("os"),vs=require("fs");var ze=require("node:sqlite");function Je(r){return typeof r=="bigint"?Number(r):r}function Fs(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)&&!(r instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(r))}function Qe(r){return r===void 0?null:typeof r=="boolean"?r?1:0:r}function se(r){let e=r;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&Fs(e[0])){let t=e[0],s={};for(let n of Object.keys(t))s[n]=Qe(t[n]);return[s]}return e.map(Qe)}var Re=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...se(e))}get(...e){return this.stmt.get(...se(e))??null}run(...e){let t=this.stmt.run(...se(e));return{changes:Je(t.changes),lastInsertRowid:Je(t.lastInsertRowid)}}values(...e){return this.stmt.all(...se(e)).map(s=>Object.values(s))}finalize(){}},K=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let s=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new ze.DatabaseSync(n,{readOnly:s,allowExtension:!0}),!s&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new Re(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let s=this.prepare(e);return this.queryCache.set(e,s),s}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let s=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;s?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,s?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,s?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var b=require("path"),ve=require("os"),L=require("fs");var rt=require("url");var Ze="KEEPMIND_",et="CLAUDE_MEM_";function tt(r){return r.startsWith(Ze)?et+r.slice(Ze.length):null}function C(r,e=process.env){let t=e[r];if(t!==void 0)return t;let s=tt(r);return s?e[s]:void 0}function re(r,e){let t=e[r];if(t!==void 0)return t;let s=tt(r);return s?e[s]:void 0}function st(r){return Object.keys(r).some(e=>e.startsWith(et))}var x=require("fs"),Ae=require("path");var $s=null;function js(r){return($s??process.stderr.write.bind(process.stderr))(r)}function Ie(r){js(r)}var Gs=14,De=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(De||{}),Oe=null,Hs=6e4,Bs=500,X=new Map;function Ks(r,e){try{let t="";if(r){for(let s of Object.keys(r).sort())if(t+=`${s}=${String(r[s])};`,t.length>200)break}return e instanceof Error?t+=`E:${e.message}`:typeof e=="string"||typeof e=="number"||typeof e=="boolean"?t+=`D:${e}`:e&&(t+="D:obj"),t.slice(0,200)}catch{return""}}function Xs(r,e,t,s,n,o){let i=`${r}|${e}|${t}|${Ks(n,o)}`,a=X.get(i);if(a&&s-a.windowStartedAt<Hs)return a.suppressed++,null;if(!a&&X.size>=Bs){let u=X.keys().next();u.done||X.delete(u.value)}let d=a?.suppressed??0,c=a?Math.round((s-a.windowStartedAt)/1e3):0;return X.set(i,{windowStartedAt:s,suppressed:0}),d>0?` (repeated ${d}\xD7 in the previous ${c}s)`:""}var ye=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=$.logsDir();(0,x.existsSync)(e)||(0,x.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ae.join)(e,`keepmind-${t}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let t=Date.now()-Gs*24*60*60*1e3;for(let s of(0,x.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(s);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<t)try{(0,x.unlinkSync)((0,Ae.join)(e,s))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=$.settings();if((0,x.existsSync)(e)){let t=(0,x.readFileSync)(e,"utf-8"),n=(JSON.parse(t).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=De[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let T=Xs(e,t,s,Date.now(),n,o);if(T===null)return;i=T}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=De[e].padEnd(5),c=t.padEnd(6),u="";n?.correlationId?u=`[${n.correlationId}] `:n?.sessionId&&(u=`[session-${n.sessionId}] `);let p="";if(o!=null)if(o instanceof Error)p=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{p=`
`+JSON.stringify(o,null,2)}catch{p=" "+this.formatData(o)}else p=" "+this.formatData(o);let E="";if(n){let{sessionId:T,memorySessionId:N,correlationId:I,...S}=n;Object.keys(S).length>0&&(E=` {${Object.entries(S).map(([P,f])=>`${P}=${f}`).join(", ")}}`)}let g=`[${a}] [${d}] [${c}] ${u}${s}${i}${E}${p}`;if(this.logFilePath)try{(0,x.appendFileSync)(this.logFilePath,g+`
`,"utf8")}catch(T){Ie(`[LOGGER] Failed to write to log file: ${T instanceof Error?T.message:String(T)}
`)}else Ie(g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",p={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),o}},l=new ye;var sr={};function Ws(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,rt.fileURLToPath)(sr.url))}var Vs=Ws();function Ys(){let r=C("KEEPMIND_DATA_DIR");if(r)return r;let e=(0,b.join)((0,ve.homedir)(),".keepmind"),t=(0,b.join)(e,"settings.json");try{if((0,L.existsSync)(t)){let s=JSON.parse((0,L.readFileSync)(t,"utf-8")),n=s.env??s,o=re("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var A=Ys(),j=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ve.homedir)(),".claude"),dn=(0,b.join)(j,"plugins","marketplaces","keepmind"),qs=(0,b.join)(A,"archives"),Js=(0,b.join)(A,"logs"),Qs=(0,b.join)(A,"trash"),zs=(0,b.join)(A,"backups"),Zs=(0,b.join)(A,"modes"),cn=(0,b.join)(A,"settings.json"),U=(0,b.join)(A,"keepmind.db"),W=(0,b.join)(A,"claude-mem.db"),er=(0,b.join)(A,"vector-db"),nt=(0,b.join)(A,"observer-sessions"),Ce=(0,b.basename)(nt),un=(0,b.join)(j,"settings.json"),ln=(0,b.join)(j,"commands"),_n=(0,b.join)(j,"CLAUDE.md");function ot(r){(0,L.mkdirSync)(r,{recursive:!0})}function tr(){try{if((0,L.existsSync)(U)||!(0,L.existsSync)(W))return(0,L.existsSync)(U);for(let r of["","-wal","-shm"]){let e=W+r,t=U+r;(0,L.existsSync)(e)&&!(0,L.existsSync)(t)&&(0,L.renameSync)(e,t)}return l.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:W,to:U}),!0}catch(r){return l.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},r instanceof Error?r:new Error(String(r))),!1}}function Le(){return tr(),!(0,L.existsSync)(U)&&(0,L.existsSync)(W)?W:U}function it(){return(0,b.join)(Vs,"..")}var $={dataDir:()=>A,workerPid:()=>(0,b.join)(A,"worker.pid"),workerPort:()=>(0,b.join)(A,"worker.port"),serverPid:()=>(0,b.join)(A,".server-beta.pid"),serverPort:()=>(0,b.join)(A,".server-beta.port"),serverRuntime:()=>(0,b.join)(A,".server-beta.runtime.json"),settings:()=>(0,b.join)(A,"settings.json"),database:()=>Le(),chroma:()=>(0,b.join)(A,"chroma"),combinedCerts:()=>(0,b.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(A,"transcript-watch-state.json"),corpora:()=>(0,b.join)(A,"corpora"),supervisorRegistry:()=>(0,b.join)(A,"supervisor.json"),envFile:()=>(0,b.join)(A,".env"),logsDir:()=>Js,archives:()=>qs,trash:()=>Qs,backups:()=>zs,modes:()=>Zs,vectorDb:()=>er,observerSessions:()=>nt};var at={injection:"injection_count",explicit_fetch:"explicit_fetch_count",fts:"fts_hit_count",vector:"vector_hit_count"};var dt=require("crypto");function Me(r,e,t){return(0,dt.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function xe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var Pe=r=>`\xABredacted:${r}\xBB`,rr=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:jdbc:[a-z0-9]{1,20}:)?(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|sqlserver|oracle|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"CREDENTIAL_ASSIGNMENT",re:/\b(?:password|pwd|passwd)\s{0,3}=\s{0,3}(?:"([^"\r\n]{1,200})"|'([^'\r\n]{1,200})'|([^;"'\r\n]{1,200}))/gi,group:1},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1},{type:"EMAIL",category:"pii",re:/\b[\w.+-]{1,64}@[\w-]{1,63}(?:\.[\w-]{1,63}){1,4}\b/g},{type:"IP_ADDRESS",category:"pii",re:/\b(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\b/g,keep:r=>r==="0.0.0.0"||r==="255.255.255.255"||r.startsWith("127.")}];function ct(r){return r.includes("redacted:")}function nr(r,e){if(e.re.lastIndex=0,e.group===void 0)return r.replace(e.re,s=>ct(s)||e.keep?.(s)?s:Pe(e.type));let t=e.group;return r.replace(e.re,(s,...n)=>{if(e.keep?.(s))return s;let o=s,i=!1;for(let a=t-1;a<n.length;a++){let d=n[a];typeof d!="string"||d.length===0||ct(d)||(o=o.replace(d,Pe(e.type)),i=!0)}return i?o:s})}function or(r){if(r.length===0)return 0;let e=new Map;for(let s of r)e.set(s,(e.get(s)??0)+1);let t=0;for(let s of e.values()){let n=s/r.length;t-=n*Math.log2(n)}return t}var ir=/^[0-9a-f]+$/i;function ar(r,e){return r.length<20||r.length>200||/[\s]/.test(r)||!/\d/.test(r)||!/[A-Za-z]/.test(r)||r.includes("/")||r.includes("\\")||r.length<=64&&ir.test(r)||r.includes("redacted:")?!1:or(r)>=e}var dr=/([\s"'`,;(){}\[\]<>]+)/;function cr(r,e){let t=r.split(dr);for(let s=0;s<t.length;s++){let n=t[s];n&&ar(n,e)&&(t[s]=Pe("HIGH_ENTROPY"))}return t.join("")}function we(r,e={}){if(typeof r!="string"||r.length===0)return r;try{let t=r,s=e.pii!==!1;for(let n of rr)n.category==="pii"&&!s||(t=nr(t,n));return e.entropySweep!==!1&&(t=cr(t,e.entropyThreshold??4)),t}catch{return r}}function ne(r,e={}){if(typeof r=="string")return we(r,e);if(Array.isArray(r))return r.map(t=>ne(t,e));if(r&&typeof r=="object"){let t={};for(let[s,n]of Object.entries(r))t[s]=ne(n,e);return t}return r}var ie=require("fs");var Ue={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0,pii:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},vectorRetention:{enabled:!0,inactiveDays:90},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function oe(r){return!!r&&typeof r=="object"&&!Array.isArray(r)}function F(r,e){if(!oe(e))return{...r};let t={...r};for(let s of Object.keys(r))e[s]!==void 0&&typeof e[s]==typeof r[s]&&(t[s]=e[s]);return t}var ke=null;function ae(r=!1){if(ke&&!r)return ke;let e=Ue,t;try{let i=$.settings();if((0,ie.existsSync)(i)){let a=JSON.parse((0,ie.readFileSync)(i,"utf-8").replace(/^﻿/,"")),d=oe(a)?a.memoryQuality??(oe(a.env)?a.env.memoryQuality:void 0):void 0;oe(d)&&(t=d)}}catch(i){l.debug("CONFIG","memoryQuality config load failed; using defaults",{},i instanceof Error?i:new Error(String(i)))}let s={redactSecrets:F(e.redactSecrets,t?.redactSecrets),scoping:F(e.scoping,t?.scoping),importance:F(e.importance,t?.importance),injection:F(e.injection,t?.injection),reconcile:F(e.reconcile,t?.reconcile),supersession:F(e.supersession,t?.supersession),expiry:F(e.expiry,t?.expiry),vectorRetention:F(e.vectorRetention,t?.vectorRetention),optimizer:F(e.optimizer,t?.optimizer)},n=C("KEEPMIND_REDACT_SECRETS");(n==="0"||n==="false")&&(s.redactSecrets.enabled=!1);let o=C("KEEPMIND_REDACT_PII");return(o==="0"||o==="false")&&(s.redactSecrets.pii=!1),ke=s,s}var ur={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function lr(r){if(Array.isArray(r))return r.length;if(typeof r=="string")try{let e=JSON.parse(r);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function Fe(r){let e=ur[r.type??"other"]??4;return lr(r.files_modified)>0&&(e+=1),(r.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(r.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var _r=14,pr=864e5;function ut(r,e={}){let t=e.now??Date.now(),s=(e.halfLifeDays??_r)*pr,n=(r.importance??5)/10,o=Math.max(0,t-(r.created_at_epoch??t)),i=Math.pow(.5,o/s);return n*i}function _t(r){return r.normalize("NFC").toLowerCase().replace(/ä/g,"ae").replace(/ö/g,"oe").replace(/ü/g,"ue").replace(/ß/g,"ss")}var Er=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will","der","die","das","den","dem","des","ein","eine","einen","einem","einer","eines","und","oder","aber","ist","sind","war","waren","wird","werden","wurde","wurden","hat","haben","hatte","hatten","f\xFCr","mit","von","vom","zu","zum","zur","im","auf","am","an","aus","bei","nach","\xFCber","unter","durch","gegen","ohne","um","als","wie","dass","sich","es","wir","man","auch","noch","nur","schon","dann","wenn","weil","damit","sowie","bereits"].map(_t));function de(r){return r?_t(r).replace(/[^\p{L}\p{N}\s]+/gu," ").split(/\s+/).filter(e=>e.length>0&&!Er.has(e)).join(" ").trim():""}function lt(r){let e=new Set,t=r.replace(/\s+/g," ");for(let s=0;s+3<=t.length;s++)e.add(t.slice(s,s+3));return e}function mr(r,e){let t=lt(r),s=lt(e);if(t.size===0&&s.size===0)return 1;if(t.size===0||s.size===0)return 0;let n=0;for(let o of t)s.has(o)&&n++;return n/(t.size+s.size-n)}function gr(r,e){let t=new Map,s=new Map;for(let a of r.split(" "))a&&t.set(a,(t.get(a)??0)+1);for(let a of e.split(" "))a&&s.set(a,(s.get(a)??0)+1);if(t.size===0||s.size===0)return 0;let n=0;for(let[a,d]of t)n+=d*(s.get(a)??0);let o=0;for(let a of t.values())o+=a*a;let i=0;for(let a of s.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function Tr(r,e){let t=de(`${r??""}`),s=de(`${e??""}`);return Math.max(mr(t,s),gr(t,s))}function pt(r,e,t){let s=`${r.title??""} ${r.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=Tr(s,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=t.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=t.updateBand&&t.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var Et=require("crypto");function ce(r){let e=r.title??"";if(!e){if(Array.isArray(r.facts)&&r.facts.length>0)e=r.facts[0];else if(typeof r.facts=="string")try{let s=JSON.parse(r.facts);Array.isArray(s)&&s.length>0&&(e=String(s[0]))}catch{}}e||(e=(r.narrative??"").slice(0,80));let t=de(e);return(0,Et.createHash)("sha1").update(t).digest("hex").slice(0,16)}var m="claude";function fr(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return m;let e=fr(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:m}function mt(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function gt(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,o)??void 0}var bt=["private","keepmind-context","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Tt=new RegExp(`<(${bt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),St=/<system-reminder>[\s\S]*?<\/system-reminder>/g,ft=100;function br(r){let e=Object.fromEntries(bt.map(n=>[n,0]));Tt.lastIndex=0;let t=0,s=r.replace(Tt,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>ft&&l.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:ft,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ht(r){return br(r).stripped}var Sr=["task-notification"],Ln=new RegExp(`^\\s*<(${Sr.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Mn=256*1024;var $e=4e3;function ue(r){let e=r.trim(),s=ht(r).trim()||e;return s.length<=$e?s:(l.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:$e}),`${s.slice(0,$e-1)}\u2026`)}var G="session-checkpoint";function Nt(r){let t=(r.split(`
`).map(s=>s.trim()).find(s=>s.length>0)??"Session checkpoint").replace(/^#+\s*/,"").replace(/^\*+\s*/,"").replace(/\*+$/,"").trim();return t?t.length>80?`${t.slice(0,80).trimEnd()}\u2026`:t:"Session checkpoint"}function Rr(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var le=class r{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?we(e,this.redactOpts):e}rl(e){return this.redactEnabled?ne(e,this.redactOpts):e}constructor(e=U){try{this.mq=ae();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=Ue,this.redactEnabled=C("KEEPMIND_REDACT_SECRETS")!=="0"&&C("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof K)this.db=e;else{e!==":memory:"&&ot(A);let t=e===U?Le():e;this.db=new K(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns(),this.recomputeSubjectKeys(),this.addCuratedSourceColumns(),this.createDecisionEdgesTable()}createDecisionEdgesTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42),t=this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all();e&&t.length>0||(this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?y(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[Ce];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(m,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(Ce),t=[],s=new Set,n={};for(let i of e){let a=y(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=mt(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return gt(this.db,e,ue(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${m}') = ?`,n.push(y(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,y(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:c}=t,u=s==="relevance",p=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n&&!u?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),T=[...e],N=[];if(o&&(N.push("o.project = ?"),T.push(o)),i&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${m}') = ?`),T.push(y(i))),a)if(Array.isArray(a)){let O=a.map(()=>"?").join(",");N.push(`o.type IN (${O})`),T.push(...a)}else N.push("o.type = ?"),T.push(a);if(d){let O=Array.isArray(d)?d:[d],h=O.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");T.push(...O),N.push(`(${h.join(" OR ")})`)}if(c){let O=Array.isArray(c)?c:[c],h=O.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");O.forEach(D=>{T.push(`%${D}%`,`%${D}%`)}),N.push(`(${h.join(" OR ")})`)}let I=N.length>0?`WHERE o.id IN (${g}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${g})`,v=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${I}
      ${p}
      ${E}
    `).all(...T);if(!u)return v;let P=new Map(v.map(O=>[O.id,O])),f=e.map(O=>P.get(O)).filter(O=>!!O);return n?f.slice(0,n):f}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(...s)||null}getFilesForSession(e){let s=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),n=new Set,o=new Set;for(let i of s)xe(i.files_read).forEach(a=>n.add(a)),xe(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(n),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Rr(n,o),c=d.platformSource??m,u=this.rt(ue(s)),p=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(m,c,e);if(p)return t&&this.db.prepare(`
          UPDATE sdk_sessions SET project = ?
          WHERE id = ? AND (project IS NULL OR project = '')
        `).run(t,p.id),d.customTitle&&this.db.prepare(`
          UPDATE sdk_sessions SET custom_title = ?
          WHERE id = ? AND custom_title IS NULL
        `).run(d.customTitle,p.id),p.id;let E=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,u,d.customTitle||null,i.toISOString(),a);return Number(E.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=this.rt(ue(s)),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),u=this.rt(s.title),p=this.rt(s.subtitle),E=this.rt(s.narrative),g=this.rl(s.facts),T=this.rt(s.metadata??null),N=Me(e,u??null,E??null),I=Fe({type:s.type,narrative:E,files_modified:s.files_modified}),S,v=s.source_kind==="curated";if(this.mq.reconcile.enabled&&!v){let h=this.reconcileBeforeInsert(t,s.type,u??null,E??null);if(h.action==="NOOP"&&h.candidateId){let D=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(h.candidateId);if(D)return{id:D.id,createdAtEpoch:D.created_at_epoch}}else h.action==="UPDATE"&&(S=h.candidateId)}let f=this.db.prepare(`
    ...
    `).get(e,t,s.type,u,p,JSON.stringify(g),E,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,N,c,d,a||null,T,I,d,ce({title:u??null,facts:g,narrative:E??null}),s.source_kind??null,s.source_path??null,s.source_line??null,s.subject??null,s.last_verified_at??null);if(f)return S!==void 0&&this.mq.supersession.enabled&&this.supersedeObservation(S,f.id,d),{id:f.id,createdAtEpoch:f.created_at_epoch};let O=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,N);if(!O)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${N}`);return{id:O.id,createdAtEpoch:O.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
    ...
    `).run(e,t,this.rt(s.request),this.rt(s.investigated),this.rt(s.learned),this.rt(s.completed),this.rt(s.next_steps),this.rt(s.notes),n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),T=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let I of s){let S=this.rt(I.title),v=this.rt(I.subtitle),P=this.rt(I.narrative),f=this.rl(I.facts),O=Me(e,S??null,P??null),h=g.get(e,t,I.type,S,v,JSON.stringify(f),P,JSON.stringify(I.concepts),JSON.stringify(I.files_read),JSON.stringify(I.files_modified),o||null,i,I.agent_type??null,I.agent_id??null,O,u,c,d||null,Fe({type:I.type,narrative:P,files_modified:I.files_modified}),c,ce({title:S??null,facts:f,narrative:P??null}));if(h){E.push(h.id);continue}let D=T.get(e,O);if(!D)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${O}`);E.push(D.id)}let N=null;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,this.rt(n.request),this.rt(n.investigated),this.rt(n.learned),this.rt(n.completed),this.rt(n.next_steps),this.rt(n.notes),o||null,i,u,c);N=Number(S.lastInsertRowid)}return{observationIds:E,summaryId:N,createdAtEpoch:c}})()}markObservationsUsed(e,t="explicit_fetch",s=Date.now()){if(e.length!==0)try{let n=this.db.query("PRAGMA table_info(observations)").all(),o=g=>n.some(T=>T.name===g),i=o("last_used_at"),a=o("relevance_count"),d=at[t],c=o(d);if(!i&&!a&&!c)return;let u=[],p=[];i&&(u.push("last_used_at = ?"),p.push(s)),a&&u.push("relevance_count = COALESCE(relevance_count, 0) + 1"),c&&u.push(`${d} = COALESCE(${d}, 0) + 1`);let E=e.map(()=>"?").join(",");this.db.prepare(`UPDATE observations SET ${u.join(", ")} WHERE id IN (${E})`).run(...p,...e)}catch(n){l.debug("DB","markObservationsUsed failed",{count:e.length,channel:t},n instanceof Error?n:new Error(String(n)))}}evaporateScratch(e){try{let t=this.db.prepare("DELETE FROM observations WHERE memory_session_id = ? AND type = 'scratch'").run(e),s=Number(t.changes??0);return s>0&&l.info("DB","Evaporated scratch observations at SessionEnd",{memorySessionId:e,count:s}),s}catch(t){return l.warn("DB","evaporateScratch failed",{memorySessionId:e},t instanceof Error?t:new Error(String(t))),0}}evaporateAllScratch(){try{let e=this.db.prepare("DELETE FROM observations WHERE type = 'scratch'").run(),t=Number(e.changes??0);return t>0&&l.info("DB","Evaporated all scratch observations on idle shutdown",{count:t}),t}catch(e){return l.warn("DB","evaporateAllScratch failed",{},e instanceof Error?e:new Error(String(e))),0}}reconcileBeforeInsert(e,t,s,n){try{let o=Date.now()-7776e6,i=this.db.query("PRAGMA table_info(observations)").all().some(p=>p.name==="valid_to"),a=i?"AND valid_to IS NULL":"",d=this.db.prepare(`
        SELECT id, title, narrative, importance
        FROM observations
        WHERE project = ? AND type = ? AND created_at_epoch >= ? ${a}
        ORDER BY created_at_epoch DESC
        LIMIT 20
      `).all(e,t,o);if(d.length===0)return{action:"ADD"};let c=this.mq.supersession.enabled&&i;return pt({title:s,narrative:n},d,{noopThreshold:this.mq.reconcile.noopThreshold,updateBand:this.mq.reconcile.updateBand,supersessionEnabled:c})}catch(o){return l.warn("DB","reconcileBeforeInsert failed; defaulting to ADD",{project:e,type:t},o instanceof Error?o:new Error(String(o))),{action:"ADD"}}}supersedeObservation(e,t,s){try{this.db.prepare(`
        UPDATE observations
           SET valid_to = ?,
    ...
    `).all(e,t,t):this.db.prepare("SELECT * FROM observations WHERE project = ?").all(e)}storeCheckpoint(e,t,s={}){let n=this.getOrCreateManualSession(e),o=Date.now(),i=s.title&&s.title.trim()?s.title.trim():Nt(t),a={checkpoint:!0};s.focus&&s.focus.trim()&&(a.focus=s.focus.trim());let d=this.storeObservation(n,e,{type:G,title:i,subtitle:"Session checkpoint",facts:[],narrative:t,concepts:[],files_read:[],files_modified:[],metadata:JSON.stringify(a),source_kind:"curated"},0,0,o,s.generatedByModel??void 0);return this.db.prepare(`
      UPDATE observations
         SET valid_to = NULL,
             metadata = json_remove(COALESCE(metadata, '{}'), '$.superseded_by_checkpoint')
       WHERE id = ? AND type = ?
    `).run(d.id,G),this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(COALESCE(metadata, '{}'), '$.superseded_by_checkpoint', ?)
       WHERE project = ? AND type = ? AND valid_to IS NULL AND id != ?
    `).run(o,d.id,e,G,d.id),l.info("DB","Saved session checkpoint",{id:d.id,project:e,title:i}),d}clearCheckpoint(e){let t=Date.now(),s=this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(COALESCE(metadata, '{}'), '$.checkpoint_cleared', 1)
       WHERE project = ? AND type = ? AND valid_to IS NULL
    `).run(t,e,G),n=Number(s.changes??0);return l.info("DB","Cleared session checkpoint(s)",{project:e,cleared:n}),{cleared:n}}static REVISION_MARKER="revised_by";getCuratedRecord(e,t,s={}){let n=s.includeClosed?"":"AND valid_to IS NULL";return this.db.prepare(`
      SELECT id, project, json_extract(metadata, '$.record_id') AS record_id,
       ...
       LIMIT 1
    `).get(e,t)??null}getCuratedRevisions(e,t){return this.db.prepare(`
      SELECT id, title, narrative, metadata, valid_from, valid_to, created_at_epoch
        FROM observations
       WHERE project = ? AND source_kind = 'curated'
         AND json_extract(metadata, '$.record_id') = ?
       ORDER BY created_at_epoch DESC, id DESC
    `).all(e,t)}nextCuratedRecordId(e){let t=this.db.prepare(`
      SELECT DISTINCT json_extract(metadata, '$.record_id') AS record_id
        FROM observations
       WHERE project = ? AND source_kind = 'curated'
         AND json_extract(metadata, '$.record_id') IS NOT NULL
    `).all(e),s=0;for(let o of t){let i=String(o.record_id??"");if(!/^0\d{3}$/.test(i))continue;let a=parseInt(i,10);Number.isFinite(a)&&a>s&&(s=a)}let n=s+1;if(n>999)throw new Error(`curated authoring: project "${e}" has reached record 0999. The edge reader only recognises zero-padded four-digit decision numbers, so the numbering cannot continue without widening relation-lexicon/edge-reader.`);return String(n).padStart(4,"0")}storeCuratedRecord(e,t,s,n=Date.now()){let o=this.storeObservation(e,t,{type:"decision",title:s.title,subtitle:s.subtitle,facts:[],narrative:s.narrative,concepts:[],files_read:[],files_modified:[],metadata:s.metadata,source_kind:"curated",source_path:s.sourcePath,source_line:s.sourceLine,subject:s.subject,last_verified_at:s.lastVerifiedAt},0,0,n);this.db.prepare(`
      UPDATE observations
         SET valid_from = ?,
             valid_to = ?,
             metadata = json_remove(COALESCE(metadata, '{}'), '$.${r.REVISION_MARKER}')
       WHERE id = ?
    `).run(s.validFrom,s.validTo,o.id);let i=this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
    ...
    `).run(n,o.id,t,s.recordId,o.id);return{...o,revisionsClosed:Number(i?.changes??0)}}closeCuratedRecord(e,t,s={}){let n=s.nowEpoch??Date.now(),o=this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(
               COALESCE(metadata, '{}'),
    ...
    `).run(n,s.reason??null,e,t),i=Number(o?.changes??0);return l.info("DB","Closed curated record",{project:e,recordId:t,closed:i}),{closed:i}}reopenCuratedRecord(e,t){let s=this.db.prepare(`
      UPDATE observations
         SET valid_to = NULL,
    ...
    `).run(e,t);return{reopened:Number(s?.changes??0)}}getActiveCheckpoints(e){if(e.length===0)return[];let t=e.map(()=>"?").join(",");return this.db.prepare(`
      SELECT id, project, title, narrative, metadata, created_at, created_at_epoch
       ...
       WHERE project IN (${t})
         ...
         AND valid_to IS NULL
       ORDER BY created_at_epoch DESC
    `).all(...e,G)}deleteObservationsByProject(e,t={}){let s=(e??"").trim();if(s===""||s==="*")throw new Error(`deleteObservationsByProject: refusing unsafe project '${e}'`);let n=this.db.prepare("SELECT count(*) AS c FROM observations WHERE project = ?").get(s).c,o=this.db.prepare("SELECT count(*) AS c FROM session_summaries WHERE project = ?").get(s).c,a=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all().length>0?this.db.prepare("SELECT count(*) AS c FROM decision_edges WHERE project = ?").get(s).c:0;if(t.dryRun)return{project:s,dryRun:!0,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a};this.db.transaction(()=>{this.db.prepare("DELETE FROM observations WHERE project = ?").run(s),this.db.prepare("DELETE FROM session_summaries WHERE project = ?").run(s),a>0&&this.db.prepare("DELETE FROM decision_edges WHERE project = ?").run(s)})();try{this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run("INSERT INTO observations_fts(observations_fts) VALUES('rebuild')")}catch(c){l.warn("DB","observations_fts rebuild after project delete failed",{project:s},c instanceof Error?c:new Error(String(c)))}return l.info("DB","Deleted observations by project",{project:s,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a}),{project:s,dryRun:!1,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a}}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),p=[...e],E=[];o&&(E.push("ss.project = ?"),p.push(o)),i&&(E.push(`COALESCE(NULLIF(s.platform_source, ''), '${m}') = ?`),p.push(y(i)));let g=E.length>0?`AND ${E.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      FROM session_summaries ss
      ...
      ${d}
      ${c}
    `).all(...p);if(!a)return N;let I=new Map(N.map(v=>[v.id,v])),S=e.map(v=>I.get(v)).filter(v=>!!v);return n?S.slice(0,n):S}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),p=[...e],E=[];o&&(E.push("s.project = ?"),p.push(o)),i&&(E.push(`COALESCE(NULLIF(s.platform_source, ''), '${m}') = ?`),p.push(y(i)));let g=E.length>0?`AND ${E.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${c}
    `).all(...p);if(!a)return N;let I=new Map(N.map(S=>[S.id,S]));return e.map(S=>I.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?y(i):void 0,d=(f,O)=>{let h=[],D=[];return o&&(h.push(`${f}.project = ?`),D.push(o)),a&&(h.push(`COALESCE(NULLIF(${O}.platform_source, ''), '${m}') = ?`),D.push(a)),{clause:h.length>0?`AND ${h.join(" AND ")}`:"",params:D}},c=d("o","src"),u=d("ss","src"),p=d("s","s"),E,g;if(e!==null){let f=`
      ...
      `,O=`
        ...
        LIMIT ?
      `;try{let h=this.db.prepare(f).all(t,...c.params,s),D=this.db.prepare(O).all(t,...c.params,n+1);if(h.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};E=h.length>0?h[h.length-1].created_at_epoch:t,g=D.length>0?D[D.length-1].created_at_epoch:t}catch(h){return h instanceof Error?l.error("DB","Error getting boundary timestamps",{project:o},h):l.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(h))),{observations:[],sessions:[],prompts:[]}}}let T=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `).all(...e)}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,m,o.toISOString(),o.getTime()),l.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=y(e.platform_source),s=this.db.prepare(`SELECT id FROM sdk_sessions
    ...
    `).run(t,e.content_session_id,e.prompt_number,e.prompt_text,e.created_at,e.created_at_epoch).lastInsertRowid}}};var Ot=require("os"),At=B(require("path"),1),Dt=require("child_process");var pe=require("fs"),_e=B(require("path"),1);var V={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Rt(r){let e=_e.default.join(r,".git"),t;try{t=(0,pe.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&l.warn("GIT","Unexpected error checking .git",{error:u instanceof Error?u.message:String(u)}),V}if(!t.isFile())return V;let s;try{s=(0,pe.readFileSync)(e,"utf-8").trim()}catch(u){return l.warn("GIT","Failed to read .git file",{error:u instanceof Error?u.message:String(u)}),V}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return V;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return V;let a=i[1],d=_e.default.basename(r),c=_e.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}function yt(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Ot.homedir)()):r}var Y=new Map,H=new Map,Ir=6e4,It=256;function Or(r,e=Date.now()){let t=Y.get(r);if(t!==void 0)return t;let s=H.get(r);if(s!==void 0&&e-s<Ir)return null;let n=Ar(r);if(n){if(Y.size>=It){let o=Y.keys().next();o.done||Y.delete(o.value)}Y.set(r,n),H.delete(r)}else{if(H.size>=It){let o=H.keys().next();o.done||H.delete(o.value)}H.set(r,e)}return n}function Ar(r){try{return(0,Dt.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"],windowsHide:!0}).trim()||null}catch{return null}}function Dr(r){if(!r||r.trim()==="")return l.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=yt(r),s=Or(e)??e,n=At.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return l.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return l.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function vt(r){let e=Dr(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=yt(r),s=Rt(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var k=require("fs"),J=require("path"),Ge=require("os");var je={DEFAULT:3e5,HEALTH_CHECK:3e3,API_REQUEST:3e4,HOOK_READINESS_WAIT:1e4,POST_SPAWN_WAIT:15e3,READINESS_WAIT:3e4,PORT_IN_USE_WAIT:3e3,WORKER_STARTUP_WAIT:1e3,PRE_RESTART_SETTLE_DELAY:2e3,POWERSHELL_COMMAND:1e4,WINDOWS_MULTIPLIER:1.5};function Ct(r){return process.platform==="win32"?Math.round(r*je.WINDOWS_MULTIPLIER):r}var R=require("fs");var w=require("path");var Lt=require("crypto");var yr=process.platform==="win32";function vr(r){(0,R.existsSync)(r)||(0,R.mkdirSync)(r,{recursive:!0})}function q(r,e){let t=r;try{if((0,R.lstatSync)(r).isSymbolicLink())try{t=(0,R.realpathSync)(r)}catch{let c=(0,R.readlinkSync)(r);t=(0,w.resolve)((0,w.dirname)(r),c)}}catch(c){let u=c.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw c}vr((0,w.dirname)(t));let s=(0,w.dirname)(t),n=(0,w.basename)(t),o=(0,w.join)(s,`.${n}.${process.pid}.${(0,Lt.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,R.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,R.openSync)(o,"w",a):(0,R.openSync)(o,"w");let c=0;for(;c<i.length;){let u=(0,R.writeSync)(d,i,c,i.length-c);if(u===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=u}if((0,R.fsyncSync)(d),(0,R.closeSync)(d),d=void 0,(0,R.renameSync)(o,t),!yr){let u;try{u=(0,R.openSync)(s,"r"),(0,R.fsyncSync)(u)}catch{}finally{if(u!==void 0)try{(0,R.closeSync)(u)}catch{}}}}catch(c){if(d!==void 0)try{(0,R.closeSync)(d)}catch{}try{(0,R.unlinkSync)(o)}catch{}throw c}}var Ee=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(Ct(je.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,J.join)((0,Ge.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_DECISION_CHECK_ENABLED:"true",KEEPMIND_DECISION_CHECK_MAX_ROWS:"3",KEEPMIND_CURATED_PROJECT:"",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_INJECT_SOURCE_KIND:"all",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,J.join)((0,Ge.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${C("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${C("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${C("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return C(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS)){let n=this.envOverride(s);n!==void 0&&(t[s]=n)}return t}static toCanonicalKeys(e){let t={};for(let[s,n]of Object.entries(e)){if(!s.startsWith("CLAUDE_MEM_")){t[s]=n;continue}let o="KEEPMIND_"+s.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,k.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,J.dirname)(e);(0,k.existsSync)(d)||(0,k.mkdirSync)(d,{recursive:!0}),q(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let s=(0,k.readFileSync)(e,"utf-8"),n=JSON.parse(s.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{q(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=re(a,o);d!==void 0&&(i[a]=d)}if(st(o))try{q(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(s){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,s instanceof Error?s.message:String(s));let n=this.getAllDefaults();try{if((0,k.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,k.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}q(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var Q=require("fs"),me=require("path");var M=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=it(),t=C("KEEPMIND_MODES_DIR"),s=[...t?[t]:[],(0,me.join)(e,"modes"),(0,me.join)(e,"..","plugin","modes")],n=s.find(o=>(0,Q.existsSync)(o));this.modesDir=n||s[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,me.join)(this.modesDir,`${e}.json`);if(!(0,Q.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,Q.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,l.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch(d){d instanceof Error?l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),l.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch(d){return d instanceof Error?l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{message:d.message}):l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return l.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,l.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}};function Mt(){let r=$.settings(),e=Ee.loadFromFile(r),t=M.getInstance().getActiveMode(),s=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true",injectSourceKind:Cr(e.KEEPMIND_INJECT_SOURCE_KIND)}}function Cr(r){let e=(r??"").trim().toLowerCase();return e==="curated"||e==="observed"?e:"all"}var _={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},ge=4,He=1;function Be(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/ge)}function Ke(r){let e=r.length,t=r.reduce((i,a)=>i+Be(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Lr(r){return M.getInstance().getWorkEmoji(r)}function z(r,e){let t=Be(r),s=r.discovery_tokens||0,n=Lr(r.type),o=s>0?`${n} ${s.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function Te(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}function Mr(r){return Pr(r)}var xr=28;function Pr(r){let e=(r.title?.length??8)+xr;return Math.max(1,Math.ceil(e/ge))}function wr(r,e){if(!Number.isFinite(e)||e<=0)return r;let t=[],s=0;for(let n of r){let o=Mr(n);s+o>e||(t.push(n),s+=o)}return t}function xt(r,e){let t=e.now??Date.now(),s=r.map(i=>({o:i,score:ut(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?s.slice(0,e.maxRows):s;return wr(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var Pt=B(require("path"),1),fe=require("fs");function wt(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function kt(r,e,t,s){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.sessionCount+He)}function Ut(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,s??null,s??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function Ft(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,s??null,s??null,t.sessionCount+He)}function kr(r){return r.replace(/[/.]/g,"-")}function Ur(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(St,"").trim(),t)return t}return null}function Fr(r){for(let e=r.length-1;e>=0;e--)try{let t=Ur(r[e]);if(t)return t}catch(t){t instanceof Error?l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function $r(r){try{if(!(0,fe.existsSync)(r))return{assistantMessage:""};let e=(0,fe.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:Fr(t)}}catch(e){return e instanceof Error?l.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):l.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function $t(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=kr(s),a=Pt.default.join(j,"projects",i,`${o}.jsonl`);return $r(a)}function jt(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Gt(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Ht(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Kt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Xt(r){return[`# [${r}] recent context, ${Kt()}`,""]}function Wt(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Vt(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${r.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString("en-US")}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Xe(r,e=new Date){let t=new Date(r);if(Number.isNaN(t.getTime()))return null;let s=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((s(e)-s(t))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function Yt(r){let e=Xe(r);return[e?`### ${r} (${e})`:`### ${r}`]}function qt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Jt(r,e,t){let s=r.title||"Untitled",n=M.getInstance().getTypeIcon(r.type),o=e?qt(e):'"';return`${r.id} ${o} ${n} ${s}`}function Qt(r,e,t,s){let n=[],o=r.title||"Untitled",i=M.getInstance().getTypeIcon(r.type),a=e?qt(e):'"',{readTokens:d,discoveryDisplay:c}=z(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let u=[];return s.showReadTokens&&u.push(`~${d}t`),s.showWorkTokens&&u.push(c),u.length>0&&n.push(u.join(" ")),n.push(""),n}function zt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}var Bt=200;function Z(r,e){if(!e)return[];let t=e.length>Bt?`${e.slice(0,Bt).trimEnd()}\u2026`:e;return[`**${r}**: ${t}`,""]}function Zt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function es(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function ts(r){return`# [${r}] recent context, ${Kt()}

No previous sessions found.`}function ss(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function rs(r){return["",`${_.bright}${_.cyan}[${r}] recent context, ${ss()}${_.reset}`,`${_.gray}${"\u2500".repeat(60)}${_.reset}`,""]}function ns(){let e=M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${_.dim}Legend: session-request | ${e}${_.reset}`,""]}function os(){return[`${_.bright}Column Key${_.reset}`,`${_.dim}  Read: Tokens to read this observation (cost to learn it now)${_.reset}`,`${_.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${_.reset}`,""]}function is(){return[`${_.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${_.reset}`,"",`${_.dim}When you need implementation details, rationale, or debugging context:${_.reset}`,`${_.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${_.reset}`,`${_.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${_.reset}`,`${_.dim}  - Trust this index over re-reading code for past decisions and learnings${_.reset}`,""]}function as(r,e){let t=[];if(t.push(`${_.bright}${_.cyan}Context Economics${_.reset}`),t.push(`${_.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${_.reset}`),t.push(`${_.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${_.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${_.green}${s}${_.reset}`)}return t.push(""),t}function ds(r){return[`${_.bright}${_.cyan}${r}${_.reset}`,""]}function cs(r){return[`${_.dim}${r}${_.reset}`]}function us(r,e,t,s){let n=r.title||"Untitled",o=M.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=z(r,s),c=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${_.dim}(~${i}t)${_.reset}`:"",p=s.showWorkTokens&&a>0?`${_.dim}(${d} ${a.toLocaleString()}t)${_.reset}`:"";return`  ${_.dim}#${r.id}${_.reset}  ${c}  ${o}  ${n} ${u} ${p}`}function ls(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=M.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:u}=z(r,n),p=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${_.dim}(~${d}t)${_.reset}`:"",g=n.showWorkTokens&&c>0?`${_.dim}(${u} ${c.toLocaleString()}t)${_.reset}`:"";return o.push(`  ${_.dim}#${r.id}${_.reset}  ${p}  ${a}  ${_.bright}${i}${_.reset}`),s&&o.push(`    ${_.dim}${s}${_.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function _s(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${_.yellow}#S${r.id}${_.reset} ${t}`,""]}function ee(r,e,t){return e?[`${t}${r}:${_.reset} ${e}`,""]:[]}function ps(r){return r.assistantMessage?["","---","",`${_.bright}${_.magenta}Previously${_.reset}`,"",`${_.dim}A: ${r.assistantMessage}${_.reset}`,""]:[]}function Es(r,e){let t=Math.round(r/1e3);return["",`${_.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${_.reset}`]}function ms(r){return`
${_.bright}${_.cyan}[${r}] recent context, ${ss()}${_.reset}
${_.gray}${"\u2500".repeat(60)}${_.reset}

${_.dim}No previous sessions found for this project yet.${_.reset}
`}function gs(r,e,t,s){let n=[];return s?n.push(...rs(r)):n.push(...Xt(r)),s?n.push(...ns()):n.push(...Wt()),s&&(n.push(...os()),n.push(...is())),Te(t)&&(s?n.push(...as(e,t)):n.push(...Vt(e,t))),n}function Ts(r){if(!r||r.length===0)return[];let e=[];for(let t of r){let s=(t.created_at??"").slice(0,10),n=Xe(s),o=n?`${s} \xB7 ${n}`:s,i=null;try{let a=t.metadata?JSON.parse(t.metadata):null;a&&typeof a.focus=="string"&&a.focus.trim()&&(i=a.focus.trim())}catch{}e.push(`# \u23F3 CHECKPOINT \u2014 ${t.project} (${o})`),e.push("Curated hand-off from the previous session. Resume from here before anything else."),i&&e.push(`_Focus: ${i}_`),e.push(""),t.narrative&&t.narrative.trim()&&(e.push(t.narrative.trim()),e.push("")),e.push("---"),e.push("")}return e}var he=B(require("path"),1);function Ne(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function We(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ve(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function bs(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function fs(r,e){return he.default.isAbsolute(r)?he.default.relative(e,r).split(he.default.sep).join("/"):r}function Ss(r,e,t){let s=Ne(r);if(s.length>0)return fs(s[0],e);if(t){let n=Ne(t);if(n.length>0)return fs(n[0],e)}return"General"}function jr(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=bs(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function hs(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Ne(r.facts).join(`
`):null}function Gr(r,e,t,s){let n=[];n.push(...Yt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=We(a.displayTime);n.push(...zt(a,d))}else{let a=i.data,d=Ve(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let E=hs(a,s);n.push(...Qt(a,u,E,s))}else n.push(Jt(a,u,s))}return n}function Hr(r,e,t,s,n){let o=[];o.push(...ds(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,u=We(c.displayTime);o.push(..._s(c,u))}else{let c=d.data,u=Ss(c.files_modified,n,c.files_read),p=Ve(c.created_at),E=p!==a;a=p;let g=t.has(c.id);if(u!==i&&(o.push(...cs(u)),i=u),g){let T=hs(c,s);o.push(...ls(c,p,E,T,s))}else o.push(us(c,p,E,s))}return o.push(""),o}function Br(r,e,t,s,n,o){return o?Hr(r,e,t,s,n):Gr(r,e,t,s)}function Ns(r,e,t,s,n){let o=[],i=jr(r);for(let[a,d]of i)o.push(...Br(a,d,e,t,s,n));return o}function Rs(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Is(r,e){let t=[];return e?(t.push(...ee("Investigated",r.investigated,_.blue)),t.push(...ee("Learned",r.learned,_.yellow)),t.push(...ee("Completed",r.completed,_.green)),t.push(...ee("Next Steps",r.next_steps,_.magenta))):(t.push(...Z("Investigated",r.investigated)),t.push(...Z("Learned",r.learned)),t.push(...Z("Completed",r.completed)),t.push(...Z("Next Steps",r.next_steps))),t}function Os(r,e){return e?ps(r):Zt(r)}function As(r,e,t){return!Te(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Es(r.totalDiscoveryTokens,r.totalReadTokens):es(r.totalDiscoveryTokens,r.totalReadTokens)}var Kr=Ds.default.join((0,ys.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function Xr(){try{return new le}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,vs.unlinkSync)(Kr)}catch(e){e instanceof Error?l.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):l.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return l.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Wr(r,e){return e?ms(r):ts(r)}function Vr(r,e,t,s,n,o,i,a){let d=[],c=Ke(e);d.push(...gs(r,c,n,a)),d.push(...Ts(s));let u=t.slice(0,n.sessionCount),p=jt(u,t),E=Gt(e,p),g=Ht(e,n.fullObservationCount);d.push(...Ns(E,g,n,o,a));let T=t[0],N=e[0];Rs(n,T,N)&&d.push(...Is(T,a));let I=$t(e,n,i,o);return d.push(...Os(I,a)),d.push(...As(c,n,a)),d.join(`
`).trimEnd()}var Yr=new Set(["bugfix","discovery","decision","refactor","security_alert","security_note"]);function qr(r,e,t){let s=Ke(r),n={bugfix:0,discovery:0,decision:0,refactor:0,security_alert:0,security_note:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=Yr.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_security_alert:n.security_alert,obs_type_security_note:n.security_note,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Ye(r,e=!1){let t=Mt(),s=ae(),n=r?.cwd??process.cwd(),o=vt(n),i=r?.projects?.length?r.projects:o.allProjects,a=i[i.length-1]??o.primary,d=s.importance.enabled&&!r?.full,c=t.totalObservationCount;d&&(t.totalObservationCount=Math.max(c,c*Math.max(1,s.injection.candidateMultiplier))),r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let u=Xr();if(!u)return{text:"",stats:null};try{let p=r?.platformSource?y(r.platformSource):void 0,E=i.length>1?Ut(u,i,t,p):wt(u,a,t,p),g=d?xt(E,{tokenBudget:s.injection.tokenBudget,halfLifeDays:s.importance.halfLifeDays,maxRows:c}):E,T=i.length>1?Ft(u,i,t,p):kt(u,a,t,p),N=u.getActiveCheckpoints(i);return g.length>0&&u.markObservationsUsed(g.map(S=>S.id),"injection"),g.length===0&&T.length===0&&N.length===0?{text:Wr(a,e),stats:null}:{text:Vr(a,g,T,N,t,n,r?.session_id,e),stats:qr(g,T,!!r?.full)}}finally{u.close()}}async function Cs(r,e=!1){return(await Ye(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
