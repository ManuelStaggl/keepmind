"use strict";var rr=Object.create;var de=Object.defineProperty;var nr=Object.getOwnPropertyDescriptor;var or=Object.getOwnPropertyNames;var ir=Object.getPrototypeOf,ar=Object.prototype.hasOwnProperty;var dr=(r,e)=>{for(var s in e)de(r,s,{get:e[s],enumerable:!0})},ut=(r,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of or(e))!ar.call(r,n)&&n!==s&&de(r,n,{get:()=>e[n],enumerable:!(t=nr(e,n))||t.enumerable});return r};var V=(r,e,s)=>(s=r!=null?rr(ir(r)):{},ut(e||!r||!r.__esModule?de(s,"default",{value:r,enumerable:!0}):s,r)),cr=r=>ut(de({},"__esModule",{value:!0}),r);var Ln={};dr(Ln,{generateContext:()=>sr,generateContextWithStats:()=>dt});module.exports=cr(Ln);var Zs=V(require("path"),1),er=require("os"),tr=require("fs");var _t=require("node:sqlite");function lt(r){return typeof r=="bigint"?Number(r):r}function ur(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)&&!(r instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(r))}function pt(r){return r===void 0?null:typeof r=="boolean"?r?1:0:r}function ce(r){let e=r;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&ur(e[0])){let s=e[0],t={};for(let n of Object.keys(s))t[n]=pt(s[n]);return[t]}return e.map(pt)}var xe=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...ce(e))}get(...e){return this.stmt.get(...ce(e))??null}run(...e){let s=this.stmt.run(...ce(e));return{changes:lt(s.changes),lastInsertRowid:lt(s.lastInsertRowid)}}values(...e){return this.stmt.all(...ce(e)).map(t=>Object.values(t))}finalize(){}},Y=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,s={}){let t=s.readonly===!0;this.safeIntegers=s.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new _t.DatabaseSync(n,{readOnly:t,allowExtension:!0}),!t&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new xe(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let s=this.queryCache.get(e);if(s)return s;let t=this.prepare(e);return this.queryCache.set(e,t),t}run(e,...s){return s.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...s)}exec(e){this.db.exec(e)}loadExtension(e,s){this.db.loadExtension(e)}transaction(e){return(...s)=>{let t=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;t?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...s);return this.txDepth--,t?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,t?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var h=require("path"),$e=require("os"),L=require("fs");var Tt=require("url");var mt="KEEPMIND_",Et="CLAUDE_MEM_";function gt(r){return r.startsWith(mt)?Et+r.slice(mt.length):null}function y(r,e=process.env){let s=e[r];if(s!==void 0)return s;let t=gt(r);return t?e[t]:void 0}function G(r,e){let s=e[r];if(s!==void 0)return s;let t=gt(r);return t?e[t]:void 0}function ft(r){return Object.keys(r).some(e=>e.startsWith(Et))}var P=require("fs"),ke=require("path");var lr=null;function pr(r){return(lr??process.stderr.write.bind(process.stderr))(r)}function Pe(r){pr(r)}var _r=14,Ue=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Ue||{}),we=null,mr=6e4,Er=500,q=new Map;function gr(r,e){try{let s="";if(r){for(let t of Object.keys(r).sort())if(s+=`${t}=${String(r[t])};`,s.length>200)break}return e instanceof Error?s+=`E:${e.message}`:typeof e=="string"||typeof e=="number"||typeof e=="boolean"?s+=`D:${e}`:e&&(s+="D:obj"),s.slice(0,200)}catch{return""}}function fr(r,e,s,t,n,o){let i=`${r}|${e}|${s}|${gr(n,o)}`,a=q.get(i);if(a&&t-a.windowStartedAt<mr)return a.suppressed++,null;if(!a&&q.size>=Er){let l=q.keys().next();l.done||q.delete(l.value)}let d=a?.suppressed??0,c=a?Math.round((t-a.windowStartedAt)/1e3):0;return q.set(i,{windowStartedAt:t,suppressed:0}),d>0?` (repeated ${d}\xD7 in the previous ${c}s)`:""}var Fe=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=H.logsDir();(0,P.existsSync)(e)||(0,P.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,ke.join)(e,`keepmind-${s}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let s=Date.now()-_r*24*60*60*1e3;for(let t of(0,P.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(t);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<s)try{(0,P.unlinkSync)((0,ke.join)(e,t))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,P.existsSync)(e)){let s=(0,P.readFileSync)(e,"utf-8"),n=(JSON.parse(s).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=Ue[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${n} ${o}:${i}:${a}.${d}`}log(e,s,t,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let I=fr(e,s,t,Date.now(),n,o);if(I===null)return;i=I}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=Ue[e].padEnd(5),c=s.padEnd(6),l="";n?.correlationId?l=`[${n.correlationId}] `:n?.sessionId&&(l=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let m="";if(n){let{sessionId:I,memorySessionId:O,correlationId:f,...g}=n;Object.keys(g).length>0&&(m=` {${Object.entries(g).map(([w,b])=>`${w}=${b}`).join(", ")}}`)}let T=`[${a}] [${d}] [${c}] ${l}${t}${i}${m}${_}`;if(this.logFilePath)try{(0,P.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(I){Pe(`[LOGGER] Failed to write to log file: ${I instanceof Error?I.message:String(I)}
`)}else Pe(T+`
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){we=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!we||!(t instanceof Error))return;we(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}happyPathError(e,s,t,n,o=""){let c=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",_={...t,location:l};return this.warn(e,`[HAPPY-PATH] ${s}`,_,n),o}},u=new Fe;var Dr={};function Tr(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,Tt.fileURLToPath)(Dr.url))}var br=Tr();function hr(){let r=y("KEEPMIND_DATA_DIR");if(r)return r;let e=(0,h.join)((0,$e.homedir)(),".keepmind"),s=(0,h.join)(e,"settings.json");try{if((0,L.existsSync)(s)){let t=JSON.parse((0,L.readFileSync)(s,"utf-8")),n=t.env??t,o=G("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var R=hr(),B=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,$e.homedir)(),".claude"),Hn=(0,h.join)(B,"plugins","marketplaces","keepmind"),Sr=(0,h.join)(R,"archives"),Nr=(0,h.join)(R,"logs"),Rr=(0,h.join)(R,"trash"),Ir=(0,h.join)(R,"backups"),Or=(0,h.join)(R,"modes"),Gn=(0,h.join)(R,"settings.json"),$=(0,h.join)(R,"keepmind.db"),J=(0,h.join)(R,"claude-mem.db"),Ar=(0,h.join)(R,"vector-db"),bt=(0,h.join)(R,"observer-sessions"),je=(0,h.basename)(bt),Bn=(0,h.join)(B,"settings.json"),Xn=(0,h.join)(B,"commands"),Wn=(0,h.join)(B,"CLAUDE.md");function ht(r){(0,L.mkdirSync)(r,{recursive:!0})}function yr(){try{if((0,L.existsSync)($)||!(0,L.existsSync)(J))return(0,L.existsSync)($);for(let r of["","-wal","-shm"]){let e=J+r,s=$+r;(0,L.existsSync)(e)&&!(0,L.existsSync)(s)&&(0,L.renameSync)(e,s)}return u.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:J,to:$}),!0}catch(r){return u.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},r instanceof Error?r:new Error(String(r))),!1}}function Ke(){return yr(),!(0,L.existsSync)($)&&(0,L.existsSync)(J)?J:$}function St(){return(0,h.join)(br,"..")}var H={dataDir:()=>R,workerPid:()=>(0,h.join)(R,"worker.pid"),workerPort:()=>(0,h.join)(R,"worker.port"),serverPid:()=>(0,h.join)(R,".server-beta.pid"),serverPort:()=>(0,h.join)(R,".server-beta.port"),serverRuntime:()=>(0,h.join)(R,".server-beta.runtime.json"),settings:()=>(0,h.join)(R,"settings.json"),database:()=>Ke(),chroma:()=>(0,h.join)(R,"chroma"),combinedCerts:()=>(0,h.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,h.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,h.join)(R,"transcript-watch-state.json"),corpora:()=>(0,h.join)(R,"corpora"),supervisorRegistry:()=>(0,h.join)(R,"supervisor.json"),envFile:()=>(0,h.join)(R,".env"),logsDir:()=>Nr,archives:()=>Sr,trash:()=>Rr,backups:()=>Ir,modes:()=>Or,vectorDb:()=>Ar,observerSessions:()=>bt};var Nt={injection:"injection_count",explicit_fetch:"explicit_fetch_count",fts:"fts_hit_count",vector:"vector_hit_count"};function Q(r){let e=typeof r=="string"?r.trim().toLowerCase():"";return e==="curated"||e==="observed"?e:"all"}function ue(r){return`COALESCE(${r?`${r}.`:""}source_kind, 'observed')`}function He(r,e){return r==="all"?null:{sql:`${ue(e)} = ?`,param:r}}var Rt=require("crypto");function Ge(r,e,s){return(0,Rt.createHash)("sha256").update([r||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}function Be(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var Xe=r=>`\xABredacted:${r}\xBB`,Cr=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:jdbc:[a-z0-9]{1,20}:)?(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|sqlserver|oracle|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"CREDENTIAL_ASSIGNMENT",re:/\b(?:password|pwd|passwd)\s{0,3}=\s{0,3}(?:"([^"\r\n]{1,200})"|'([^'\r\n]{1,200})'|([^;"'\r\n]{1,200}))/gi,group:1},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1},{type:"EMAIL",category:"pii",re:/\b[\w.+-]{1,64}@[\w-]{1,63}(?:\.[\w-]{1,63}){1,4}\b/g},{type:"IP_ADDRESS",category:"pii",re:/\b(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\b/g,keep:r=>r==="0.0.0.0"||r==="255.255.255.255"||r.startsWith("127.")}];function It(r){return r.includes("redacted:")}function vr(r,e){if(e.re.lastIndex=0,e.group===void 0)return r.replace(e.re,t=>It(t)||e.keep?.(t)?t:Xe(e.type));let s=e.group;return r.replace(e.re,(t,...n)=>{if(e.keep?.(t))return t;let o=t,i=!1;for(let a=s-1;a<n.length;a++){let d=n[a];typeof d!="string"||d.length===0||It(d)||(o=o.replace(d,Xe(e.type)),i=!0)}return i?o:t})}function Lr(r){if(r.length===0)return 0;let e=new Map;for(let t of r)e.set(t,(e.get(t)??0)+1);let s=0;for(let t of e.values()){let n=t/r.length;s-=n*Math.log2(n)}return s}var Mr=/^[0-9a-f]+$/i;function xr(r,e){return r.length<20||r.length>200||/[\s]/.test(r)||!/\d/.test(r)||!/[A-Za-z]/.test(r)||r.includes("/")||r.includes("\\")||r.length<=64&&Mr.test(r)||r.includes("redacted:")?!1:Lr(r)>=e}var Pr=/([\s"'`,;(){}\[\]<>]+)/;function wr(r,e){let s=r.split(Pr);for(let t=0;t<s.length;t++){let n=s[t];n&&xr(n,e)&&(s[t]=Xe("HIGH_ENTROPY"))}return s.join("")}function We(r,e={}){if(typeof r!="string"||r.length===0)return r;try{let s=r,t=e.pii!==!1;for(let n of Cr)n.category==="pii"&&!t||(s=vr(s,n));return e.entropySweep!==!1&&(s=wr(s,e.entropyThreshold??4)),s}catch{return r}}function le(r,e={}){if(typeof r=="string")return We(r,e);if(Array.isArray(r))return r.map(s=>le(s,e));if(r&&typeof r=="object"){let s={};for(let[t,n]of Object.entries(r))s[t]=le(n,e);return s}return r}var _e=require("fs");var Ye={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0,pii:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},vectorRetention:{enabled:!0,inactiveDays:90},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function pe(r){return!!r&&typeof r=="object"&&!Array.isArray(r)}function j(r,e){if(!pe(e))return{...r};let s={...r};for(let t of Object.keys(r))e[t]!==void 0&&typeof e[t]==typeof r[t]&&(s[t]=e[t]);return s}var Ve=null;function me(r=!1){if(Ve&&!r)return Ve;let e=Ye,s;try{let i=H.settings();if((0,_e.existsSync)(i)){let a=JSON.parse((0,_e.readFileSync)(i,"utf-8").replace(/^﻿/,"")),d=pe(a)?a.memoryQuality??(pe(a.env)?a.env.memoryQuality:void 0):void 0;pe(d)&&(s=d)}}catch(i){u.debug("CONFIG","memoryQuality config load failed; using defaults",{},i instanceof Error?i:new Error(String(i)))}let t={redactSecrets:j(e.redactSecrets,s?.redactSecrets),scoping:j(e.scoping,s?.scoping),importance:j(e.importance,s?.importance),injection:j(e.injection,s?.injection),reconcile:j(e.reconcile,s?.reconcile),supersession:j(e.supersession,s?.supersession),expiry:j(e.expiry,s?.expiry),vectorRetention:j(e.vectorRetention,s?.vectorRetention),optimizer:j(e.optimizer,s?.optimizer)},n=y("KEEPMIND_REDACT_SECRETS");(n==="0"||n==="false")&&(t.redactSecrets.enabled=!1);let o=y("KEEPMIND_REDACT_PII");return(o==="0"||o==="false")&&(t.redactSecrets.pii=!1),Ve=t,t}var kr={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function Ur(r){if(Array.isArray(r))return r.length;if(typeof r=="string")try{let e=JSON.parse(r);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function qe(r){let e=kr[r.type??"other"]??4;return Ur(r.files_modified)>0&&(e+=1),(r.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(r.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var Fr=14,$r=864e5;function Ot(r,e={}){let s=e.now??Date.now(),t=(e.halfLifeDays??Fr)*$r,n=(r.importance??5)/10,o=Math.max(0,s-(r.created_at_epoch??s)),i=Math.pow(.5,o/t);return n*i}function yt(r){return r.normalize("NFC").toLowerCase().replace(/ä/g,"ae").replace(/ö/g,"oe").replace(/ü/g,"ue").replace(/ß/g,"ss")}var jr=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will","der","die","das","den","dem","des","ein","eine","einen","einem","einer","eines","und","oder","aber","ist","sind","war","waren","wird","werden","wurde","wurden","hat","haben","hatte","hatten","f\xFCr","mit","von","vom","zu","zum","zur","im","auf","am","an","aus","bei","nach","\xFCber","unter","durch","gegen","ohne","um","als","wie","dass","sich","es","wir","man","auch","noch","nur","schon","dann","wenn","weil","damit","sowie","bereits"].map(yt));function Ee(r){return r?yt(r).replace(/[^\p{L}\p{N}\s]+/gu," ").split(/\s+/).filter(e=>e.length>0&&!jr.has(e)).join(" ").trim():""}function At(r){let e=new Set,s=r.replace(/\s+/g," ");for(let t=0;t+3<=s.length;t++)e.add(s.slice(t,t+3));return e}function Kr(r,e){let s=At(r),t=At(e);if(s.size===0&&t.size===0)return 1;if(s.size===0||t.size===0)return 0;let n=0;for(let o of s)t.has(o)&&n++;return n/(s.size+t.size-n)}function Hr(r,e){let s=new Map,t=new Map;for(let a of r.split(" "))a&&s.set(a,(s.get(a)??0)+1);for(let a of e.split(" "))a&&t.set(a,(t.get(a)??0)+1);if(s.size===0||t.size===0)return 0;let n=0;for(let[a,d]of s)n+=d*(t.get(a)??0);let o=0;for(let a of s.values())o+=a*a;let i=0;for(let a of t.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function Gr(r,e){let s=Ee(`${r??""}`),t=Ee(`${e??""}`);return Math.max(Kr(s,t),Hr(s,t))}function Dt(r,e,s){let t=`${r.title??""} ${r.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=Gr(t,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=s.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=s.updateBand&&s.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var Ct=require("crypto");function ge(r){let e=r.title??"";if(!e){if(Array.isArray(r.facts)&&r.facts.length>0)e=r.facts[0];else if(typeof r.facts=="string")try{let t=JSON.parse(r.facts);Array.isArray(t)&&t.length>0&&(e=String(t[0]))}catch{}}e||(e=(r.narrative??"").slice(0,80));let s=Ee(e);return(0,Ct.createHash)("sha1").update(s).digest("hex").slice(0,16)}var E="claude";function Br(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return E;let e=Br(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:E}function vt(r){let e=["claude","codex","cursor"];return[...r].sort((s,t)=>{let n=e.indexOf(s),o=e.indexOf(t);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:s.localeCompare(t)})}function Lt(r,e,s,t,n){let o=Date.now()-t,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,o)??void 0}var Pt=["private","keepmind-context","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Mt=new RegExp(`<(${Pt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),wt=/<system-reminder>[\s\S]*?<\/system-reminder>/g,xt=100;function Xr(r){let e=Object.fromEntries(Pt.map(n=>[n,0]));Mt.lastIndex=0;let s=0,t=r.replace(Mt,(n,o)=>(e[o]=(e[o]??0)+1,s+=1,""));return s>xt&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:xt,contentLength:r.length}),{stripped:t.trim(),counts:e}}function kt(r){return Xr(r).stripped}var Wr=["task-notification"],_o=new RegExp(`^\\s*<(${Wr.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),mo=256*1024;var Je=4e3;function fe(r){let e=r.trim(),t=kt(r).trim()||e;return t.length<=Je?t:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:Je}),`${t.slice(0,Je-1)}\u2026`)}var X="session-checkpoint";function Ut(r){let s=(r.split(`
`).map(t=>t.trim()).find(t=>t.length>0)??"Session checkpoint").replace(/^#+\s*/,"").replace(/^\*+\s*/,"").replace(/\*+$/,"").trim();return s?s.length>80?`${s.slice(0,80).trimEnd()}\u2026`:s:"Session checkpoint"}var Vr=/^0\d{3}$/,Yr=/^V-\d{4}$/;function qr(r){let e=r?`${r}.`:"";return`COALESCE(json_extract(${e}metadata, '$.record_id'), json_extract(${e}metadata, '$.vorgang_id'))`}var k=qr();function Jr(r){let e=r.trim();return Vr.test(e)?"akte":Yr.test(e)?"vorgang":null}function Ft(r,e){if(r)try{if(JSON.parse(r)?.kind==="vorgang")return"vorgang"}catch{}return(e&&Jr(e))==="vorgang"?"vorgang":"akte"}function Zr(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var Te=class r{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?We(e,this.redactOpts):e}rl(e){return this.redactEnabled?le(e,this.redactOpts):e}constructor(e=$){try{this.mq=me();let s=this.mq.redactSecrets;this.redactEnabled=s.enabled,this.redactOpts={entropySweep:s.entropySweep,entropyThreshold:s.entropyThreshold}}catch{this.mq=Ye,this.redactEnabled=y("KEEPMIND_REDACT_SECRETS")!=="0"&&y("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof Y)this.db=e;else{e!==":memory:"&&ht(R);let s=e===$?Ke():e;this.db=new Y(s),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns(),this.recomputeSubjectKeys(),this.addCuratedSourceColumns(),this.createDecisionEdgesTable()}createDecisionEdgesTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42),s=this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all();e&&s.length>0||(this.db.run(`
    ...
    `).all(e)}getAllRecentUserPrompts(e=100){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT ?
    `).all(e)}getAllProjects(e){let s=e?D(e):void 0,t=`
      SELECT DISTINCT project
      FROM sdk_sessions
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[je];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",n.push(E,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(je),s=[],t=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),t.has(i.project)||(t.add(i.project),s.push(i.project))}let o=vt(Object.keys(n));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,n){return Lt(this.db,e,fe(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`,n.push(D(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(...t)}getObservationById(e,s){return s?this.db.prepare(`
      ...
      WHERE o.id = ?
        AND COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?
    `).get(e,D(s))||null:this.db.prepare(`
        SELECT *
        FROM observations
        WHERE id = ?
      `).get(e)||null}filterObservationIdsBySourceKind(e,s){let t=He(Q(s),"o");if(!t||e.length===0)return e;let n=this.db.prepare(`
      SELECT o.id FROM observations o
      WHERE o.id IN (SELECT value FROM json_each(?)) AND ${t.sql}
    `).all(JSON.stringify(e),t.param),o=new Set(n.map(i=>i.id));return e.filter(i=>o.has(i))}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:c,sourceKind:l}=s,_=t==="relevance",m=_?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,T=n&&!_?`LIMIT ${n}`:"",I=e.map(()=>"?").join(","),O=[...e],f=[];o&&(f.push("o.project = ?"),O.push(o)),i&&(f.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),O.push(D(i)));let g=He(Q(l),"o");if(g&&(f.push(g.sql),O.push(g.param)),a)if(Array.isArray(a)){let S=a.map(()=>"?").join(",");f.push(`o.type IN (${S})`),O.push(...a)}else f.push("o.type = ?"),O.push(a);if(d){let S=Array.isArray(d)?d:[d],Me=S.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...S),f.push(`(${Me.join(" OR ")})`)}if(c){let S=Array.isArray(c)?c:[c],Me=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");S.forEach(ct=>{O.push(`%${ct}%`,`%${ct}%`)}),f.push(`(${Me.join(" OR ")})`)}let C=f.length>0?`WHERE o.id IN (${I}) AND ${f.join(" AND ")}`:`WHERE o.id IN (${I})`,b=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${C}
      ${m}
      ${T}
    `).all(...O);if(!_)return b;let v=new Map(b.map(S=>[S.id,S])),N=e.map(S=>v.get(S)).filter(S=>!!S);return n?N.slice(0,n):N}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(...t)||null}getFilesForSession(e){let t=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),n=new Set,o=new Set;for(let i of t)Be(i.files_read).forEach(a=>n.add(a)),Be(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(n),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,s,t,n,o){let i=new Date,a=i.getTime(),d=Zr(n,o),c=d.platformSource??E,l=this.rt(fe(t)),_=this.db.prepare(`
    ...
    `).get(E,c,e);if(_)return s&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,c,l,d.customTitle||null,i.toISOString(),a);return Number(m.lastInsertRowid)}saveUserPrompt(e,s,t,n){let o=new Date,i=o.getTime(),a=this.rt(fe(t)),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,s,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,s,t){let n=this.resolvePromptSessionDbId(e,t);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),l=this.rt(t.title),_=this.rt(t.subtitle),m=this.rt(t.narrative),T=this.rl(t.facts),I=this.rt(t.metadata??null),O=Ge(e,l??null,m??null),f=qe({type:t.type,narrative:m,files_modified:t.files_modified}),g,C=t.source_kind==="curated";if(this.mq.reconcile.enabled&&!C){let N=this.reconcileBeforeInsert(s,t.type,l??null,m??null);if(N.action==="NOOP"&&N.candidateId){let S=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(N.candidateId);if(S)return{id:S.id,createdAtEpoch:S.created_at_epoch}}else N.action==="UPDATE"&&(g=N.candidateId)}let b=this.db.prepare(`
    ...
    `).get(e,s,t.type,l,_,JSON.stringify(T),m,JSON.stringify(t.concepts),JSON.stringify(t.files_read),JSON.stringify(t.files_modified),n||null,o,t.agent_type??null,t.agent_id??null,O,c,d,a||null,I,f,d,ge({title:l??null,facts:T,narrative:m??null}),t.source_kind??null,t.source_path??null,t.source_line??null,t.subject??null,t.last_verified_at??null);if(b)return g!==void 0&&this.mq.supersession.enabled&&this.supersedeObservation(g,b.id,d),{id:b.id,createdAtEpoch:b.created_at_epoch};let v=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,O);if(!v)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${O}`);return{id:v.id,createdAtEpoch:v.created_at_epoch}}storeSummary(e,s,t,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),l=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,this.rt(t.request),this.rt(t.investigated),this.rt(t.learned),this.rt(t.completed),this.rt(t.next_steps),this.rt(t.notes),n||null,o,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,n,o,i=0,a,d){let c=a??Date.now(),l=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
    ...
    `).run(s,e,X),n=Number(t.changes??0);return u.info("DB","Cleared session checkpoint(s)",{project:e,cleared:n}),{cleared:n}}static REVISION_MARKER="revised_by";getCuratedRecord(e,s,t={}){let n=t.includeClosed?"":"AND valid_to IS NULL",o=this.db.prepare(`
      SELECT id, project, ${k} AS record_id,
       ...
       LIMIT 1
    `).get(e,s);return o?{...o,kind:Ft(o.metadata,o.record_id)}:null}getCuratedRevisions(e,s){return this.db.prepare(`
    ...
    `).all(...e,X)}deleteObservationsByProject(e,s={}){let t=(e??"").trim();if(t===""||t==="*")throw new Error(`deleteObservationsByProject: refusing unsafe project '${e}'`);let n=this.db.prepare("SELECT count(*) AS c FROM observations WHERE project = ?").get(t).c,o=this.db.prepare("SELECT count(*) AS c FROM session_summaries WHERE project = ?").get(t).c,a=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all().length>0?this.db.prepare("SELECT count(*) AS c FROM decision_edges WHERE project = ?").get(t).c:0;if(s.dryRun)return{project:t,dryRun:!0,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a};this.db.transaction(()=>{this.db.prepare("DELETE FROM observations WHERE project = ?").run(t),this.db.prepare("DELETE FROM session_summaries WHERE project = ?").run(t),a>0&&this.db.prepare("DELETE FROM decision_edges WHERE project = ?").run(t)})();try{this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run("INSERT INTO observations_fts(observations_fts) VALUES('rebuild')")}catch(c){u.warn("DB","observations_fts rebuild after project delete failed",{project:t},c instanceof Error?c:new Error(String(c)))}return u.info("DB","Deleted observations by project",{project:t,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a}),{project:t,dryRun:!1,observationsDeleted:n,summariesDeleted:o,edgesDeleted:a}}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),_=[...e],m=[];o&&(m.push("ss.project = ?"),_.push(o)),i&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),_.push(D(i)));let T=m.length>0?`AND ${m.join(" AND ")}`:"",O=this.db.prepare(`
      ...
      ${d}
      ${c}
    `).all(..._);if(!a)return O;let f=new Map(O.map(C=>[C.id,C])),g=e.map(C=>f.get(C)).filter(C=>!!C);return n?g.slice(0,n):g}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),_=[...e],m=[];o&&(m.push("s.project = ?"),_.push(o)),i&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),_.push(D(i)));let T=m.length>0?`AND ${m.join(" AND ")}`:"",O=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${c}
    `).all(..._);if(!a)return O;let f=new Map(O.map(g=>[g.id,g]));return e.map(g=>f.get(g)).filter(g=>!!g)}getTimelineAroundTimestamp(e,s=10,t=10,n,o){return this.getTimelineAroundObservation(null,e,s,t,n,o)}getTimelineAroundObservation(e,s,t=10,n=10,o,i){let a=i?D(i):void 0,d=(b,v)=>{let N=[],S=[];return o&&(N.push(`${b}.project = ?`),S.push(o)),a&&(N.push(`COALESCE(NULLIF(${v}.platform_source, ''), '${E}') = ?`),S.push(a)),{clause:N.length>0?`AND ${N.join(" AND ")}`:"",params:S}},c=d("o","src"),l=d("ss","src"),_=d("s","s"),m,T;if(e!==null){let b=`
      ...
      `,v=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let N=this.db.prepare(b).all(e,...c.params,t+1),S=this.db.prepare(v).all(e,...c.params,n+1);if(N.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};m=N.length>0?N[N.length-1].created_at_epoch:s,T=S.length>0?S[S.length-1].created_at_epoch:s}catch(N){return N instanceof Error?u.error("DB","Error getting boundary observations",{project:o},N):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(N))),{observations:[],sessions:[],prompts:[]}}}else{let b=`
      ...
      `,v=`
        ...
        LIMIT ?
      `;try{let N=this.db.prepare(b).all(s,...c.params,t),S=this.db.prepare(v).all(s,...c.params,n+1);if(N.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};m=N.length>0?N[N.length-1].created_at_epoch:s,T=S.length>0?S[S.length-1].created_at_epoch:s}catch(N){return N instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},N):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(N))),{observations:[],sessions:[],prompts:[]}}}let I=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `).all(...e)}getOrCreateManualSession(e){let s=`manual-${e}`,t=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(s))return s;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(s,t,e,E,o.toISOString(),o.getTime()),u.info("SESSION","Created manual session",{memorySessionId:s,project:e}),s}close(){this.db.close()}importSdkSession(e){let s=D(e.platform_source),t=this.db.prepare(`SELECT id FROM sdk_sessions
    ...
    `).run(e.memory_session_id,e.project,e.text,e.type,e.title,e.subtitle,e.facts,e.narrative,e.concepts,e.files_read,e.files_modified,e.prompt_number,e.discovery_tokens||0,e.agent_type??null,e.agent_id??null,e.created_at,e.created_at_epoch).lastInsertRowid}}rebuildObservationsFTSIndex(){this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run("INSERT INTO observations_fts(observations_fts) VALUES('rebuild')")}importUserPrompt(e){let s=null,t=e.platform_source?D(e.platform_source):void 0;if(typeof e.session_db_id=="number"){let a=this.db.prepare(`
        SELECT id, content_session_id, COALESCE(NULLIF(platform_source, ''), '${E}') as platform_source
        FROM sdk_sessions
        WHERE id = ?
        LIMIT 1
      `).get(e.session_db_id);a&&a.content_session_id===e.content_session_id&&(!t||D(a.platform_source)===t)&&(s=a.id)}s===null&&(s=this.resolvePromptSessionDbId(e.content_session_id,void 0,t));let n=this.db.prepare(`
...
`,"utf-8"),a;try{a=(0,A.statSync)(s).mode&511}catch{}let d;try{d=a!==void 0?(0,A.openSync)(o,"w",a):(0,A.openSync)(o,"w");let c=0;for(;c<i.length;){let l=(0,A.writeSync)(d,i,c,i.length-c);if(l===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=l}if((0,A.fsyncSync)(d),(0,A.closeSync)(d),d=void 0,(0,A.renameSync)(o,s),!nn){let l;try{l=(0,A.openSync)(t,"r"),(0,A.fsyncSync)(l)}catch{}finally{if(l!==void 0)try{(0,A.closeSync)(l)}catch{}}}}catch(c){if(d!==void 0)try{(0,A.closeSync)(d)}catch{}try{(0,A.unlinkSync)(o)}catch{}throw c}}var Se=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(Wt(Qe.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,te.join)((0,ze.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_DECISION_CHECK_ENABLED:"true",KEEPMIND_DECISION_CHECK_MAX_ROWS:"3",KEEPMIND_CURATED_PROJECT:"",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_INJECT_SOURCE_KIND:"all",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,te.join)((0,ze.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${y("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return y(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let s=this.get(e);return parseInt(s,10)}static getBool(e){let s=this.get(e);return s==="true"||s===!0}static applyEnvOverrides(e){let s={...e};for(let t of Object.keys(this.DEFAULTS)){let n=this.envOverride(t);n!==void 0&&(s[t]=n)}return s}static toCanonicalKeys(e){let s={};for(let[t,n]of Object.entries(e)){if(!t.startsWith("CLAUDE_MEM_")){s[t]=n;continue}let o="KEEPMIND_"+t.slice(11);e[o]===void 0&&(s[o]=n)}return s}static loadFromFile(e,s=!0){try{if(!(0,F.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,te.dirname)(e);(0,F.existsSync)(d)||(0,F.mkdirSync)(d,{recursive:!0}),ee(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return s?this.applyEnvOverrides(a):a}let t=(0,F.readFileSync)(e,"utf-8"),n=JSON.parse(t.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{ee(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=G(a,o);d!==void 0&&(i[a]=d)}if(ft(o))try{ee(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return s?this.applyEnvOverrides(i):i}catch(t){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t instanceof Error?t.message:String(t));let n=this.getAllDefaults();try{if((0,F.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,F.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}ee(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return s?this.applyEnvOverrides(n):n}}};var se=require("fs"),Ne=require("path");var M=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=St(),s=y("KEEPMIND_MODES_DIR"),t=[...s?[s]:[],(0,Ne.join)(e,"modes"),(0,Ne.join)(e,"..","plugin","modes")],n=t.find(o=>(0,se.existsSync)(o));this.modesDir=n||t[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let s=e.split("--");if(s.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(s.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:s[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,s){let t={...e};for(let n in s){let o=s[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?t[n]=this.deepMerge(i,o):t[n]=o}return t}loadModeFile(e){let s=(0,Ne.join)(this.modesDir,`${e}.json`);if(!(0,se.existsSync)(s))throw new Error(`Mode file not found: ${s}`);let t=(0,se.readFileSync)(s,"utf-8");return JSON.parse(t)}loadMode(e){let s=this.parseInheritance(e);if(!s.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,u.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:t,overrideId:n}=s,o;try{o=this.loadMode(t)}catch(d){d instanceof Error?u.warn("WORKER",`Parent mode '${t}' not found for ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Parent mode '${t}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),u.debug("SYSTEM",`Loaded override file: ${n} for parent ${t}`)}catch(d){return d instanceof Error?u.warn("WORKER",`Override file '${n}' not found, using parent mode '${t}' only`,{message:d.message}):u.warn("WORKER",`Override file '${n}' not found, using parent mode '${t}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return u.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${t}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,u.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${t} + ${n})`,void 0,{parent:t,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(t=>t.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(t=>t.id===e)?.work_emoji||"\u{1F4DD}"}};function Yt(){let r=H.settings(),e=Se.loadFromFile(r),s=M.getInstance().getActiveMode(),t=new Set(s.observation_types.map(o=>o.id)),n=new Set(s.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:t,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true",injectSourceKind:Q(e.KEEPMIND_INJECT_SOURCE_KIND)}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},Re=4,Ze=1;function et(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/Re)}function tt(r){let e=r.length,s=r.reduce((i,a)=>i+et(a),0),t=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=t-s,o=t>0?Math.round(n/t*100):0;return{totalObservations:e,totalReadTokens:s,totalDiscoveryTokens:t,savings:n,savingsPercent:o}}function an(r){return M.getInstance().getWorkEmoji(r)}function re(r,e){let s=et(r),t=r.discovery_tokens||0,n=an(r.type),o=t>0?`${n} ${t.toLocaleString("en-US")}`:"-";return{readTokens:s,discoveryTokens:t,discoveryDisplay:o,workEmoji:n}}function Ie(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}function dn(r){return un(r)}var cn=28;function un(r){let e=(r.title?.length??8)+cn;return Math.max(1,Math.ceil(e/Re))}function ln(r,e){if(!Number.isFinite(e)||e<=0)return r;let s=[],t=0;for(let n of r){let o=dn(n);t+o>e||(s.push(n),t+=o)}return s}function qt(r,e){let s=e.now??Date.now(),t=r.map(i=>({o:i,score:Ot(i,{now:s,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?t.slice(0,e.maxRows):t;return ln(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var Jt=V(require("path"),1),Oe=require("fs");function Qt(r,e,s,t){let n=Array.from(s.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(s.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t??null,t??null,s.injectSourceKind??"all",s.injectSourceKind??"all",...n,...i,s.totalObservationCount)}function zt(r,e,s,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t??null,t??null,s.sessionCount+Ze)}function Zt(r,e,s,t){let n=Array.from(s.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(s.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.injectSourceKind??"all",s.injectSourceKind??"all",...n,...i,s.totalObservationCount)}function es(r,e,s,t){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.sessionCount+Ze)}function pn(r){return r.replace(/[/.]/g,"-")}function _n(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let t of e.message.content)t.type==="text"&&(s+=t.text);if(s=s.replace(wt,"").trim(),s)return s}return null}function mn(r){for(let e=r.length-1;e>=0;e--)try{let s=_n(r[e]);if(s)return s}catch(s){s instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function En(r){try{if(!(0,Oe.existsSync)(r))return{assistantMessage:""};let e=(0,Oe.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let s=e.split(`
`).filter(n=>n.trim());return{assistantMessage:mn(s)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function ts(r,e,s,t){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==s);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=pn(t),a=Jt.default.join(B,"projects",i,`${o}.jsonl`);return En(a)}function ss(r,e){let s=e[0]?.id;return r.map((t,n)=>{let o=n===0?null:e[n+1];return{...t,displayEpoch:o?o.created_at_epoch:t.created_at_epoch,displayTime:o?o.created_at:t.created_at,shouldShowLink:t.id!==s}})}function rs(r,e){let s=[...r.map(t=>({type:"observation",data:t})),...e.map(t=>({type:"summary",data:t}))];return s.sort((t,n)=>{let o=t.type==="observation"?t.data.created_at_epoch:t.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),s}function ns(r,e){return new Set(r.slice(0,e).map(s=>s.id))}function is(){let r=new Date,e=r.toLocaleDateString("en-CA"),s=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function as(r){return[`# [${r}] recent context, ${is()}`,""]}function ds(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function cs(r,e){let s=[],t=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${r.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?t.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&t.push(`${r.savings.toLocaleString("en-US")}t saved`)),s.push(`Stats: ${t.join(" | ")}`),s.push(""),s}function st(r,e=new Date){let s=new Date(r);if(Number.isNaN(s.getTime()))return null;let t=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((t(e)-t(s))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function us(r){let e=st(r);return[e?`### ${r} (${e})`:`### ${r}`]}function ls(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function ps(r,e,s){let t=r.title||"Untitled",n=M.getInstance().getTypeIcon(r.type),o=e?ls(e):'"';return`${r.id} ${o} ${n} ${t}`}function _s(r,e,s,t){let n=[],o=r.title||"Untitled",i=M.getInstance().getTypeIcon(r.type),a=e?ls(e):'"',{readTokens:d,discoveryDisplay:c}=re(r,t);n.push(`**${r.id}** ${a} ${i} **${o}**`),s&&n.push(s);let l=[];return t.showReadTokens&&l.push(`~${d}t`),t.showWorkTokens&&l.push(c),l.length>0&&n.push(l.join(" ")),n.push(""),n}function ms(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}var os=200;function ne(r,e){if(!e)return[];let s=e.length>os?`${e.slice(0,os).trimEnd()}\u2026`:e;return[`**${r}**: ${s}`,""]}function Es(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function gs(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function fs(r){return`# [${r}] recent context, ${is()}

No previous sessions found.`}function Ts(){let r=new Date,e=r.toLocaleDateString("en-CA"),s=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function bs(r){return["",`${p.bright}${p.cyan}[${r}] recent context, ${Ts()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function hs(){let e=M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function Ss(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function Ns(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${p.reset}`,`${p.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function Rs(r,e){let s=[];if(s.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),s.push(`${p.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),s.push(`${p.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let t="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?t+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?t+=`${r.savings.toLocaleString()} tokens`:t+=`${r.savingsPercent}% reduction from reuse`,s.push(`${p.green}${t}${p.reset}`)}return s.push(""),s}function Is(r){return[`${p.bright}${p.cyan}${r}${p.reset}`,""]}function Os(r){return[`${p.dim}${r}${p.reset}`]}function As(r,e,s,t){let n=r.title||"Untitled",o=M.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=re(r,t),c=s?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),l=t.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",_=t.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${r.id}${p.reset}  ${c}  ${o}  ${n} ${l} ${_}`}function ys(r,e,s,t,n){let o=[],i=r.title||"Untitled",a=M.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:l}=re(r,n),_=s?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),m=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",T=n.showWorkTokens&&c>0?`${p.dim}(${l} ${c.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${r.id}${p.reset}  ${_}  ${a}  ${p.bright}${i}${p.reset}`),t&&o.push(`    ${p.dim}${t}${p.reset}`),(m||T)&&o.push(`    ${m} ${T}`),o.push(""),o}function Ds(r,e){let s=`${r.request||"Session started"} (${e})`;return[`${p.yellow}#S${r.id}${p.reset} ${s}`,""]}function oe(r,e,s){return e?[`${s}${r}:${p.reset} ${e}`,""]:[]}function Cs(r){return r.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${r.assistantMessage}${p.reset}`,""]:[]}function vs(r,e){let s=Math.round(r/1e3);return["",`${p.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${p.reset}`]}function Ls(r){return`
${p.bright}${p.cyan}[${r}] recent context, ${Ts()}${p.reset}
${p.gray}${"\u2500".repeat(60)}${p.reset}

${p.dim}No previous sessions found for this project yet.${p.reset}
`}function Ms(r,e,s,t){let n=[];return t?n.push(...bs(r)):n.push(...as(r)),t?n.push(...hs()):n.push(...ds()),t&&(n.push(...Ss()),n.push(...Ns())),Ie(s)&&(t?n.push(...Rs(e,s)):n.push(...cs(e,s))),n}function xs(r){if(!r||r.length===0)return[];let e=[];for(let s of r){let t=(s.created_at??"").slice(0,10),n=st(t),o=n?`${t} \xB7 ${n}`:t,i=null;try{let a=s.metadata?JSON.parse(s.metadata):null;a&&typeof a.focus=="string"&&a.focus.trim()&&(i=a.focus.trim())}catch{}e.push(`# \u23F3 CHECKPOINT \u2014 ${s.project} (${o})`),e.push("Curated hand-off from the previous session. Resume from here before anything else."),i&&e.push(`_Focus: ${i}_`),e.push(""),s.narrative&&s.narrative.trim()&&(e.push(s.narrative.trim()),e.push("")),e.push("---"),e.push("")}return e}var x=require("node:fs"),rt=require("node:path");var gn="curated-import-state.json",ie=1;function fn(r){return(0,rt.join)(r,gn)}function Tn(r){let e=fn(r);if(!(0,x.existsSync)(e))return{version:ie,projects:{}};try{let s=JSON.parse((0,x.readFileSync)(e,"utf8"));return s?.version!==ie?{version:ie,projects:{}}:{version:ie,projects:s.projects??{}}}catch(s){return u.warn("DB","Curated import state unreadable \u2014 treating as absent",{path:e},s instanceof Error?s:void 0),{version:ie,projects:{}}}}function Ps(r=R){return Object.values(Tn(r).projects)}function bn(r){let e=0,s=0,t=[r];for(;t.length>0;){let n=t.pop(),o;try{o=(0,x.readdirSync)(n,{withFileTypes:!0}),s=Math.max(s,(0,x.statSync)(n).mtimeMs)}catch{continue}for(let i of o){let a=(0,rt.join)(n,i.name);if(i.isDirectory()){t.push(a);continue}if(i.isFile()){e+=1;try{s=Math.max(s,(0,x.statSync)(a).mtimeMs)}catch{}}}}return{files:e,newest:s}}function ws(r){return r.map(e=>{let s=!1;try{s=(0,x.statSync)(e.path).isDirectory()}catch{s=!1}if(!s)return{path:e.path,kind:e.kind,files:0,newestMtimeEpoch:0,present:!1};let{files:t,newest:n}=bn(e.path);return{path:e.path,kind:e.kind,files:t,newestMtimeEpoch:Math.round(n),present:!0}})}function ks(r,e){if(!r||r.lastSuccessEpoch===null)return{stale:!0,reason:"never imported successfully"};if(!r.indexed)return{stale:!0,reason:"the last import was not indexed \u2014 its records are not searchable"};let s=new Map(r.sources.map(t=>[t.path,t]));for(let t of e){let n=s.get(t.path);if(!n)return{stale:!0,reason:`a source was added: ${t.path}`};if(!t.present)return{stale:!0,reason:`a source is missing: ${t.path}`};if(t.files!==n.files)return{stale:!0,reason:`${t.path} holds ${t.files} file(s), ${n.files} at the last import`};if(t.newestMtimeEpoch>n.newestMtimeEpoch)return{stale:!0,reason:`${t.path} was changed after the last import`}}for(let t of r.sources)if(!e.some(n=>n.path===t.path))return{stale:!0,reason:`a source was removed from the configuration: ${t.path}`};return{stale:!1,reason:null}}var K=require("node:fs"),De=require("node:path");var ot=require("node:path");var Fs="settings.json",Us="curatedSources",ae="KEEPMIND_CURATED_SOURCES";function nt(r,e){if(!Array.isArray(r))return e.push({entry:r,reason:`expected an array, got ${typeof r}`}),[];let s=[];for(let t of r){if(typeof t!="object"||t===null){e.push({entry:t,reason:"not an object"});continue}let n=t,o=n.path,i=n.kind;if(typeof o!="string"||o.trim().length===0){e.push({entry:t,reason:"missing `path`"});continue}if(i!=="akten"&&i!=="vorgaenge"){e.push({entry:t,reason:`\`kind\` must be "akten" or "vorgaenge", got ${JSON.stringify(i)}`});continue}if(!(0,De.isAbsolute)(o)){e.push({entry:t,reason:`\`path\` must be absolute: ${o}`});continue}let a=n.project;if(a!==void 0&&(typeof a!="string"||a.trim().length===0)){e.push({entry:t,reason:`\`project\` must be a non-empty string when given, got ${JSON.stringify(a)}`});continue}s.push({path:(0,De.resolve)(o),kind:i,...a?{project:a.trim()}:{}})}return s}function $s(r,e){let s=new Map;for(let t of r){let n=t.project??e,o=s.get(n);o?o.push(t):s.set(n,[t])}return s}function js(r=R){let e=[],s=process.env[ae];if(s&&s.trim().length>0){let n=s.trim();try{return n.startsWith("[")?{sources:nt(JSON.parse(n),e),origin:`${ae} (inline)`,rejected:e}:(0,K.existsSync)(n)?{sources:nt(JSON.parse((0,K.readFileSync)(n,"utf8")),e),origin:n,rejected:e}:(e.push({entry:n,reason:`${ae} is neither JSON nor an existing file`}),{sources:[],origin:ae,rejected:e})}catch(o){return e.push({entry:n,reason:`unreadable: ${o instanceof Error?o.message:o}`}),{sources:[],origin:ae,rejected:e}}}let t=(0,ot.join)(r,Fs);if(!(0,K.existsSync)(t))return{sources:[],origin:t,rejected:e};try{let n=JSON.parse((0,K.readFileSync)(t,"utf8"));return Us in n?{sources:nt(n[Us],e),origin:t,rejected:e}:{sources:[],origin:t,rejected:e}}catch(n){return u.warn("DB","Could not read curated source set",{settingsPath:t},n instanceof Error?n:void 0),e.push({entry:t,reason:`unreadable: ${n instanceof Error?n.message:n}`}),{sources:[],origin:t,rejected:e}}}function Ks(r=R){let e=y("KEEPMIND_CURATED_PROJECT");if(e&&e.trim().length>0)return e.trim();let s=(0,ot.join)(r,Fs);if(!(0,K.existsSync)(s))return null;try{let t=JSON.parse((0,K.readFileSync)(s,"utf8")),n=t.env??t,o=G("KEEPMIND_CURATED_PROJECT",n);return typeof o=="string"&&o.trim().length>0?o.trim():null}catch{return null}}function Hs(r=R){let e=new Map;for(let i of Ps(r))e.set(i.project,i);let s=js(r),t=new Map;if(s.sources.length>0){let i=s.sources.filter(d=>d.project);for(let[d,c]of $s(i,"(unattributed)"))d!=="(unattributed)"&&t.set(d,c);let a=s.sources.filter(d=>!d.project);if(a.length>0){let d=Ks(r),c=d?[d]:e.size>0?[...e.keys()]:[];for(let l of c)t.set(l,[...t.get(l)??[],...a]);c.length===0&&t.set("(no project configured)",a)}}let n=new Set([...e.keys(),...t.keys()]),o=[];for(let i of n){let a=e.get(i)??null,d=t.get(i)??[],c=d.length>0?ks(a,ws(d)):{stale:a===null||a.lastSuccessEpoch===null,reason:a?null:"never imported"};o.push({project:i,lastSuccessEpoch:a?.lastSuccessEpoch??null,lastAttemptEpoch:a?.lastAttemptEpoch??0,records:a?.records??0,edges:a?.edges??0,indexed:a?.indexed??!1,failure:a?.failure??null,stale:c.stale,staleReason:c.reason,ok:a!==null&&a.lastSuccessEpoch!==null&&a.indexed&&!a.failure&&!c.stale,sources:d})}return o.sort((i,a)=>i.project.localeCompare(a.project))}function hn(r,e=Date.now()){if(r.lastSuccessEpoch===null)return"never";let s=new Date(r.lastSuccessEpoch).toISOString().slice(0,10),t=Math.floor((e-r.lastSuccessEpoch)/864e5);return t<=0?`${s} \xB7 today`:t===1?`${s} \xB7 yesterday`:`${s} \xB7 ${t} days ago`}function Ce(r,e=Date.now()){let s=hn(r,e);if(r.ok)return`last imported ${s} \xB7 ${r.records} record(s), ${r.edges} relation(s) \xB7 index in sync`;let t=new Set;return r.lastSuccessEpoch===null&&t.add("never imported successfully"),r.failure&&t.add(r.failure),r.indexed||t.add("NOT in the semantic index \u2014 semantic search cannot see these records"),r.stale&&r.staleReason&&t.add(r.staleReason),`last imported ${s} \u2014 ${[...t].join("; ")}`}function Gs(r={}){let e=r.now??Date.now(),s;try{s=r.entries??Hs()}catch(i){return u.debug("WORKER","Curated health could not be read",{},i instanceof Error?i:void 0),[]}if(s.length===0)return[];let t=s.filter(i=>!i.ok),n=[];if(t.length===0){for(let i of s)n.push(`Curated corpus [${i.project}]: ${Ce(i,e)}`);return n.push(""),n}n.push("# \u26A0 CURATED CORPUS OUT OF STEP"),n.push("The lasting entries below are not in step with their source files. Answers drawn from them may be out of date."),n.push("");for(let i of t)n.push(`- **${i.project}** \u2014 ${Ce(i,e)}`);let o=s.filter(i=>i.ok);for(let i of o)n.push(`- ${i.project} \u2014 ${Ce(i,e)}`);return n.push(""),n.push("Fix it with `npx keepmind curated:import` (add `--project <name>`), then `npx keepmind doctor`."),n.push(""),n.push("---"),n.push(""),n}var ve=V(require("path"),1);function Le(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function at(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Xs(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Bs(r,e){return ve.default.isAbsolute(r)?ve.default.relative(e,r).split(ve.default.sep).join("/"):r}function Ws(r,e,s){let t=Le(r);if(t.length>0)return Bs(t[0],e);if(s){let n=Le(s);if(n.length>0)return Bs(n[0],e)}return"General"}function Sn(r){let e=new Map;for(let t of r){let n=t.type==="observation"?t.data.created_at:t.data.displayTime,o=Xs(n);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,n)=>{let o=new Date(t[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(s)}function Vs(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Le(r.facts).join(`
`):null}function Nn(r,e,s,t){let n=[];n.push(...us(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=it(a.displayTime);n.push(...ms(a,d))}else{let a=i.data,d=at(a.created_at),l=d!==o?d:"";if(o=d,s.has(a.id)){let m=Vs(a,t);n.push(..._s(a,l,m,t))}else n.push(ps(a,l,t))}return n}function Rn(r,e,s,t,n){let o=[];o.push(...Is(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,l=it(c.displayTime);o.push(...Ds(c,l))}else{let c=d.data,l=Ws(c.files_modified,n,c.files_read),_=at(c.created_at),m=_!==a;a=_;let T=s.has(c.id);if(l!==i&&(o.push(...Os(l)),i=l),T){let I=Vs(c,t);o.push(...ys(c,_,m,I,t))}else o.push(As(c,_,m,t))}return o.push(""),o}function In(r,e,s,t,n,o){return o?Rn(r,e,s,t,n):Nn(r,e,s,t)}function Ys(r,e,s,t,n){let o=[],i=Sn(r);for(let[a,d]of i)o.push(...In(a,d,e,s,t,n));return o}function qs(r,e,s){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function Js(r,e){let s=[];return e?(s.push(...oe("Investigated",r.investigated,p.blue)),s.push(...oe("Learned",r.learned,p.yellow)),s.push(...oe("Completed",r.completed,p.green)),s.push(...oe("Next Steps",r.next_steps,p.magenta))):(s.push(...ne("Investigated",r.investigated)),s.push(...ne("Learned",r.learned)),s.push(...ne("Completed",r.completed)),s.push(...ne("Next Steps",r.next_steps))),s}function Qs(r,e){return e?Cs(r):Es(r)}function zs(r,e,s){return!Ie(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:s?vs(r.totalDiscoveryTokens,r.totalReadTokens):gs(r.totalDiscoveryTokens,r.totalReadTokens)}var On=Zs.default.join((0,er.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function An(){try{return new Te}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,tr.unlinkSync)(On)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function yn(r,e){return e?Ls(r):fs(r)}function Dn(r,e,s,t,n,o,i,a){let d=[],c=tt(e);d.push(...Ms(r,c,n,a)),d.push(...Gs()),d.push(...xs(t));let l=s.slice(0,n.sessionCount),_=ss(l,s),m=rs(e,_),T=ns(e,n.fullObservationCount);d.push(...Ys(m,T,n,o,a));let I=s[0],O=e[0];qs(n,I,O)&&d.push(...Js(I,a));let f=ts(e,n,i,o);return d.push(...Qs(f,a)),d.push(...zs(c,n,a)),d.join(`
`).trimEnd()}var Cn=new Set(["bugfix","discovery","decision","refactor","security_alert","security_note"]);function vn(r,e,s){let t=tt(r),n={bugfix:0,discovery:0,decision:0,refactor:0,security_alert:0,security_note:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=Cn.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_security_alert:n.security_alert,obs_type_security_note:n.security_note,obs_type_other:n.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function dt(r,e=!1){let s=Yt(),t=me(),n=r?.cwd??process.cwd(),o=Xt(n),i=r?.projects?.length?r.projects:o.allProjects,a=i[i.length-1]??o.primary,d=t.importance.enabled&&!r?.full,c=s.totalObservationCount;d&&(s.totalObservationCount=Math.max(c,c*Math.max(1,t.injection.candidateMultiplier))),r?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let l=An();if(!l)return{text:"",stats:null};try{let _=r?.platformSource?D(r.platformSource):void 0,m=i.length>1?Zt(l,i,s,_):Qt(l,a,s,_),T=d?qt(m,{tokenBudget:t.injection.tokenBudget,halfLifeDays:t.importance.halfLifeDays,maxRows:c}):m,I=i.length>1?es(l,i,s,_):zt(l,a,s,_),O=l.getActiveCheckpoints(i);return T.length>0&&l.markObservationsUsed(T.map(g=>g.id),"injection"),T.length===0&&I.length===0&&O.length===0?{text:yn(a,e),stats:null}:{text:Dn(a,T,I,O,s,n,r?.session_id,e),stats:vn(T,I,!!r?.full)}}finally{l.close()}}async function sr(r,e=!1){return(await dt(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
