"use strict";var hs=Object.create;var z=Object.defineProperty;var Is=Object.getOwnPropertyDescriptor;var Rs=Object.getOwnPropertyNames;var Ns=Object.getPrototypeOf,Os=Object.prototype.hasOwnProperty;var As=(r,e)=>{for(var t in e)z(r,t,{get:e[t],enumerable:!0})},Ke=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Rs(e))!Os.call(r,n)&&n!==t&&z(r,n,{get:()=>e[n],enumerable:!(s=Is(e,n))||s.enumerable});return r};var B=(r,e,t)=>(t=r!=null?hs(Ns(r)):{},Ke(e||!r||!r.__esModule?z(t,"default",{value:r,enumerable:!0}):t,r)),ys=r=>Ke(z({},"__esModule",{value:!0}),r);var Ur={};As(Ur,{generateContext:()=>Ss,generateContextWithStats:()=>je});module.exports=ys(Ur);var Ts=B(require("path"),1),fs=require("os"),bs=require("fs");var Ye=require("node:sqlite");function We(r){return typeof r=="bigint"?Number(r):r}function Ds(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)&&!(r instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(r))}function Ve(r){return r===void 0?null:typeof r=="boolean"?r?1:0:r}function Z(r){let e=r;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&Ds(e[0])){let t=e[0],s={};for(let n of Object.keys(t))s[n]=Ve(t[n]);return[s]}return e.map(Ve)}var be=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...Z(e))}get(...e){return this.stmt.get(...Z(e))??null}run(...e){let t=this.stmt.run(...Z(e));return{changes:We(t.changes),lastInsertRowid:We(t.lastInsertRowid)}}values(...e){return this.stmt.all(...Z(e)).map(s=>Object.values(s))}finalize(){}},H=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let s=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new Ye.DatabaseSync(n,{readOnly:s,allowExtension:!0}),!s&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new be(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let s=this.prepare(e);return this.queryCache.set(e,s),s}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let s=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;s?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,s?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,s?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var T=require("path"),Oe=require("os"),M=require("fs");var Ze=require("url");var qe="KEEPMIND_",Je="CLAUDE_MEM_";function Qe(r){return r.startsWith(qe)?Je+r.slice(qe.length):null}function v(r,e=process.env){let t=e[r];if(t!==void 0)return t;let s=Qe(r);return s?e[s]:void 0}function ee(r,e){let t=e[r];if(t!==void 0)return t;let s=Qe(r);return s?e[s]:void 0}function ze(r){return Object.keys(r).some(e=>e.startsWith(Je))}var P=require("fs"),Ie=require("path");var Ls=null;function Cs(r){return(Ls??process.stderr.write.bind(process.stderr))(r)}function Se(r){Cs(r)}var vs=14,Re=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Re||{}),he=null,Ms=6e4,xs=500,X=new Map;function Ps(r,e,t,s){let n=`${r}|${e}|${t}`,o=X.get(n);if(o&&s-o.windowStartedAt<Ms)return o.suppressed++,null;if(!o&&X.size>=xs){let d=X.keys().next();d.done||X.delete(d.value)}let i=o?.suppressed??0,a=o?Math.round((s-o.windowStartedAt)/1e3):0;return X.set(n,{windowStartedAt:s,suppressed:0}),i>0?` (repeated ${i}\xD7 in the previous ${a}s)`:""}var Ne=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=$.logsDir();(0,P.existsSync)(e)||(0,P.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ie.join)(e,`keepmind-${t}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let t=Date.now()-vs*24*60*60*1e3;for(let s of(0,P.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(s);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<t)try{(0,P.unlinkSync)((0,Ie.join)(e,s))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=$.settings();if((0,P.existsSync)(e)){let t=(0,P.readFileSync)(e,"utf-8"),n=(JSON.parse(t).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=Re[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let b=Ps(e,t,s,Date.now());if(b===null)return;i=b}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=Re[e].padEnd(5),u=t.padEnd(6),l="";n?.correlationId?l=`[${n.correlationId}] `:n?.sessionId&&(l=`[session-${n.sessionId}] `);let m="";if(o!=null)if(o instanceof Error)m=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{m=`
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let _="";if(n){let{sessionId:b,memorySessionId:N,correlationId:O,...S}=n;Object.keys(S).length>0&&(_=` {${Object.entries(S).map(([C,f])=>`${C}=${f}`).join(", ")}}`)}let g=`[${a}] [${d}] [${u}] ${l}${s}${i}${_}${m}`;if(this.logFilePath)try{(0,P.appendFileSync)(this.logFilePath,g+`
`,"utf8")}catch(b){Se(`[LOGGER] Failed to write to log file: ${b instanceof Error?b.message:String(b)}
`)}else Se(g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=u?`${u[1].split("/").pop()}:${u[2]}`:"unknown",m={...s,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},c=new Ne;var Ks={};function ws(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ze.fileURLToPath)(Ks.url))}var ks=ws();function Us(){let r=v("KEEPMIND_DATA_DIR");if(r)return r;let e=(0,T.join)((0,Oe.homedir)(),".keepmind"),t=(0,T.join)(e,"settings.json");try{if((0,M.existsSync)(t)){let s=JSON.parse((0,M.readFileSync)(t,"utf-8")),n=s.env??s,o=ee("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var A=Us(),G=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,Oe.homedir)(),".claude"),Yr=(0,T.join)(G,"plugins","marketplaces","keepmind"),Fs=(0,T.join)(A,"archives"),$s=(0,T.join)(A,"logs"),Gs=(0,T.join)(A,"trash"),Bs=(0,T.join)(A,"backups"),Hs=(0,T.join)(A,"modes"),qr=(0,T.join)(A,"settings.json"),U=(0,T.join)(A,"keepmind.db"),j=(0,T.join)(A,"claude-mem.db"),Xs=(0,T.join)(A,"vector-db"),et=(0,T.join)(A,"observer-sessions"),Ae=(0,T.basename)(et),Jr=(0,T.join)(G,"settings.json"),Qr=(0,T.join)(G,"commands"),zr=(0,T.join)(G,"CLAUDE.md");function tt(r){(0,M.mkdirSync)(r,{recursive:!0})}function js(){try{if((0,M.existsSync)(U)||!(0,M.existsSync)(j))return(0,M.existsSync)(U);for(let r of["","-wal","-shm"]){let e=j+r,t=U+r;(0,M.existsSync)(e)&&!(0,M.existsSync)(t)&&(0,M.renameSync)(e,t)}return c.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:j,to:U}),!0}catch(r){return c.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},r instanceof Error?r:new Error(String(r))),!1}}function ye(){return js(),!(0,M.existsSync)(U)&&(0,M.existsSync)(j)?j:U}function st(){return(0,T.join)(ks,"..")}var $={dataDir:()=>A,workerPid:()=>(0,T.join)(A,"worker.pid"),workerPort:()=>(0,T.join)(A,"worker.port"),serverPid:()=>(0,T.join)(A,".server-beta.pid"),serverPort:()=>(0,T.join)(A,".server-beta.port"),serverRuntime:()=>(0,T.join)(A,".server-beta.runtime.json"),settings:()=>(0,T.join)(A,"settings.json"),database:()=>ye(),chroma:()=>(0,T.join)(A,"chroma"),combinedCerts:()=>(0,T.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(A,"transcript-watch-state.json"),corpora:()=>(0,T.join)(A,"corpora"),supervisorRegistry:()=>(0,T.join)(A,"supervisor.json"),envFile:()=>(0,T.join)(A,".env"),logsDir:()=>$s,archives:()=>Fs,trash:()=>Gs,backups:()=>Bs,modes:()=>Hs,vectorDb:()=>Xs,observerSessions:()=>et};var rt=require("crypto");function De(r,e,t){return(0,rt.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Le(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var Ce=r=>`\xABredacted:${r}\xBB`,Ws=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1}];function Vs(r,e){if(e.re.lastIndex=0,e.group===void 0)return r.replace(e.re,Ce(e.type));let t=e.group;return r.replace(e.re,(s,...n)=>{let o=n[t-1];return typeof o!="string"||o.length===0?s:s.replace(o,Ce(e.type))})}function Ys(r){if(r.length===0)return 0;let e=new Map;for(let s of r)e.set(s,(e.get(s)??0)+1);let t=0;for(let s of e.values()){let n=s/r.length;t-=n*Math.log2(n)}return t}var qs=/^[0-9a-f]+$/i;function Js(r,e){return r.length<20||r.length>200||/[\s]/.test(r)||!/\d/.test(r)||!/[A-Za-z]/.test(r)||r.includes("/")||r.includes("\\")||r.length<=64&&qs.test(r)||r.includes("redacted:")?!1:Ys(r)>=e}var Qs=/([\s"'`,;(){}\[\]<>]+)/;function zs(r,e){let t=r.split(Qs);for(let s=0;s<t.length;s++){let n=t[s];n&&Js(n,e)&&(t[s]=Ce("HIGH_ENTROPY"))}return t.join("")}function ve(r,e={}){if(typeof r!="string"||r.length===0)return r;try{let t=r;for(let s of Ws)t=Vs(t,s);return e.entropySweep!==!1&&(t=zs(t,e.entropyThreshold??4)),t}catch{return r}}function te(r,e={}){if(typeof r=="string")return ve(r,e);if(Array.isArray(r))return r.map(t=>te(t,e));if(r&&typeof r=="object"){let t={};for(let[s,n]of Object.entries(r))t[s]=te(n,e);return t}return r}var re=require("fs");var xe={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function se(r){return!!r&&typeof r=="object"&&!Array.isArray(r)}function F(r,e){if(!se(e))return{...r};let t={...r};for(let s of Object.keys(r))e[s]!==void 0&&typeof e[s]==typeof r[s]&&(t[s]=e[s]);return t}var Me=null;function ne(r=!1){if(Me&&!r)return Me;let e=xe,t;try{let o=$.settings();if((0,re.existsSync)(o)){let i=JSON.parse((0,re.readFileSync)(o,"utf-8").replace(/^﻿/,"")),a=se(i)?i.memoryQuality??(se(i.env)?i.env.memoryQuality:void 0):void 0;se(a)&&(t=a)}}catch(o){c.debug("CONFIG","memoryQuality config load failed; using defaults",{},o instanceof Error?o:new Error(String(o)))}let s={redactSecrets:F(e.redactSecrets,t?.redactSecrets),scoping:F(e.scoping,t?.scoping),importance:F(e.importance,t?.importance),injection:F(e.injection,t?.injection),reconcile:F(e.reconcile,t?.reconcile),supersession:F(e.supersession,t?.supersession),expiry:F(e.expiry,t?.expiry),optimizer:F(e.optimizer,t?.optimizer)},n=v("KEEPMIND_REDACT_SECRETS");return(n==="0"||n==="false")&&(s.redactSecrets.enabled=!1),Me=s,s}var Zs={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function er(r){if(Array.isArray(r))return r.length;if(typeof r=="string")try{let e=JSON.parse(r);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function Pe(r){let e=Zs[r.type??"other"]??4;return er(r.files_modified)>0&&(e+=1),(r.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(r.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var tr=14,sr=864e5;function nt(r,e={}){let t=e.now??Date.now(),s=(e.halfLifeDays??tr)*sr,n=(r.importance??5)/10,o=Math.max(0,t-(r.created_at_epoch??t)),i=Math.pow(.5,o/s);return n*i}var rr=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will"]);function oe(r){return r?r.toLowerCase().replace(/[^a-z0-9\s]+/g," ").split(/\s+/).filter(e=>e.length>0&&!rr.has(e)).join(" ").trim():""}function ot(r){let e=new Set,t=r.replace(/\s+/g," ");for(let s=0;s+3<=t.length;s++)e.add(t.slice(s,s+3));return e}function nr(r,e){let t=ot(r),s=ot(e);if(t.size===0&&s.size===0)return 1;if(t.size===0||s.size===0)return 0;let n=0;for(let o of t)s.has(o)&&n++;return n/(t.size+s.size-n)}function or(r,e){let t=new Map,s=new Map;for(let a of r.split(" "))a&&t.set(a,(t.get(a)??0)+1);for(let a of e.split(" "))a&&s.set(a,(s.get(a)??0)+1);if(t.size===0||s.size===0)return 0;let n=0;for(let[a,d]of t)n+=d*(s.get(a)??0);let o=0;for(let a of t.values())o+=a*a;let i=0;for(let a of s.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function ir(r,e){let t=oe(`${r??""}`),s=oe(`${e??""}`);return Math.max(nr(t,s),or(t,s))}function it(r,e,t){let s=`${r.title??""} ${r.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=ir(s,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=t.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=t.updateBand&&t.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var at=require("crypto");function we(r){let e=r.title??"";if(!e){if(Array.isArray(r.facts)&&r.facts.length>0)e=r.facts[0];else if(typeof r.facts=="string")try{let s=JSON.parse(r.facts);Array.isArray(s)&&s.length>0&&(e=String(s[0]))}catch{}}e||(e=(r.narrative??"").slice(0,80));let t=oe(e);return(0,at.createHash)("sha1").update(t).digest("hex").slice(0,16)}var E="claude";function ar(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return E;let e=ar(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:E}function dt(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ut(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(a,t,o)??void 0}var pt=["private","keepmind-context","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],ct=new RegExp(`<(${pt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),mt=/<system-reminder>[\s\S]*?<\/system-reminder>/g,lt=100;function dr(r){let e=Object.fromEntries(pt.map(n=>[n,0]));ct.lastIndex=0;let t=0,s=r.replace(ct,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>lt&&c.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:lt,contentLength:r.length}),{stripped:s.trim(),counts:e}}function _t(r){return dr(r).stripped}var ur=["task-notification"],Tn=new RegExp(`^\\s*<(${ur.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),fn=256*1024;var ke=4e3;function ie(r){let e=r.trim(),s=_t(r).trim()||e;return s.length<=ke?s:(c.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:ke}),`${s.slice(0,ke-1)}\u2026`)}function pr(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var ae=class{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?ve(e,this.redactOpts):e}rl(e){return this.redactEnabled?te(e,this.redactOpts):e}constructor(e=U){try{this.mq=ne();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=xe,this.redactEnabled=v("KEEPMIND_REDACT_SECRETS")!=="0"&&v("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof H)this.db=e;else{e!==":memory:"&&tt(A);let t=e===U?ye():e;this.db=new H(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn()}addObservationBitemporalColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(37),t=this.db.query("PRAGMA table_info(observations)").all(),s=n=>t.some(o=>o.name===n);e&&s("valid_from")&&s("valid_to")&&s("subject_key")||(s("valid_from")||this.db.run("ALTER TABLE observations ADD COLUMN valid_from INTEGER"),s("valid_to")||this.db.run("ALTER TABLE observations ADD COLUMN valid_to INTEGER"),s("subject_key")||this.db.run("ALTER TABLE observations ADD COLUMN subject_key TEXT"),this.db.run("UPDATE observations SET valid_from = created_at_epoch WHERE valid_from IS NULL"),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_subject_valid ON observations(project, subject_key, valid_to)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(37,new Date().toISOString()))}addObservationLastUsedColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(38),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="last_used_at");e&&s||(s||this.db.run("ALTER TABLE observations ADD COLUMN last_used_at INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_last_used ON observations(last_used_at)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(38,new Date().toISOString()))}addObservationImportanceColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(36),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="importance");e&&s||(s||this.db.run("ALTER TABLE observations ADD COLUMN importance INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_importance ON observations(importance)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(36,new Date().toISOString()))}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?D(s):void 0;return n?this.db.prepare(`
    ...
    `).get(e,D(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:u}=t,l=s==="relevance",m=l?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!l?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),b=[...e],N=[];if(o&&(N.push("o.project = ?"),b.push(o)),i&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),b.push(D(i))),a)if(Array.isArray(a)){let I=a.map(()=>"?").join(",");N.push(`o.type IN (${I})`),b.push(...a)}else N.push("o.type = ?"),b.push(a);if(d){let I=Array.isArray(d)?d:[d],h=I.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");b.push(...I),N.push(`(${h.join(" OR ")})`)}if(u){let I=Array.isArray(u)?u:[u],h=I.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");I.forEach(y=>{b.push(`%${y}%`,`%${y}%`)}),N.push(`(${h.join(" OR ")})`)}let O=N.length>0?`WHERE o.id IN (${g}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${g})`,L=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${O}
      ${m}
      ${_}
    `).all(...b);if(!l)return L;let C=new Map(L.map(I=>[I.id,I])),f=e.map(I=>C.get(I)).filter(I=>!!I);return n?f.slice(0,n):f}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=pr(n,o),u=d.platformSource??E,l=this.rt(ie(s)),m=this.db.prepare(`
    ...
    `).get(E,u,e);if(m)return t&&this.db.prepare(`
        ...
        `).run(d.customTitle,m.id),m.id;let _=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,u,l,d.customTitle||null,i.toISOString(),a);return Number(_.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=this.rt(ie(s)),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),u=new Date(d).toISOString(),l=this.rt(s.title),m=this.rt(s.subtitle),_=this.rt(s.narrative),g=this.rl(s.facts),b=this.rt(s.metadata??null),N=De(e,l??null,_??null),O=Pe({type:s.type,narrative:_,files_modified:s.files_modified}),S;if(this.mq.reconcile.enabled){let I=this.reconcileBeforeInsert(t,s.type,l??null,_??null);if(I.action==="NOOP"&&I.candidateId){let h=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(I.candidateId);if(h)return{id:h.id,createdAtEpoch:h.created_at_epoch}}else I.action==="UPDATE"&&(S=I.candidateId)}let C=this.db.prepare(`
    ...
    `).get(e,t,s.type,l,m,JSON.stringify(g),_,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,N,u,d,a||null,b,O,d,we({title:l??null,facts:g,narrative:_??null}));if(C)return S!==void 0&&this.mq.supersession.enabled&&this.supersedeObservation(S,C.id,d),{id:C.id,createdAtEpoch:C.created_at_epoch};let f=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,N);if(!f)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${N}`);return{id:f.id,createdAtEpoch:f.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),l=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,this.rt(s.request),this.rt(s.investigated),this.rt(s.learned),this.rt(s.completed),this.rt(s.next_steps),this.rt(s.notes),n||null,o,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let u=a??Date.now(),l=new Date(u).toISOString();return this.db.transaction(()=>{let _=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
    ...
    `).all(e,t,t):this.db.prepare("SELECT * FROM observations WHERE project = ?").all(e)}deleteObservationsByProject(e,t={}){let s=(e??"").trim();if(s===""||s==="*")throw new Error(`deleteObservationsByProject: refusing unsafe project '${e}'`);let n=this.db.prepare("SELECT count(*) AS c FROM observations WHERE project = ?").get(s).c,o=this.db.prepare("SELECT count(*) AS c FROM session_summaries WHERE project = ?").get(s).c;if(t.dryRun)return{project:s,dryRun:!0,observationsDeleted:n,summariesDeleted:o};this.db.transaction(()=>{this.db.prepare("DELETE FROM observations WHERE project = ?").run(s),this.db.prepare("DELETE FROM session_summaries WHERE project = ?").run(s)})();try{this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run("INSERT INTO observations_fts(observations_fts) VALUES('rebuild')")}catch(a){c.warn("DB","observations_fts rebuild after project delete failed",{project:s},a instanceof Error?a:new Error(String(a)))}return c.info("DB","Deleted observations by project",{project:s,observationsDeleted:n,summariesDeleted:o}),{project:s,dryRun:!1,observationsDeleted:n,summariesDeleted:o}}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n&&!a?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),m=[...e],_=[];o&&(_.push("ss.project = ?"),m.push(o)),i&&(_.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),m.push(D(i)));let g=_.length>0?`AND ${_.join(" AND ")}`:"",N=this.db.prepare(`
      ...
      ${d}
      ${u}
    `).all(...m);if(!a)return N;let O=new Map(N.map(L=>[L.id,L])),S=e.map(L=>O.get(L)).filter(L=>!!L);return n?S.slice(0,n):S}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),m=[...e],_=[];o&&(_.push("s.project = ?"),m.push(o)),i&&(_.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),m.push(D(i)));let g=_.length>0?`AND ${_.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${u}
    `).all(...m);if(!a)return N;let O=new Map(N.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?D(i):void 0,d=(f,I)=>{let h=[],y=[];return o&&(h.push(`${f}.project = ?`),y.push(o)),a&&(h.push(`COALESCE(NULLIF(${I}.platform_source, ''), '${E}') = ?`),y.push(a)),{clause:h.length>0?`AND ${h.join(" AND ")}`:"",params:y}},u=d("o","src"),l=d("ss","src"),m=d("s","s"),_,g;if(e!==null){let f=`
...
`,"utf-8"),a;try{a=(0,R.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,R.openSync)(o,"w",a):(0,R.openSync)(o,"w");let u=0;for(;u<i.length;){let l=(0,R.writeSync)(d,i,u,i.length-u);if(l===0)throw new Error(`writeSync stalled at ${u}/${i.length} bytes`);u+=l}if((0,R.fsyncSync)(d),(0,R.closeSync)(d),d=void 0,(0,R.renameSync)(o,t),!Er){let l;try{l=(0,R.openSync)(s,"r"),(0,R.fsyncSync)(l)}catch{}finally{if(l!==void 0)try{(0,R.closeSync)(l)}catch{}}}}catch(u){if(d!==void 0)try{(0,R.closeSync)(d)}catch{}try{(0,R.unlinkSync)(o)}catch{}throw u}}var ce=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(ht(Ue.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,V.join)((0,Fe.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,V.join)((0,Fe.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${v("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${v("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${v("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return v(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS)){let n=this.envOverride(s);n!==void 0&&(t[s]=n)}return t}static toCanonicalKeys(e){let t={};for(let[s,n]of Object.entries(e)){if(!s.startsWith("CLAUDE_MEM_")){t[s]=n;continue}let o="KEEPMIND_"+s.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,k.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,V.dirname)(e);(0,k.existsSync)(d)||(0,k.mkdirSync)(d,{recursive:!0}),W(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let s=(0,k.readFileSync)(e,"utf-8"),n=JSON.parse(s.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{W(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=ee(a,o);d!==void 0&&(i[a]=d)}if(ze(o))try{W(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(s){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,s instanceof Error?s.message:String(s));let n=this.getAllDefaults();try{if((0,k.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,k.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}W(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var Y=require("fs"),le=require("path");var x=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=st(),t=v("KEEPMIND_MODES_DIR"),s=[...t?[t]:[],(0,le.join)(e,"modes"),(0,le.join)(e,"..","plugin","modes")],n=s.find(o=>(0,Y.existsSync)(o));this.modesDir=n||s[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,le.join)(this.modesDir,`${e}.json`);if(!(0,Y.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,Y.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,c.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(u=>u.id),concepts:d.observation_concepts.map(u=>u.id)}),d}catch(d){if(d instanceof Error?c.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):c.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch(d){d instanceof Error?c.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{message:d.message}):c.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),c.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch(d){return d instanceof Error?c.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{message:d.message}):c.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return c.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,c.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}};function Rt(){let r=$.settings(),e=ce.loadFromFile(r),t=x.getInstance().getActiveMode(),s=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},pe=4,$e=1;function Ge(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/pe)}function Be(r){let e=r.length,t=r.reduce((i,a)=>i+Ge(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Tr(r){return x.getInstance().getWorkEmoji(r)}function q(r,e){let t=Ge(r),s=r.discovery_tokens||0,n=Tr(r.type),o=s>0?`${n} ${s.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function me(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}function fr(r){return Sr(r)}var br=28;function Sr(r){let e=(r.title?.length??8)+br;return Math.max(1,Math.ceil(e/pe))}function hr(r,e){if(!Number.isFinite(e)||e<=0)return r;let t=[],s=0;for(let n of r){let o=fr(n);s+o>e||(t.push(n),s+=o)}return t}function Nt(r,e){let t=e.now??Date.now(),s=r.map(i=>({o:i,score:nt(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?s.slice(0,e.maxRows):s;return hr(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var Ot=B(require("path"),1),_e=require("fs");function At(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,...n,...i,t.totalObservationCount)}function yt(r,e,t,s){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.sessionCount+$e)}function Dt(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
  ...
  `).all(...e,...e,s??null,s??null,...n,...i,t.totalObservationCount)}function Lt(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,s??null,s??null,t.sessionCount+$e)}function Ir(r){return r.replace(/[/.]/g,"-")}function Rr(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(mt,"").trim(),t)return t}return null}function Nr(r){for(let e=r.length-1;e>=0;e--)try{let t=Rr(r[e]);if(t)return t}catch(t){t instanceof Error?c.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):c.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function Or(r){try{if(!(0,_e.existsSync)(r))return{assistantMessage:""};let e=(0,_e.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:Nr(t)}}catch(e){return e instanceof Error?c.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):c.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function Ct(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=Ir(s),a=Ot.default.join(G,"projects",i,`${o}.jsonl`);return Or(a)}function vt(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Mt(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function xt(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function wt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function kt(r){return[`# [${r}] recent context, ${wt()}`,""]}function Ut(){return[`Legend: \u{1F3AF}session ${x.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Ft(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${r.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString("en-US")}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ar(r,e=new Date){let t=new Date(r);if(Number.isNaN(t.getTime()))return null;let s=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((s(e)-s(t))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function $t(r){let e=Ar(r);return[e?`### ${r} (${e})`:`### ${r}`]}function Gt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Bt(r,e,t){let s=r.title||"Untitled",n=x.getInstance().getTypeIcon(r.type),o=e?Gt(e):'"';return`${r.id} ${o} ${n} ${s}`}function Ht(r,e,t,s){let n=[],o=r.title||"Untitled",i=x.getInstance().getTypeIcon(r.type),a=e?Gt(e):'"',{readTokens:d,discoveryDisplay:u}=q(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let l=[];return s.showReadTokens&&l.push(`~${d}t`),s.showWorkTokens&&l.push(u),l.length>0&&n.push(l.join(" ")),n.push(""),n}function Xt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}var Pt=200;function J(r,e){if(!e)return[];let t=e.length>Pt?`${e.slice(0,Pt).trimEnd()}\u2026`:e;return[`**${r}**: ${t}`,""]}function jt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Kt(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Wt(r){return`# [${r}] recent context, ${wt()}

No previous sessions found.`}function Vt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Yt(r){return["",`${p.bright}${p.cyan}[${r}] recent context, ${Vt()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function qt(){let e=x.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function Jt(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function Qt(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${p.reset}`,`${p.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function zt(r,e){let t=[];if(t.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),t.push(`${p.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),t.push(`${p.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${p.green}${s}${p.reset}`)}return t.push(""),t}function Zt(r){return[`${p.bright}${p.cyan}${r}${p.reset}`,""]}function es(r){return[`${p.dim}${r}${p.reset}`]}function ts(r,e,t,s){let n=r.title||"Untitled",o=x.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=q(r,s),u=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),l=s.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",m=s.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${r.id}${p.reset}  ${u}  ${o}  ${n} ${l} ${m}`}function ss(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=x.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:u,workEmoji:l}=q(r,n),m=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),_=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",g=n.showWorkTokens&&u>0?`${p.dim}(${l} ${u.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${r.id}${p.reset}  ${m}  ${a}  ${p.bright}${i}${p.reset}`),s&&o.push(`    ${p.dim}${s}${p.reset}`),(_||g)&&o.push(`    ${_} ${g}`),o.push(""),o}function rs(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${p.yellow}#S${r.id}${p.reset} ${t}`,""]}function Q(r,e,t){return e?[`${t}${r}:${p.reset} ${e}`,""]:[]}function ns(r){return r.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${r.assistantMessage}${p.reset}`,""]:[]}function os(r,e){let t=Math.round(r/1e3);return["",`${p.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${p.reset}`]}function is(r){return`
${p.bright}${p.cyan}[${r}] recent context, ${Vt()}${p.reset}
${p.gray}${"\u2500".repeat(60)}${p.reset}

${p.dim}No previous sessions found for this project yet.${p.reset}
`}function as(r,e,t,s){let n=[];return s?n.push(...Yt(r)):n.push(...kt(r)),s?n.push(...qt()):n.push(...Ut()),s&&(n.push(...Jt()),n.push(...Qt())),me(t)&&(s?n.push(...zt(e,t)):n.push(...Ft(e,t))),n}var Te=B(require("path"),1);function fe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function He(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Xe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function us(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ds(r,e){return Te.default.isAbsolute(r)?Te.default.relative(e,r).split(Te.default.sep).join("/"):r}function cs(r,e,t){let s=fe(r);if(s.length>0)return ds(s[0],e);if(t){let n=fe(t);if(n.length>0)return ds(n[0],e)}return"General"}function yr(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=us(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ls(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?fe(r.facts).join(`
`):null}function Dr(r,e,t,s){let n=[];n.push(...$t(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=He(a.displayTime);n.push(...Xt(a,d))}else{let a=i.data,d=Xe(a.created_at),l=d!==o?d:"";if(o=d,t.has(a.id)){let _=ls(a,s);n.push(...Ht(a,l,_,s))}else n.push(Bt(a,l,s))}return n}function Lr(r,e,t,s,n){let o=[];o.push(...Zt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let u=d.data,l=He(u.displayTime);o.push(...rs(u,l))}else{let u=d.data,l=cs(u.files_modified,n,u.files_read),m=Xe(u.created_at),_=m!==a;a=m;let g=t.has(u.id);if(l!==i&&(o.push(...es(l)),i=l),g){let b=ls(u,s);o.push(...ss(u,m,_,b,s))}else o.push(ts(u,m,_,s))}return o.push(""),o}function Cr(r,e,t,s,n,o){return o?Lr(r,e,t,s,n):Dr(r,e,t,s)}function ps(r,e,t,s,n){let o=[],i=yr(r);for(let[a,d]of i)o.push(...Cr(a,d,e,t,s,n));return o}function ms(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function _s(r,e){let t=[];return e?(t.push(...Q("Investigated",r.investigated,p.blue)),t.push(...Q("Learned",r.learned,p.yellow)),t.push(...Q("Completed",r.completed,p.green)),t.push(...Q("Next Steps",r.next_steps,p.magenta))):(t.push(...J("Investigated",r.investigated)),t.push(...J("Learned",r.learned)),t.push(...J("Completed",r.completed)),t.push(...J("Next Steps",r.next_steps))),t}function Es(r,e){return e?ns(r):jt(r)}function gs(r,e,t){return!me(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?os(r.totalDiscoveryTokens,r.totalReadTokens):Kt(r.totalDiscoveryTokens,r.totalReadTokens)}var vr=Ts.default.join((0,fs.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function Mr(){try{return new ae}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,bs.unlinkSync)(vr)}catch(e){e instanceof Error?c.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):c.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return c.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function xr(r,e){return e?is(r):Wt(r)}function Pr(r,e,t,s,n,o,i){let a=[],d=Be(e);a.push(...as(r,d,s,i));let u=t.slice(0,s.sessionCount),l=vt(u,t),m=Mt(e,l),_=xt(e,s.fullObservationCount);a.push(...ps(m,_,s,n,i));let g=t[0],b=e[0];ms(s,g,b)&&a.push(..._s(g,i));let N=Ct(e,s,o,n);return a.push(...Es(N,i)),a.push(...gs(d,s,i)),a.join(`
`).trimEnd()}var wr=new Set(["bugfix","discovery","decision","refactor"]);function kr(r,e,t){let s=Be(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let u=wr.has(d.type)?d.type:"other";n[u]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function je(r,e=!1){let t=Rt(),s=ne(),n=r?.cwd??process.cwd(),o=St(n),i=r?.projects?.length?r.projects:o.allProjects,a=i[i.length-1]??o.primary,d=s.importance.enabled&&!r?.full,u=t.totalObservationCount;d&&(t.totalObservationCount=Math.max(u,u*Math.max(1,s.injection.candidateMultiplier))),r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let l=Mr();if(!l)return{text:"",stats:null};try{let m=r?.platformSource?D(r.platformSource):void 0,_=i.length>1?Dt(l,i,t,m):At(l,a,t,m),g=d?Nt(_,{tokenBudget:s.injection.tokenBudget,halfLifeDays:s.importance.halfLifeDays,maxRows:u}):_,b=i.length>1?Lt(l,i,t,m):yt(l,a,t,m);return g.length>0&&l.markObservationsUsed(g.map(O=>O.id)),g.length===0&&b.length===0?{text:xr(a,e),stats:null}:{text:Pr(a,g,b,t,n,r?.session_id,e),stats:kr(g,b,!!r?.full)}}finally{l.close()}}async function Ss(r,e=!1){return(await je(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
