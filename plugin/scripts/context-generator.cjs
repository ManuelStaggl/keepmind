"use strict";var cs=Object.create;var le=Object.defineProperty;var us=Object.getOwnPropertyDescriptor;var ls=Object.getOwnPropertyNames;var ps=Object.getPrototypeOf,_s=Object.prototype.hasOwnProperty;var ms=(s,e)=>{for(var t in e)le(s,t,{get:e[t],enumerable:!0})},lt=(s,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ls(e))!_s.call(s,n)&&n!==t&&le(s,n,{get:()=>e[n],enumerable:!(r=us(e,n))||r.enumerable});return s};var q=(s,e,t)=>(t=s!=null?cs(ps(s)):{},lt(e||!s||!s.__esModule?le(t,"default",{value:s,enumerable:!0}):t,s)),Es=s=>lt(le({},"__esModule",{value:!0}),s);var Fn={};ms(Fn,{generateContext:()=>ds,generateContextWithStats:()=>ct});module.exports=Es(Fn);var os=q(require("path"),1),is=require("os"),as=require("fs");var mt=require("node:sqlite");function pt(s){return typeof s=="bigint"?Number(s):s}function gs(s){return s!==null&&typeof s=="object"&&!Array.isArray(s)&&!(s instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(s))}function _t(s){return s===void 0?null:typeof s=="boolean"?s?1:0:s}function pe(s){let e=s;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&gs(e[0])){let t=e[0],r={};for(let n of Object.keys(t))r[n]=_t(t[n]);return[r]}return e.map(_t)}var we=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...pe(e))}get(...e){return this.stmt.get(...pe(e))??null}run(...e){let t=this.stmt.run(...pe(e));return{changes:pt(t.changes),lastInsertRowid:pt(t.lastInsertRowid)}}values(...e){return this.stmt.all(...pe(e)).map(r=>Object.values(r))}finalize(){}},J=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let r=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new mt.DatabaseSync(n,{readOnly:r,allowExtension:!0}),!r&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new we(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let r=this.prepare(e);return this.queryCache.set(e,r),r}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let r=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;r?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,r?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,r?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var h=require("path"),Ke=require("os"),L=require("fs");var bt=require("url");var Et="KEEPMIND_",gt="CLAUDE_MEM_";function ft(s){return s.startsWith(Et)?gt+s.slice(Et.length):null}function y(s,e=process.env){let t=e[s];if(t!==void 0)return t;let r=ft(s);return r?e[r]:void 0}function G(s,e){let t=e[s];if(t!==void 0)return t;let r=ft(s);return r?e[r]:void 0}function Tt(s){return Object.keys(s).some(e=>e.startsWith(gt))}var P=require("fs"),Fe=require("path");var fs=null;function Ts(s){return(fs??process.stderr.write.bind(process.stderr))(s)}function ke(s){Ts(s)}var bs=14,$e=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))($e||{}),Ue=null,hs=6e4,Ss=500,Q=new Map;function Ns(s,e){try{let t="";if(s){for(let r of Object.keys(s).sort())if(t+=`${r}=${String(s[r])};`,t.length>200)break}return e instanceof Error?t+=`E:${e.message}`:typeof e=="string"||typeof e=="number"||typeof e=="boolean"?t+=`D:${e}`:e&&(t+="D:obj"),t.slice(0,200)}catch{return""}}function Rs(s,e,t,r,n,o){let i=`${s}|${e}|${t}|${Ns(n,o)}`,a=Q.get(i);if(a&&r-a.windowStartedAt<hs)return a.suppressed++,null;if(!a&&Q.size>=Ss){let l=Q.keys().next();l.done||Q.delete(l.value)}let d=a?.suppressed??0,c=a?Math.round((r-a.windowStartedAt)/1e3):0;return Q.set(i,{windowStartedAt:r,suppressed:0}),d>0?` (repeated ${d}\xD7 in the previous ${c}s)`:""}var je=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=H.logsDir();(0,P.existsSync)(e)||(0,P.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Fe.join)(e,`keepmind-${t}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let t=Date.now()-bs*24*60*60*1e3;for(let r of(0,P.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(r);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<t)try{(0,P.unlinkSync)((0,Fe.join)(e,r))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,P.existsSync)(e)){let t=(0,P.readFileSync)(e,"utf-8"),n=(JSON.parse(t).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=$e[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let r=t;if(typeof t=="string")try{r=JSON.parse(t)}catch{r=t}if(e==="Bash"&&r.command)return`${e}(${r.command})`;if(r.file_path)return`${e}(${r.file_path})`;if(r.notebook_path)return`${e}(${r.notebook_path})`;if(e==="Glob"&&r.pattern)return`${e}(${r.pattern})`;if(e==="Grep"&&r.pattern)return`${e}(${r.pattern})`;if(r.url)return`${e}(${r.url})`;if(r.query)return`${e}(${r.query})`;if(e==="Task"){if(r.subagent_type)return`${e}(${r.subagent_type})`;if(r.description)return`${e}(${r.description})`}return e==="Skill"&&r.skill?`${e}(${r.skill})`:e==="LSP"&&r.operation?`${e}(${r.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${r}-${n} ${o}:${i}:${a}.${d}`}log(e,t,r,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let I=Rs(e,t,r,Date.now(),n,o);if(I===null)return;i=I}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=$e[e].padEnd(5),c=t.padEnd(6),l="";n?.correlationId?l=`[${n.correlationId}] `:n?.sessionId&&(l=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let m="";if(n){let{sessionId:I,memorySessionId:O,correlationId:T,...f}=n;Object.keys(f).length>0&&(m=` {${Object.entries(f).map(([k,b])=>`${k}=${b}`).join(", ")}}`)}let g=`[${a}] [${d}] [${c}] ${l}${r}${i}${m}${_}`;if(this.logFilePath)try{(0,P.appendFileSync)(this.logFilePath,g+`
`,"utf8")}catch(I){ke(`[LOGGER] Failed to write to log file: ${I instanceof Error?I.message:String(I)}
`)}else ke(g+`
`)}debug(e,t,r,n){this.log(0,e,t,r,n)}info(e,t,r,n){this.log(1,e,t,r,n)}warn(e,t,r,n){this.log(2,e,t,r,n)}setErrorSink(e){Ue=e}error(e,t,r,n){this.log(3,e,t,r,n),this.routeErrorToSink(t,r,n)}routeErrorToSink(e,t,r){try{if(!Ue||!(r instanceof Error))return;Ue(r)}catch{}}dataIn(e,t,r,n){this.info(e,`\u2192 ${t}`,r,n)}dataOut(e,t,r,n){this.info(e,`\u2190 ${t}`,r,n)}success(e,t,r,n){this.info(e,`\u2713 ${t}`,r,n)}failure(e,t,r,n){this.error(e,`\u2717 ${t}`,r,n)}happyPathError(e,t,r,n,o=""){let c=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",_={...r,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,_,n),o}},u=new je;var Ps={};function Is(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,bt.fileURLToPath)(Ps.url))}var Os=Is();function As(){let s=y("KEEPMIND_DATA_DIR");if(s)return s;let e=(0,h.join)((0,Ke.homedir)(),".keepmind"),t=(0,h.join)(e,"settings.json");try{if((0,L.existsSync)(t)){let r=JSON.parse((0,L.readFileSync)(t,"utf-8")),n=r.env??r,o=G("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var R=As(),X=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,Ke.homedir)(),".claude"),qn=(0,h.join)(X,"plugins","marketplaces","keepmind"),ys=(0,h.join)(R,"archives"),Ds=(0,h.join)(R,"logs"),Cs=(0,h.join)(R,"trash"),vs=(0,h.join)(R,"backups"),Ls=(0,h.join)(R,"modes"),Jn=(0,h.join)(R,"settings.json"),j=(0,h.join)(R,"keepmind.db"),z=(0,h.join)(R,"claude-mem.db"),Ms=(0,h.join)(R,"vector-db"),ht=(0,h.join)(R,"observer-sessions"),He=(0,h.basename)(ht),Qn=(0,h.join)(X,"settings.json"),zn=(0,h.join)(X,"commands"),Zn=(0,h.join)(X,"CLAUDE.md");function St(s){(0,L.mkdirSync)(s,{recursive:!0})}function xs(){try{if((0,L.existsSync)(j)||!(0,L.existsSync)(z))return(0,L.existsSync)(j);for(let s of["","-wal","-shm"]){let e=z+s,t=j+s;(0,L.existsSync)(e)&&!(0,L.existsSync)(t)&&(0,L.renameSync)(e,t)}return u.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:z,to:j}),!0}catch(s){return u.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},s instanceof Error?s:new Error(String(s))),!1}}function Z(){return xs(),!(0,L.existsSync)(j)&&(0,L.existsSync)(z)?z:j}function Nt(){return(0,h.join)(Os,"..")}var H={dataDir:()=>R,workerPid:()=>(0,h.join)(R,"worker.pid"),workerPort:()=>(0,h.join)(R,"worker.port"),serverPid:()=>(0,h.join)(R,".server-beta.pid"),serverPort:()=>(0,h.join)(R,".server-beta.port"),serverRuntime:()=>(0,h.join)(R,".server-beta.runtime.json"),settings:()=>(0,h.join)(R,"settings.json"),database:()=>Z(),chroma:()=>(0,h.join)(R,"chroma"),combinedCerts:()=>(0,h.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,h.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,h.join)(R,"transcript-watch-state.json"),corpora:()=>(0,h.join)(R,"corpora"),supervisorRegistry:()=>(0,h.join)(R,"supervisor.json"),envFile:()=>(0,h.join)(R,".env"),logsDir:()=>Ds,archives:()=>ys,trash:()=>Cs,backups:()=>vs,modes:()=>Ls,vectorDb:()=>Ms,observerSessions:()=>ht};var Rt={injection:"injection_count",explicit_fetch:"explicit_fetch_count",fts:"fts_hit_count",vector:"vector_hit_count"};function ee(s){let e=typeof s=="string"?s.trim().toLowerCase():"";return e==="curated"||e==="observed"?e:"all"}function _e(s){return`COALESCE(${s?`${s}.`:""}source_kind, 'observed')`}function Be(s,e){return s==="all"?null:{sql:`${_e(e)} = ?`,param:s}}var It=require("crypto");function Ge(s,e,t){return(0,It.createHash)("sha256").update([s||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Xe(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[String(e)]}catch{return[s]}}var We=s=>`\xABredacted:${s}\xBB`,ws=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:jdbc:[a-z0-9]{1,20}:)?(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|sqlserver|oracle|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"CREDENTIAL_ASSIGNMENT",re:/\b(?:password|pwd|passwd)\s{0,3}=\s{0,3}(?:"([^"\r\n]{1,200})"|'([^'\r\n]{1,200})'|([^;"'\r\n]{1,200}))/gi,group:1},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1},{type:"EMAIL",category:"pii",re:/\b[\w.+-]{1,64}@[\w-]{1,63}(?:\.[\w-]{1,63}){1,4}\b/g},{type:"IP_ADDRESS",category:"pii",re:/\b(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\b/g,keep:s=>s==="0.0.0.0"||s==="255.255.255.255"||s.startsWith("127.")}];function Ot(s){return s.includes("redacted:")}function ks(s,e){if(e.re.lastIndex=0,e.group===void 0)return s.replace(e.re,r=>Ot(r)||e.keep?.(r)?r:We(e.type));let t=e.group;return s.replace(e.re,(r,...n)=>{if(e.keep?.(r))return r;let o=r,i=!1;for(let a=t-1;a<n.length;a++){let d=n[a];typeof d!="string"||d.length===0||Ot(d)||(o=o.replace(d,We(e.type)),i=!0)}return i?o:r})}function Us(s){if(s.length===0)return 0;let e=new Map;for(let r of s)e.set(r,(e.get(r)??0)+1);let t=0;for(let r of e.values()){let n=r/s.length;t-=n*Math.log2(n)}return t}var Fs=/^[0-9a-f]+$/i;function $s(s,e){return s.length<20||s.length>200||/[\s]/.test(s)||!/\d/.test(s)||!/[A-Za-z]/.test(s)||s.includes("/")||s.includes("\\")||s.length<=64&&Fs.test(s)||s.includes("redacted:")?!1:Us(s)>=e}var js=/([\s"'`,;(){}\[\]<>]+)/;function Ks(s,e){let t=s.split(js);for(let r=0;r<t.length;r++){let n=t[r];n&&$s(n,e)&&(t[r]=We("HIGH_ENTROPY"))}return t.join("")}function Ve(s,e={}){if(typeof s!="string"||s.length===0)return s;try{let t=s,r=e.pii!==!1;for(let n of ws)n.category==="pii"&&!r||(t=ks(t,n));return e.entropySweep!==!1&&(t=Ks(t,e.entropyThreshold??4)),t}catch{return s}}function me(s,e={}){if(typeof s=="string")return Ve(s,e);if(Array.isArray(s))return s.map(t=>me(t,e));if(s&&typeof s=="object"){let t={};for(let[r,n]of Object.entries(s))t[r]=me(n,e);return t}return s}var ge=require("fs");var qe={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0,pii:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},vectorRetention:{enabled:!0,inactiveDays:90},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function Ee(s){return!!s&&typeof s=="object"&&!Array.isArray(s)}function K(s,e){if(!Ee(e))return{...s};let t={...s};for(let r of Object.keys(s))e[r]!==void 0&&typeof e[r]==typeof s[r]&&(t[r]=e[r]);return t}var Ye=null;function fe(s=!1){if(Ye&&!s)return Ye;let e=qe,t;try{let i=H.settings();if((0,ge.existsSync)(i)){let a=JSON.parse((0,ge.readFileSync)(i,"utf-8").replace(/^﻿/,"")),d=Ee(a)?a.memoryQuality??(Ee(a.env)?a.env.memoryQuality:void 0):void 0;Ee(d)&&(t=d)}}catch(i){u.debug("CONFIG","memoryQuality config load failed; using defaults",{},i instanceof Error?i:new Error(String(i)))}let r={redactSecrets:K(e.redactSecrets,t?.redactSecrets),scoping:K(e.scoping,t?.scoping),importance:K(e.importance,t?.importance),injection:K(e.injection,t?.injection),reconcile:K(e.reconcile,t?.reconcile),supersession:K(e.supersession,t?.supersession),expiry:K(e.expiry,t?.expiry),vectorRetention:K(e.vectorRetention,t?.vectorRetention),optimizer:K(e.optimizer,t?.optimizer)},n=y("KEEPMIND_REDACT_SECRETS");(n==="0"||n==="false")&&(r.redactSecrets.enabled=!1);let o=y("KEEPMIND_REDACT_PII");return(o==="0"||o==="false")&&(r.redactSecrets.pii=!1),Ye=r,r}var Hs={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function Bs(s){if(Array.isArray(s))return s.length;if(typeof s=="string")try{let e=JSON.parse(s);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function Je(s){let e=Hs[s.type??"other"]??4;return Bs(s.files_modified)>0&&(e+=1),(s.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(s.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var Gs=14,Xs=864e5;function At(s,e={}){let t=e.now??Date.now(),r=(e.halfLifeDays??Gs)*Xs,n=(s.importance??5)/10,o=Math.max(0,t-(s.created_at_epoch??t)),i=Math.pow(.5,o/r);return n*i}function Dt(s){return s.normalize("NFC").toLowerCase().replace(/ä/g,"ae").replace(/ö/g,"oe").replace(/ü/g,"ue").replace(/ß/g,"ss")}var Ws=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will","der","die","das","den","dem","des","ein","eine","einen","einem","einer","eines","und","oder","aber","ist","sind","war","waren","wird","werden","wurde","wurden","hat","haben","hatte","hatten","f\xFCr","mit","von","vom","zu","zum","zur","im","auf","am","an","aus","bei","nach","\xFCber","unter","durch","gegen","ohne","um","als","wie","dass","sich","es","wir","man","auch","noch","nur","schon","dann","wenn","weil","damit","sowie","bereits"].map(Dt));function Te(s){return s?Dt(s).replace(/[^\p{L}\p{N}\s]+/gu," ").split(/\s+/).filter(e=>e.length>0&&!Ws.has(e)).join(" ").trim():""}function yt(s){let e=new Set,t=s.replace(/\s+/g," ");for(let r=0;r+3<=t.length;r++)e.add(t.slice(r,r+3));return e}function Vs(s,e){let t=yt(s),r=yt(e);if(t.size===0&&r.size===0)return 1;if(t.size===0||r.size===0)return 0;let n=0;for(let o of t)r.has(o)&&n++;return n/(t.size+r.size-n)}function Ys(s,e){let t=new Map,r=new Map;for(let a of s.split(" "))a&&t.set(a,(t.get(a)??0)+1);for(let a of e.split(" "))a&&r.set(a,(r.get(a)??0)+1);if(t.size===0||r.size===0)return 0;let n=0;for(let[a,d]of t)n+=d*(r.get(a)??0);let o=0;for(let a of t.values())o+=a*a;let i=0;for(let a of r.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function qs(s,e){let t=Te(`${s??""}`),r=Te(`${e??""}`);return Math.max(Vs(t,r),Ys(t,r))}function Ct(s,e,t){let r=`${s.title??""} ${s.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=qs(r,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=t.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=t.updateBand&&t.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var vt=require("crypto");function be(s){let e=s.title??"";if(!e){if(Array.isArray(s.facts)&&s.facts.length>0)e=s.facts[0];else if(typeof s.facts=="string")try{let r=JSON.parse(s.facts);Array.isArray(r)&&r.length>0&&(e=String(r[0]))}catch{}}e||(e=(s.narrative??"").slice(0,80));let t=Te(e);return(0,vt.createHash)("sha1").update(t).digest("hex").slice(0,16)}var E="claude";function Js(s){return s.trim().toLowerCase().replace(/\s+/g,"-")}function D(s){if(!s)return E;let e=Js(s);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:E}function Lt(s){let e=["claude","codex","cursor"];return[...s].sort((t,r)=>{let n=e.indexOf(t),o=e.indexOf(r);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(r)})}function Mt(s,e,t,r,n){let o=Date.now()-r,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return s.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,o)??void 0}var wt=["private","keepmind-context","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],xt=new RegExp(`<(${wt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),kt=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Pt=100;function Qs(s){let e=Object.fromEntries(wt.map(n=>[n,0]));xt.lastIndex=0;let t=0,r=s.replace(xt,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Pt&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Pt,contentLength:s.length}),{stripped:r.trim(),counts:e}}function Ut(s){return Qs(s).stripped}var zs=["task-notification"],ho=new RegExp(`^\\s*<(${zs.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),So=256*1024;var Qe=4e3;function he(s){let e=s.trim(),r=Ut(s).trim()||e;return r.length<=Qe?r:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:r.length,storedLength:Qe}),`${r.slice(0,Qe-1)}\u2026`)}var W="session-checkpoint";function Ft(s){let t=(s.split(`
`).map(r=>r.trim()).find(r=>r.length>0)??"Session checkpoint").replace(/^#+\s*/,"").replace(/^\*+\s*/,"").replace(/\*+$/,"").trim();return t?t.length>80?`${t.slice(0,80).trimEnd()}\u2026`:t:"Session checkpoint"}var Zs=/^0\d{3}$/,en=/^V-\d{4}$/;function tn(s){let e=s?`${s}.`:"";return`COALESCE(json_extract(${e}metadata, '$.record_id'), json_extract(${e}metadata, '$.vorgang_id'))`}var w=tn();function rn(s){let e=s.trim();return Zs.test(e)?"akte":en.test(e)?"vorgang":null}function $t(s,e){if(s)try{if(JSON.parse(s)?.kind==="vorgang")return"vorgang"}catch{}return(e&&rn(e))==="vorgang"?"vorgang":"akte"}var jt="keepmind://curated/";var B="revised_by";function on(s,e){return{customTitle:s,platformSource:e?D(e):void 0}}var Se=class{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?Ve(e,this.redactOpts):e}rl(e){return this.redactEnabled?me(e,this.redactOpts):e}constructor(e=j){try{this.mq=fe();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=qe,this.redactEnabled=y("KEEPMIND_REDACT_SECRETS")!=="0"&&y("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof J)this.db=e;else{e!==":memory:"&&St(R);let t=e===j?Z():e;this.db=new J(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns(),this.recomputeSubjectKeys(),this.addCuratedSourceColumns(),this.createDecisionEdgesTable()}createDecisionEdgesTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42),t=this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all();e&&t.length>0||(this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?D(e):void 0,r=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[He];return t&&(r+=" AND COALESCE(platform_source, ?) = ?",n.push(E,t)),r+=" ORDER BY project ASC",this.db.prepare(r).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(He),t=[],r=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),r.has(i.project)||(r.add(i.project),t.push(i.project))}let o=Lt(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let r=this.resolvePromptSessionDbId(e,t),n=r!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=r!==null?r:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,r,n){return Mt(this.db,e,he(t),r,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,r){let n=[e],o="";return r&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`,n.push(D(r))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,D(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}filterObservationIdsBySourceKind(e,t){let r=Be(ee(t),"o");if(!r||e.length===0)return e;let n=this.db.prepare(`
      SELECT o.id FROM observations o
      WHERE o.id IN (SELECT value FROM json_each(?)) AND ${r.sql}
    `).all(JSON.stringify(e),r.param),o=new Set(n.map(i=>i.id));return e.filter(i=>o.has(i))}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:r="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:c,sourceKind:l}=t,_=r==="relevance",m=_?"":`ORDER BY o.created_at_epoch ${r==="date_asc"?"ASC":"DESC"}`,g=n&&!_?`LIMIT ${n}`:"",I=e.map(()=>"?").join(","),O=[...e],T=[];o&&(T.push("o.project = ?"),O.push(o)),i&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),O.push(D(i)));let f=Be(ee(l),"o");if(f&&(T.push(f.sql),O.push(f.param)),a)if(Array.isArray(a)){let S=a.map(()=>"?").join(",");T.push(`o.type IN (${S})`),O.push(...a)}else T.push("o.type = ?"),O.push(a);if(d){let S=Array.isArray(d)?d:[d],Pe=S.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...S),T.push(`(${Pe.join(" OR ")})`)}if(c){let S=Array.isArray(c)?c:[c],Pe=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");S.forEach(ut=>{O.push(`%${ut}%`,`%${ut}%`)}),T.push(`(${Pe.join(" OR ")})`)}let C=T.length>0?`WHERE o.id IN (${I}) AND ${T.join(" AND ")}`:`WHERE o.id IN (${I})`,b=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${C}
      ${m}
      ${g}
    `).all(...O);if(!_)return b;let v=new Map(b.map(S=>[S.id,S])),N=e.map(S=>v.get(S)).filter(S=>!!S);return n?N.slice(0,n):N}getSummaryForSession(e,t){let r=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(...r)||null}getFilesForSession(e){let r=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),n=new Set,o=new Set;for(let i of r)Xe(i.files_read).forEach(a=>n.add(a)),Xe(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(n),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,t,r,n,o){let i=new Date,a=i.getTime(),d=on(n,o),c=d.platformSource??E,l=this.rt(he(r)),_=this.db.prepare(`
    ...
    `).get(E,c,e);if(_)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,l,d.customTitle||null,i.toISOString(),a);return Number(m.lastInsertRowid)}saveUserPrompt(e,t,r,n){let o=new Date,i=o.getTime(),a=this.rt(he(r)),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,r){let n=this.resolvePromptSessionDbId(e,r);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,r,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),l=this.rt(r.title),_=this.rt(r.subtitle),m=this.rt(r.narrative),g=this.rl(r.facts),I=this.rt(r.metadata??null),O=Ge(e,l??null,m??null),T=Je({type:r.type,narrative:m,files_modified:r.files_modified}),f,C=r.source_kind==="curated";if(this.mq.reconcile.enabled&&!C){let N=this.reconcileBeforeInsert(t,r.type,l??null,m??null);if(N.action==="NOOP"&&N.candidateId){let S=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(N.candidateId);if(S)return{id:S.id,createdAtEpoch:S.created_at_epoch}}else N.action==="UPDATE"&&(f=N.candidateId)}let b=this.db.prepare(`
    ...
    `).run(e,t,this.rt(r.request),this.rt(r.investigated),this.rt(r.learned),this.rt(r.completed),this.rt(r.next_steps),this.rt(r.notes),n||null,o,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,r,n,o,i=0,a,d){let c=a??Date.now(),l=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),I=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let T of r){let f=this.rt(T.title),C=this.rt(T.subtitle),k=this.rt(T.narrative),b=this.rl(T.facts),v=Ge(e,f??null,k??null),N=g.get(e,t,T.type,f,C,JSON.stringify(b),k,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,T.agent_type??null,T.agent_id??null,v,l,c,d||null,Je({type:T.type,narrative:k,files_modified:T.files_modified}),c,be({title:f??null,facts:b,narrative:k??null}));if(N){m.push(N.id);continue}let S=I.get(e,v);if(!S)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${v}`);m.push(S.id)}let O=null;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    `).all(e,t,t):this.db.prepare("SELECT * FROM observations WHERE project = ?").all(e)}storeCheckpoint(e,t,r={}){let n=this.getOrCreateManualSession(e),o=Date.now(),i=r.title&&r.title.trim()?r.title.trim():Ft(t),a={checkpoint:!0};r.focus&&r.focus.trim()&&(a.focus=r.focus.trim());let d=this.storeObservation(n,e,{type:W,title:i,subtitle:"Session checkpoint",facts:[],narrative:t,concepts:[],files_read:[],files_modified:[],metadata:JSON.stringify(a),source_kind:"curated"},0,0,o,r.generatedByModel??void 0);return this.db.prepare(`
      UPDATE observations
         SET valid_to = NULL,
             metadata = json_remove(COALESCE(metadata, '{}'), '$.superseded_by_checkpoint')
       WHERE id = ? AND type = ?
    `).run(d.id,W),this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(COALESCE(metadata, '{}'), '$.superseded_by_checkpoint', ?)
       WHERE project = ? AND type = ? AND valid_to IS NULL AND id != ?
    `).run(o,d.id,e,W,d.id),u.info("DB","Saved session checkpoint",{id:d.id,project:e,title:i}),d}clearCheckpoint(e){let t=Date.now(),r=this.db.prepare(`
      UPDATE observations
         SET valid_to = ?,
             metadata = json_set(COALESCE(metadata, '{}'), '$.checkpoint_cleared', 1)
       WHERE project = ? AND type = ? AND valid_to IS NULL
    `).run(t,e,W),n=Number(r.changes??0);return u.info("DB","Cleared session checkpoint(s)",{project:e,cleared:n}),{cleared:n}}getCuratedRecord(e,t,r={}){let n=r.includeClosed?"":"AND valid_to IS NULL",o=this.db.prepare(`
      SELECT id, project, ${w} AS record_id,
       ...
       LIMIT 1
    `).get(e,t);return o?{...o,kind:$t(o.metadata,o.record_id)}:null}getCuratedRelations(e,t){return this.db.prepare(`
    ...
    `).all(e).map(r=>Number(r.id))}nextCuratedRecordId(e){let t=this.db.prepare(`
      SELECT DISTINCT ${w} AS record_id
        FROM observations
       WHERE project = ? AND source_kind = 'curated'
         AND ${w} IS NOT NULL
    ...
    `).all(..._);if(!a)return O;let T=new Map(O.map(C=>[C.id,C])),f=e.map(C=>T.get(C)).filter(C=>!!C);return n?f.slice(0,n):f}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:r="date_desc",limit:n,project:o,platformSource:i}=t,a=r==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${r==="date_asc"?"ASC":"DESC"}`,c=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),_=[...e],m=[];o&&(m.push("s.project = ?"),_.push(o)),i&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`),_.push(D(i)));let g=m.length>0?`AND ${m.join(" AND ")}`:"",O=this.db.prepare(`
      ...
      ${d}
      ${c}
    `).all(..._);if(!a)return O;let T=new Map(O.map(f=>[f.id,f]));return e.map(f=>T.get(f)).filter(f=>!!f)}getTimelineAroundTimestamp(e,t=10,r=10,n,o){return this.getTimelineAroundObservation(null,e,t,r,n,o)}getTimelineAroundObservation(e,t,r=10,n=10,o,i){let a=i?D(i):void 0,d=(b,v)=>{let N=[],S=[];return o&&(N.push(`${b}.project = ?`),S.push(o)),a&&(N.push(`COALESCE(NULLIF(${v}.platform_source, ''), '${E}') = ?`),S.push(a)),{clause:N.length>0?`AND ${N.join(" AND ")}`:"",params:S}},c=d("o","src"),l=d("ss","src"),_=d("s","s"),m,g;if(e!==null){let b=`
...
`,"utf-8"),a;try{a=(0,A.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,A.openSync)(o,"w",a):(0,A.openSync)(o,"w");let c=0;for(;c<i.length;){let l=(0,A.writeSync)(d,i,c,i.length-c);if(l===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=l}if((0,A.fsyncSync)(d),(0,A.closeSync)(d),d=void 0,(0,A.renameSync)(o,t),!ln){let l;try{l=(0,A.openSync)(r,"r"),(0,A.fsyncSync)(l)}catch{}finally{if(l!==void 0)try{(0,A.closeSync)(l)}catch{}}}}catch(c){if(d!==void 0)try{(0,A.closeSync)(d)}catch{}try{(0,A.unlinkSync)(o)}catch{}throw c}}var Ie=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(Yt(ze.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,ne.join)((0,Ze.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_DECISION_CHECK_ENABLED:"true",KEEPMIND_DECISION_CHECK_MAX_ROWS:"3",KEEPMIND_CURATED_PROJECT:"",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_INJECT_SOURCE_KIND:"all",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,ne.join)((0,Ze.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${y("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return y(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let r of Object.keys(this.DEFAULTS)){let n=this.envOverride(r);n!==void 0&&(t[r]=n)}return t}static toCanonicalKeys(e){let t={};for(let[r,n]of Object.entries(e)){if(!r.startsWith("CLAUDE_MEM_")){t[r]=n;continue}let o="KEEPMIND_"+r.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,F.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,ne.dirname)(e);(0,F.existsSync)(d)||(0,F.mkdirSync)(d,{recursive:!0}),se(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let r=(0,F.readFileSync)(e,"utf-8"),n=JSON.parse(r.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{se(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=G(a,o);d!==void 0&&(i[a]=d)}if(Tt(o))try{se(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(r){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,r instanceof Error?r.message:String(r));let n=this.getAllDefaults();try{if((0,F.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,F.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}se(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var oe=require("fs"),Oe=require("path");var M=class s{static instance=null;activeMode=null;modesDir;constructor(){let e=Nt(),t=y("KEEPMIND_MODES_DIR"),r=[...t?[t]:[],(0,Oe.join)(e,"modes"),(0,Oe.join)(e,"..","plugin","modes")],n=r.find(o=>(0,oe.existsSync)(o));this.modesDir=n||r[0]}static getInstance(){return s.instance||(s.instance=new s),s.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let r={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?r[n]=this.deepMerge(i,o):r[n]=o}return r}loadModeFile(e){let t=(0,Oe.join)(this.modesDir,`${e}.json`);if(!(0,oe.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let r=(0,oe.readFileSync)(t,"utf-8");return JSON.parse(r)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,u.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:r,overrideId:n}=t,o;try{o=this.loadMode(r)}catch(d){d instanceof Error?u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),u.debug("SYSTEM",`Loaded override file: ${n} for parent ${r}`)}catch(d){return d instanceof Error?u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{message:d.message}):u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return u.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${r}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,u.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${r} + ${n})`,void 0,{parent:r,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(r=>r.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(r=>r.id===e)?.work_emoji||"\u{1F4DD}"}};function Jt(){let s=H.settings(),e=Ie.loadFromFile(s),t=M.getInstance().getActiveMode(),r=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:r,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true",injectSourceKind:ee(e.KEEPMIND_INJECT_SOURCE_KIND)}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},Ae=4,et=1;function tt(s){let e=(s.title?.length||0)+(s.subtitle?.length||0)+(s.narrative?.length||0)+JSON.stringify(s.facts||[]).length;return Math.ceil(e/Ae)}function rt(s){let e=s.length,t=s.reduce((i,a)=>i+tt(a),0),r=s.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=r-t,o=r>0?Math.round(n/r*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:r,savings:n,savingsPercent:o}}function _n(s){return M.getInstance().getWorkEmoji(s)}function ie(s,e){let t=tt(s),r=s.discovery_tokens||0,n=_n(s.type),o=r>0?`${n} ${r.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:r,discoveryDisplay:o,workEmoji:n}}function ye(s){return s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent}function mn(s){return gn(s)}var En=28;function gn(s){let e=(s.title?.length??8)+En;return Math.max(1,Math.ceil(e/Ae))}function fn(s,e){if(!Number.isFinite(e)||e<=0)return s;let t=[],r=0;for(let n of s){let o=mn(n);r+o>e||(t.push(n),r+=o)}return t}function Qt(s,e){let t=e.now??Date.now(),r=s.map(i=>({o:i,score:At(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?r.slice(0,e.maxRows):r;return fn(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var zt=q(require("path"),1),De=require("fs");function Zt(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return s.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,r??null,r??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function er(s,e,t,r){return s.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,r??null,r??null,t.sessionCount+et)}function tr(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return s.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,r??null,r??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function rr(s,e,t,r){let n=e.map(()=>"?").join(",");return s.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,r??null,r??null,t.sessionCount+et)}function Tn(s){return s.replace(/[/.]/g,"-")}function bn(s){if(!s.includes('"type":"assistant"'))return null;let e=JSON.parse(s);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let r of e.message.content)r.type==="text"&&(t+=r.text);if(t=t.replace(kt,"").trim(),t)return t}return null}function hn(s){for(let e=s.length-1;e>=0;e--)try{let t=bn(s[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function Sn(s){try{if(!(0,De.existsSync)(s))return{assistantMessage:""};let e=(0,De.readFileSync)(s,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:hn(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:s},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:s,error:String(e)}),{assistantMessage:""}}}function sr(s,e,t,r){if(!e.showLastMessage||s.length===0)return{assistantMessage:""};let n=s.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=Tn(r),a=zt.default.join(X,"projects",i,`${o}.jsonl`);return Sn(a)}function nr(s,e){let t=e[0]?.id;return s.map((r,n)=>{let o=n===0?null:e[n+1];return{...r,displayEpoch:o?o.created_at_epoch:r.created_at_epoch,displayTime:o?o.created_at:r.created_at,shouldShowLink:r.id!==t}})}function or(s,e){let t=[...s.map(r=>({type:"observation",data:r})),...e.map(r=>({type:"summary",data:r}))];return t.sort((r,n)=>{let o=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function ir(s,e){return new Set(s.slice(0,e).map(t=>t.id))}function dr(){let s=new Date,e=s.toLocaleDateString("en-CA"),t=s.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),r=s.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${r}`}function cr(s){return[`# [${s}] recent context, ${dr()}`,""]}function ur(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function lr(s,e){let t=[],r=[`${s.totalObservations} obs (${s.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${s.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return s.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?r.push(`${s.savingsPercent}% savings`):e.showSavingsAmount&&r.push(`${s.savings.toLocaleString("en-US")}t saved`)),t.push(`Stats: ${r.join(" | ")}`),t.push(""),t}function st(s,e=new Date){let t=new Date(s);if(Number.isNaN(t.getTime()))return null;let r=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((r(e)-r(t))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function pr(s){let e=st(s);return[e?`### ${s} (${e})`:`### ${s}`]}function _r(s){return s.toLowerCase().replace(" am","a").replace(" pm","p")}function mr(s,e,t){let r=s.title||"Untitled",n=M.getInstance().getTypeIcon(s.type),o=e?_r(e):'"';return`${s.id} ${o} ${n} ${r}`}function Er(s,e,t,r){let n=[],o=s.title||"Untitled",i=M.getInstance().getTypeIcon(s.type),a=e?_r(e):'"',{readTokens:d,discoveryDisplay:c}=ie(s,r);n.push(`**${s.id}** ${a} ${i} **${o}**`),t&&n.push(t);let l=[];return r.showReadTokens&&l.push(`~${d}t`),r.showWorkTokens&&l.push(c),l.length>0&&n.push(l.join(" ")),n.push(""),n}function gr(s,e){return[`S${s.id} ${s.request||"Session started"} (${e})`]}var ar=200;function ae(s,e){if(!e)return[];let t=e.length>ar?`${e.slice(0,ar).trimEnd()}\u2026`:e;return[`**${s}**: ${t}`,""]}function fr(s){return s.assistantMessage?["","---","","**Previously**","",`A: ${s.assistantMessage}`,""]:[]}function Tr(s,e){return["",`Access ${Math.round(s/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function br(s){return`# [${s}] recent context, ${dr()}

No previous sessions found.`}function hr(){let s=new Date,e=s.toLocaleDateString("en-CA"),t=s.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),r=s.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${r}`}function Sr(s){return["",`${p.bright}${p.cyan}[${s}] recent context, ${hr()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function Nr(){let e=M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function Rr(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function Ir(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${p.reset}`,`${p.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function Or(s,e){let t=[];if(t.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),t.push(`${p.dim}  Loading: ${s.totalObservations} observations (${s.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),t.push(`${p.dim}  Work investment: ${s.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),s.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let r="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?r+=`${s.savings.toLocaleString()} tokens (${s.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?r+=`${s.savings.toLocaleString()} tokens`:r+=`${s.savingsPercent}% reduction from reuse`,t.push(`${p.green}${r}${p.reset}`)}return t.push(""),t}function Ar(s){return[`${p.bright}${p.cyan}${s}${p.reset}`,""]}function yr(s){return[`${p.dim}${s}${p.reset}`]}function Dr(s,e,t,r){let n=s.title||"Untitled",o=M.getInstance().getTypeIcon(s.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=ie(s,r),c=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),l=r.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",_=r.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${s.id}${p.reset}  ${c}  ${o}  ${n} ${l} ${_}`}function Cr(s,e,t,r,n){let o=[],i=s.title||"Untitled",a=M.getInstance().getTypeIcon(s.type),{readTokens:d,discoveryTokens:c,workEmoji:l}=ie(s,n),_=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),m=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",g=n.showWorkTokens&&c>0?`${p.dim}(${l} ${c.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${s.id}${p.reset}  ${_}  ${a}  ${p.bright}${i}${p.reset}`),r&&o.push(`    ${p.dim}${r}${p.reset}`),(m||g)&&o.push(`    ${m} ${g}`),o.push(""),o}function vr(s,e){let t=`${s.request||"Session started"} (${e})`;return[`${p.yellow}#S${s.id}${p.reset} ${t}`,""]}function de(s,e,t){return e?[`${t}${s}:${p.reset} ${e}`,""]:[]}function Lr(s){return s.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${s.assistantMessage}${p.reset}`,""]:[]}function Mr(s,e){let t=Math.round(s/1e3);return["",`${p.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${p.reset}`]}function xr(s){return`
${p.bright}${p.cyan}[${s}] recent context, ${hr()}${p.reset}
${p.gray}${"\u2500".repeat(60)}${p.reset}

${p.dim}No previous sessions found for this project yet.${p.reset}
`}function Pr(s,e,t,r){let n=[];return r?n.push(...Sr(s)):n.push(...cr(s)),r?n.push(...Nr()):n.push(...ur()),r&&(n.push(...Rr()),n.push(...Ir())),ye(t)&&(r?n.push(...Or(e,t)):n.push(...lr(e,t))),n}function wr(s){if(!s||s.length===0)return[];let e=[];for(let t of s){let r=(t.created_at??"").slice(0,10),n=st(r),o=n?`${r} \xB7 ${n}`:r,i=null;try{let a=t.metadata?JSON.parse(t.metadata):null;a&&typeof a.focus=="string"&&a.focus.trim()&&(i=a.focus.trim())}catch{}e.push(`# \u23F3 CHECKPOINT \u2014 ${t.project} (${o})`),e.push("Curated hand-off from the previous session. Resume from here before anything else."),i&&e.push(`_Focus: ${i}_`),e.push(""),t.narrative&&t.narrative.trim()&&(e.push(t.narrative.trim()),e.push("")),e.push("---"),e.push("")}return e}var x=require("node:fs"),nt=require("node:path");var Nn="curated-import-state.json",ce=1;function Rn(s){return(0,nt.join)(s,Nn)}function In(s){let e=Rn(s);if(!(0,x.existsSync)(e))return{version:ce,projects:{}};try{let t=JSON.parse((0,x.readFileSync)(e,"utf8"));return t?.version!==ce?{version:ce,projects:{}}:{version:ce,projects:t.projects??{}}}catch(t){return u.warn("DB","Curated import state unreadable \u2014 treating as absent",{path:e},t instanceof Error?t:void 0),{version:ce,projects:{}}}}function kr(s=R){return Object.values(In(s).projects)}function On(s){let e=0,t=0,r=[s];for(;r.length>0;){let n=r.pop(),o;try{o=(0,x.readdirSync)(n,{withFileTypes:!0}),t=Math.max(t,(0,x.statSync)(n).mtimeMs)}catch{continue}for(let i of o){let a=(0,nt.join)(n,i.name);if(i.isDirectory()){r.push(a);continue}if(i.isFile()){e+=1;try{t=Math.max(t,(0,x.statSync)(a).mtimeMs)}catch{}}}}return{files:e,newest:t}}function Ur(s){return s.map(e=>{let t=!1;try{t=(0,x.statSync)(e.path).isDirectory()}catch{t=!1}if(!t)return{path:e.path,kind:e.kind,files:0,newestMtimeEpoch:0,present:!1};let{files:r,newest:n}=On(e.path);return{path:e.path,kind:e.kind,files:r,newestMtimeEpoch:Math.round(n),present:!0}})}function Fr(s,e){if(!s||s.lastSuccessEpoch===null)return{stale:!0,reason:"never imported successfully"};if(!s.indexed)return{stale:!0,reason:"the last import did not get as far as verifying the semantic index"};let t=new Map(s.sources.map(r=>[r.path,r]));for(let r of e){let n=t.get(r.path);if(!n)return{stale:!0,reason:`a source was added: ${r.path}`};if(!r.present)return{stale:!0,reason:`a source is missing: ${r.path}`};if(r.files!==n.files)return{stale:!0,reason:`${r.path} holds ${r.files} file(s), ${n.files} at the last import`};if(r.newestMtimeEpoch>n.newestMtimeEpoch)return{stale:!0,reason:`${r.path} was changed after the last import`}}for(let r of s.sources)if(!e.some(n=>n.path===r.path))return{stale:!0,reason:`a source was removed from the configuration: ${r.path}`};return{stale:!1,reason:null}}var $=require("node:fs"),Le=require("node:path");var it=require("node:path");var jr="settings.json",$r="curatedSources",ue="KEEPMIND_CURATED_SOURCES";function ot(s,e){if(!Array.isArray(s))return e.push({entry:s,reason:`expected an array, got ${typeof s}`}),[];let t=[];for(let r of s){if(typeof r!="object"||r===null){e.push({entry:r,reason:"not an object"});continue}let n=r,o=n.path,i=n.kind;if(typeof o!="string"||o.trim().length===0){e.push({entry:r,reason:"missing `path`"});continue}if(i!=="akten"&&i!=="vorgaenge"){e.push({entry:r,reason:`\`kind\` must be "akten" or "vorgaenge", got ${JSON.stringify(i)}`});continue}if(!(0,Le.isAbsolute)(o)){e.push({entry:r,reason:`\`path\` must be absolute: ${o}`});continue}let a=n.project;if(a!==void 0&&(typeof a!="string"||a.trim().length===0)){e.push({entry:r,reason:`\`project\` must be a non-empty string when given, got ${JSON.stringify(a)}`});continue}t.push({path:(0,Le.resolve)(o),kind:i,...a?{project:a.trim()}:{}})}return t}function Kr(s,e){let t=new Map;for(let r of s){let n=r.project??e;if(!n)throw new Error(`Curated source "${r.path}" names no project and no fallback project was resolved`);let o=t.get(n);o?o.push(r):t.set(n,[r])}return t}function Hr(s=R){let e=[],t=process.env[ue];if(t&&t.trim().length>0){let n=t.trim();try{return n.startsWith("[")?{sources:ot(JSON.parse(n),e),origin:`${ue} (inline)`,rejected:e}:(0,$.existsSync)(n)?{sources:ot(JSON.parse((0,$.readFileSync)(n,"utf8")),e),origin:n,rejected:e}:(e.push({entry:n,reason:`${ue} is neither JSON nor an existing file`}),{sources:[],origin:ue,rejected:e})}catch(o){return e.push({entry:n,reason:`unreadable: ${o instanceof Error?o.message:o}`}),{sources:[],origin:ue,rejected:e}}}let r=(0,it.join)(s,jr);if(!(0,$.existsSync)(r))return{sources:[],origin:r,rejected:e};try{let n=JSON.parse((0,$.readFileSync)(r,"utf8"));return $r in n?{sources:ot(n[$r],e),origin:r,rejected:e}:{sources:[],origin:r,rejected:e}}catch(n){return u.warn("DB","Could not read curated source set",{settingsPath:r},n instanceof Error?n:void 0),e.push({entry:r,reason:`unreadable: ${n instanceof Error?n.message:n}`}),{sources:[],origin:r,rejected:e}}}function Br(s=R){let e=y("KEEPMIND_CURATED_PROJECT");if(e&&e.trim().length>0)return e.trim();let t=(0,it.join)(s,jr);if(!(0,$.existsSync)(t))return null;try{let r=JSON.parse((0,$.readFileSync)(t,"utf8")),n=r.env??r,o=G("KEEPMIND_CURATED_PROJECT",n);return typeof o=="string"&&o.trim().length>0?o.trim():null}catch{return null}}function Gr(s){return s.filter(e=>{try{return!(0,$.statSync)(e.path).isDirectory()}catch{return!0}})}function Xr(s=R,e={}){let t=new Map;for(let a of kr(s))t.set(a.project,a);let r=Hr(s),n=new Map;if(r.sources.length>0){let a=r.sources.filter(c=>c.project);for(let[c,l]of Kr(a,"(unattributed)"))c!=="(unattributed)"&&n.set(c,l);let d=r.sources.filter(c=>!c.project);if(d.length>0){let c=Br(s),l=c?[c]:t.size>0?[...t.keys()]:[];for(let _ of l)n.set(_,[...n.get(_)??[],...d]);l.length===0&&n.set("(no project configured)",d)}}let o=new Set([...t.keys(),...n.keys()]),i=[];for(let a of o){let d=t.get(a)??null,c=n.get(a)??[],l=c.length>0?Fr(d,Ur(c)):{stale:d===null||d.lastSuccessEpoch===null,reason:d?null:"never imported"},_=Gr(c),m=e.storedRecords?e.storedRecords.get(a)??0:null,g=An(c,_,m);i.push({project:a,lastSuccessEpoch:d?.lastSuccessEpoch??null,lastAttemptEpoch:d?.lastAttemptEpoch??0,records:d?.records??0,edges:d?.edges??0,indexed:d?.indexed??!1,failure:d?.failure??null,stale:l.stale,staleReason:l.reason,ok:d!==null&&d.lastSuccessEpoch!==null&&d.indexed&&!d.failure&&!l.stale,sources:c,absentSources:_,storedRecords:m,presence:g})}return i.sort((a,d)=>a.project.localeCompare(d.project))}function An(s,e,t){return s.length===0||e.length===0||e.length<s.length?"present":t===null?"unknown":t>0?"detached":"absent"}function yn(s,e=Date.now()){if(s.lastSuccessEpoch===null)return"never";let t=new Date(s.lastSuccessEpoch).toISOString().slice(0,10),r=Math.floor((e-s.lastSuccessEpoch)/864e5);return r<=0?`${t} \xB7 today`:r===1?`${t} \xB7 yesterday`:`${t} \xB7 ${r} days ago`}function Y(s,e=Date.now()){let t=yn(s,e);if(s.ok)return`last imported ${t} \xB7 ${s.records} record(s), ${s.edges} relation(s) \xB7 index in sync`;if(s.presence==="detached")return`${s.storedRecords??0} record(s) held here, searchable \xB7 sources not reachable from this machine (${s.absentSources.map(o=>o.path).join(", ")}) \u2014 nothing refreshes them here`;if(s.presence==="absent")return"configured for a corpus this machine does not have";let r=new Set;return s.lastSuccessEpoch===null&&r.add("never imported successfully"),s.failure&&r.add(s.failure),s.indexed||r.add("the last import did not get as far as verifying the semantic index"),s.stale&&s.staleReason&&r.add(s.staleReason),`last imported ${t} \u2014 ${[...r].join("; ")}`}var Wr=require("node:fs"),Vr=require("node:sqlite");function Yr(s=Z()){if(!(0,Wr.existsSync)(s))return null;let e=null;try{e=new Vr.DatabaseSync(s,{readOnly:!0});let t=e.prepare(`
      SELECT project, COUNT(*) AS n
        FROM observations
       WHERE source_kind = 'curated' AND project IS NOT NULL AND project != ''
       GROUP BY project
    `).all();return new Map(t.map(r=>[String(r.project),Number(r.n)]))}catch(t){return u.debug("DB","Curated record counts could not be read",{},t instanceof Error?t:void 0),null}finally{try{e?.close()}catch{}}}function qr(s={}){let e=s.now??Date.now(),t;try{t=s.entries??Xr(void 0,{storedRecords:Yr()})}catch(c){return u.debug("WORKER","Curated health could not be read",{},c instanceof Error?c:void 0),[]}if(t.length===0)return[];if(t=t.filter(c=>c.presence!=="absent"),t.length===0)return[];let r=t.filter(c=>c.presence==="detached"),n=t.filter(c=>c.presence!=="detached"),o=r.map(c=>`Curated corpus [${c.project}]: ${Y(c,e)}`);if(n.length===0)return[...o,""];t=n;let i=t.filter(c=>!c.ok),a=[];if(i.length===0){for(let c of t)a.push(`Curated corpus [${c.project}]: ${Y(c,e)}`);return a.push(...o),a.push(""),a}a.push("# \u26A0 CURATED CORPUS OUT OF STEP"),a.push("The lasting entries below are not in step with their source files. Answers drawn from them may be out of date."),a.push("");for(let c of i)a.push(`- **${c.project}** \u2014 ${Y(c,e)}`);let d=t.filter(c=>c.ok);for(let c of d)a.push(`- ${c.project} \u2014 ${Y(c,e)}`);for(let c of r)a.push(`- ${c.project} \u2014 ${Y(c,e)}`);return a.push(""),a.push("Fix it with `npx keepmind curated:import` (add `--project <name>`), then `npx keepmind doctor`."),a.push(""),a.push("---"),a.push(""),a}var Me=q(require("path"),1);function xe(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:s?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function at(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function dt(s){return new Date(s).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Qr(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Jr(s,e){return Me.default.isAbsolute(s)?Me.default.relative(e,s).split(Me.default.sep).join("/"):s}function zr(s,e,t){let r=xe(s);if(r.length>0)return Jr(r[0],e);if(t){let n=xe(t);if(n.length>0)return Jr(n[0],e)}return"General"}function Dn(s){let e=new Map;for(let r of s){let n=r.type==="observation"?r.data.created_at:r.data.displayTime,o=Qr(n);e.has(o)||e.set(o,[]),e.get(o).push(r)}let t=Array.from(e.entries()).sort((r,n)=>{let o=new Date(r[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Zr(s,e){return e.fullObservationField==="narrative"?s.narrative:s.facts?xe(s.facts).join(`
`):null}function Cn(s,e,t,r){let n=[];n.push(...pr(s));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=at(a.displayTime);n.push(...gr(a,d))}else{let a=i.data,d=dt(a.created_at),l=d!==o?d:"";if(o=d,t.has(a.id)){let m=Zr(a,r);n.push(...Er(a,l,m,r))}else n.push(mr(a,l,r))}return n}function vn(s,e,t,r,n){let o=[];o.push(...Ar(s));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,l=at(c.displayTime);o.push(...vr(c,l))}else{let c=d.data,l=zr(c.files_modified,n,c.files_read),_=dt(c.created_at),m=_!==a;a=_;let g=t.has(c.id);if(l!==i&&(o.push(...yr(l)),i=l),g){let I=Zr(c,r);o.push(...Cr(c,_,m,I,r))}else o.push(Dr(c,_,m,r))}return o.push(""),o}function Ln(s,e,t,r,n,o){return o?vn(s,e,t,r,n):Cn(s,e,t,r)}function es(s,e,t,r,n){let o=[],i=Dn(s);for(let[a,d]of i)o.push(...Ln(a,d,e,t,r,n));return o}function ts(s,e,t){return!(!s.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function rs(s,e){let t=[];return e?(t.push(...de("Investigated",s.investigated,p.blue)),t.push(...de("Learned",s.learned,p.yellow)),t.push(...de("Completed",s.completed,p.green)),t.push(...de("Next Steps",s.next_steps,p.magenta))):(t.push(...ae("Investigated",s.investigated)),t.push(...ae("Learned",s.learned)),t.push(...ae("Completed",s.completed)),t.push(...ae("Next Steps",s.next_steps))),t}function ss(s,e){return e?Lr(s):fr(s)}function ns(s,e,t){return!ye(e)||s.totalDiscoveryTokens<=0||s.savings<=0?[]:t?Mr(s.totalDiscoveryTokens,s.totalReadTokens):Tr(s.totalDiscoveryTokens,s.totalReadTokens)}var Mn=os.default.join((0,is.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function xn(){try{return new Se}catch(s){if(s instanceof Error&&s.code==="ERR_DLOPEN_FAILED"){try{(0,as.unlinkSync)(Mn)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw s}}function Pn(s,e){return e?xr(s):br(s)}function wn(s,e,t,r,n,o,i,a){let d=[],c=rt(e);d.push(...Pr(s,c,n,a)),d.push(...qr()),d.push(...wr(r));let l=t.slice(0,n.sessionCount),_=nr(l,t),m=or(e,_),g=ir(e,n.fullObservationCount);d.push(...es(m,g,n,o,a));let I=t[0],O=e[0];ts(n,I,O)&&d.push(...rs(I,a));let T=sr(e,n,i,o);return d.push(...ss(T,a)),d.push(...ns(c,n,a)),d.join(`
`).trimEnd()}var kn=new Set(["bugfix","discovery","decision","refactor","security_alert","security_note"]);function Un(s,e,t){let r=rt(s),n={bugfix:0,discovery:0,decision:0,refactor:0,security_alert:0,security_note:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of s){let c=kn.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:s.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_security_alert:n.security_alert,obs_type_security_note:n.security_note,obs_type_other:n.other,tokens_injected:r.totalReadTokens,tokens_saved_vs_naive:r.savings,search_strategy:t?"full":"timeline"}}async function ct(s,e=!1){let t=Jt(),r=fe(),n=s?.cwd??process.cwd(),o=Vt(n),i=s?.projects?.length?s.projects:o.allProjects,a=i[i.length-1]??o.primary,d=r.importance.enabled&&!s?.full,c=t.totalObservationCount;d&&(t.totalObservationCount=Math.max(c,c*Math.max(1,r.injection.candidateMultiplier))),s?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let l=xn();if(!l)return{text:"",stats:null};try{let _=s?.platformSource?D(s.platformSource):void 0,m=i.length>1?tr(l,i,t,_):Zt(l,a,t,_),g=d?Qt(m,{tokenBudget:r.injection.tokenBudget,halfLifeDays:r.importance.halfLifeDays,maxRows:c}):m,I=i.length>1?rr(l,i,t,_):er(l,a,t,_),O=l.getActiveCheckpoints(i);return g.length>0&&l.markObservationsUsed(g.map(f=>f.id),"injection"),g.length===0&&I.length===0&&O.length===0?{text:Pn(a,e),stats:null}:{text:wn(a,g,I,O,t,n,s?.session_id,e),stats:Un(g,I,!!s?.full)}}finally{l.close()}}async function ds(s,e=!1){return(await ct(s,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
