"use strict";var As=Object.create;var ee=Object.defineProperty;var ys=Object.getOwnPropertyDescriptor;var Ds=Object.getOwnPropertyNames;var vs=Object.getPrototypeOf,Cs=Object.prototype.hasOwnProperty;var Ls=(r,e)=>{for(var t in e)ee(r,t,{get:e[t],enumerable:!0})},Ve=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ds(e))!Cs.call(r,n)&&n!==t&&ee(r,n,{get:()=>e[n],enumerable:!(s=ys(e,n))||s.enumerable});return r};var H=(r,e,t)=>(t=r!=null?As(vs(r)):{},Ve(e||!r||!r.__esModule?ee(t,"default",{value:r,enumerable:!0}):t,r)),Ms=r=>Ve(ee({},"__esModule",{value:!0}),r);var Kr={};Ls(Kr,{generateContext:()=>Os,generateContextWithStats:()=>We});module.exports=Ms(Kr);var Rs=H(require("path"),1),Is=require("os"),Ns=require("fs");var Je=require("node:sqlite");function Ye(r){return typeof r=="bigint"?Number(r):r}function xs(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)&&!(r instanceof Uint8Array)&&!(typeof Buffer<"u"&&Buffer.isBuffer(r))}function qe(r){return r===void 0?null:typeof r=="boolean"?r?1:0:r}function te(r){let e=r;if(e.length===1&&Array.isArray(e[0])&&(e=e[0]),e.length===1&&xs(e[0])){let t=e[0],s={};for(let n of Object.keys(t))s[n]=qe(t[n]);return[s]}return e.map(qe)}var he=class{constructor(e){this.stmt=e}stmt;all(...e){return this.stmt.all(...te(e))}get(...e){return this.stmt.get(...te(e))??null}run(...e){let t=this.stmt.run(...te(e));return{changes:Ye(t.changes),lastInsertRowid:Ye(t.lastInsertRowid)}}values(...e){return this.stmt.all(...te(e)).map(s=>Object.values(s))}finalize(){}},j=class{db;queryCache=new Map;safeIntegers;txDepth=0;filename;constructor(e,t={}){let s=t.readonly===!0;this.safeIntegers=t.safeIntegers===!0;let n=e&&e.length>0?e:":memory:";if(this.filename=n,this.db=new Je.DatabaseSync(n,{readOnly:s,allowExtension:!0}),!s&&n!==":memory:")try{this.db.exec("PRAGMA journal_mode=WAL")}catch{}}wrap(e){return this.safeIntegers&&e.setReadBigInts(!0),new he(e)}prepare(e){return this.wrap(this.db.prepare(e))}query(e){let t=this.queryCache.get(e);if(t)return t;let s=this.prepare(e);return this.queryCache.set(e,s),s}run(e,...t){return t.length===0?(this.db.exec(e),{changes:0,lastInsertRowid:0}):this.prepare(e).run(...t)}exec(e){this.db.exec(e)}loadExtension(e,t){this.db.loadExtension(e)}transaction(e){return(...t)=>{let s=this.txDepth===0,n=`__cm_sp_${this.txDepth}`;s?this.db.exec("BEGIN"):this.db.exec(`SAVEPOINT ${n}`),this.txDepth++;try{let o=e(...t);return this.txDepth--,s?this.db.exec("COMMIT"):this.db.exec(`RELEASE ${n}`),o}catch(o){throw this.txDepth--,s?this.db.exec("ROLLBACK"):(this.db.exec(`ROLLBACK TO ${n}`),this.db.exec(`RELEASE ${n}`)),o}}}close(){this.db.close()}};var T=require("path"),ye=require("os"),M=require("fs");var tt=require("url");var Qe="KEEPMIND_",ze="CLAUDE_MEM_";function Ze(r){return r.startsWith(Qe)?ze+r.slice(Qe.length):null}function v(r,e=process.env){let t=e[r];if(t!==void 0)return t;let s=Ze(r);return s?e[s]:void 0}function se(r,e){let t=e[r];if(t!==void 0)return t;let s=Ze(r);return s?e[s]:void 0}function et(r){return Object.keys(r).some(e=>e.startsWith(ze))}var P=require("fs"),Ne=require("path");var Ps=null;function ws(r){return(Ps??process.stderr.write.bind(process.stderr))(r)}function Re(r){ws(r)}var ks=14,Oe=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Oe||{}),Ie=null,Us=6e4,Fs=500,X=new Map;function $s(r,e){try{let t="";if(r){for(let s of Object.keys(r).sort())if(t+=`${s}=${String(r[s])};`,t.length>200)break}return e instanceof Error?t+=`E:${e.message}`:typeof e=="string"||typeof e=="number"||typeof e=="boolean"?t+=`D:${e}`:e&&(t+="D:obj"),t.slice(0,200)}catch{return""}}function Gs(r,e,t,s,n,o){let i=`${r}|${e}|${t}|${$s(n,o)}`,a=X.get(i);if(a&&s-a.windowStartedAt<Us)return a.suppressed++,null;if(!a&&X.size>=Fs){let u=X.keys().next();u.done||X.delete(u.value)}let d=a?.suppressed??0,c=a?Math.round((s-a.windowStartedAt)/1e3):0;return X.set(i,{windowStartedAt:s,suppressed:0}),d>0?` (repeated ${d}\xD7 in the previous ${c}s)`:""}var Ae=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=$.logsDir();(0,P.existsSync)(e)||(0,P.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`keepmind-${t}.log`),this.pruneOldLogs(e)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}pruneOldLogs(e){try{let t=Date.now()-ks*24*60*60*1e3;for(let s of(0,P.readdirSync)(e)){let n=/^keepmind-(\d{4}-\d{2}-\d{2})\.log$/.exec(s);if(!n)continue;let o=Date.parse(n[1]);if(Number.isFinite(o)&&o<t)try{(0,P.unlinkSync)((0,Ne.join)(e,s))}catch{}}}catch{}}getLevel(){if(this.level===null)try{let e=$.settings();if((0,P.existsSync)(e)){let t=(0,P.readFileSync)(e,"utf-8"),n=(JSON.parse(t).KEEPMIND_LOG_LEVEL||"INFO").toUpperCase();this.level=Oe[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;let i="";if(process.env.KEEPMIND_LOG_DEDUP!=="0"){let f=Gs(e,t,s,Date.now(),n,o);if(f===null)return;i=f}this.ensureLogFileInitialized();let a=this.formatTimestamp(new Date),d=Oe[e].padEnd(5),c=t.padEnd(6),u="";n?.correlationId?u=`[${n.correlationId}] `:n?.sessionId&&(u=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let m="";if(n){let{sessionId:f,memorySessionId:N,correlationId:O,...S}=n;Object.keys(S).length>0&&(m=` {${Object.entries(S).map(([L,b])=>`${L}=${b}`).join(", ")}}`)}let g=`[${a}] [${d}] [${c}] ${u}${s}${i}${m}${_}`;if(this.logFilePath)try{(0,P.appendFileSync)(this.logFilePath,g+`
`,"utf8")}catch(f){Re(`[LOGGER] Failed to write to log file: ${f instanceof Error?f.message:String(f)}
`)}else Re(g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",_={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,_,n),o}},l=new Ae;var Qs={};function Bs(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,tt.fileURLToPath)(Qs.url))}var Hs=Bs();function js(){let r=v("KEEPMIND_DATA_DIR");if(r)return r;let e=(0,T.join)((0,ye.homedir)(),".keepmind"),t=(0,T.join)(e,"settings.json");try{if((0,M.existsSync)(t)){let s=JSON.parse((0,M.readFileSync)(t,"utf-8")),n=s.env??s,o=se("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var A=js(),G=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,ye.homedir)(),".claude"),sn=(0,T.join)(G,"plugins","marketplaces","keepmind"),Xs=(0,T.join)(A,"archives"),Ks=(0,T.join)(A,"logs"),Ws=(0,T.join)(A,"trash"),Vs=(0,T.join)(A,"backups"),Ys=(0,T.join)(A,"modes"),rn=(0,T.join)(A,"settings.json"),U=(0,T.join)(A,"keepmind.db"),K=(0,T.join)(A,"claude-mem.db"),qs=(0,T.join)(A,"vector-db"),st=(0,T.join)(A,"observer-sessions"),De=(0,T.basename)(st),nn=(0,T.join)(G,"settings.json"),on=(0,T.join)(G,"commands"),an=(0,T.join)(G,"CLAUDE.md");function rt(r){(0,M.mkdirSync)(r,{recursive:!0})}function Js(){try{if((0,M.existsSync)(U)||!(0,M.existsSync)(K))return(0,M.existsSync)(U);for(let r of["","-wal","-shm"]){let e=K+r,t=U+r;(0,M.existsSync)(e)&&!(0,M.existsSync)(t)&&(0,M.renameSync)(e,t)}return l.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:K,to:U}),!0}catch(r){return l.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},r instanceof Error?r:new Error(String(r))),!1}}function ve(){return Js(),!(0,M.existsSync)(U)&&(0,M.existsSync)(K)?K:U}function nt(){return(0,T.join)(Hs,"..")}var $={dataDir:()=>A,workerPid:()=>(0,T.join)(A,"worker.pid"),workerPort:()=>(0,T.join)(A,"worker.port"),serverPid:()=>(0,T.join)(A,".server-beta.pid"),serverPort:()=>(0,T.join)(A,".server-beta.port"),serverRuntime:()=>(0,T.join)(A,".server-beta.runtime.json"),settings:()=>(0,T.join)(A,"settings.json"),database:()=>ve(),chroma:()=>(0,T.join)(A,"chroma"),combinedCerts:()=>(0,T.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(A,"transcript-watch-state.json"),corpora:()=>(0,T.join)(A,"corpora"),supervisorRegistry:()=>(0,T.join)(A,"supervisor.json"),envFile:()=>(0,T.join)(A,".env"),logsDir:()=>Ks,archives:()=>Xs,trash:()=>Ws,backups:()=>Vs,modes:()=>Ys,vectorDb:()=>qs,observerSessions:()=>st};var ot={injection:"injection_count",explicit_fetch:"explicit_fetch_count",fts:"fts_hit_count",vector:"vector_hit_count"};var it=require("crypto");function Ce(r,e,t){return(0,it.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Le(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var Me=r=>`\xABredacted:${r}\xBB`,zs=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:jdbc:[a-z0-9]{1,20}:)?(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|sqlserver|oracle|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"CREDENTIAL_ASSIGNMENT",re:/\b(?:password|pwd|passwd)\s{0,3}=\s{0,3}(?:"([^"\r\n]{1,200})"|'([^'\r\n]{1,200})'|([^;"'\r\n]{1,200}))/gi,group:1},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1},{type:"EMAIL",category:"pii",re:/\b[\w.+-]{1,64}@[\w-]{1,63}(?:\.[\w-]{1,63}){1,4}\b/g},{type:"IP_ADDRESS",category:"pii",re:/\b(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\b/g,keep:r=>r==="0.0.0.0"||r==="255.255.255.255"||r.startsWith("127.")}];function at(r){return r.includes("redacted:")}function Zs(r,e){if(e.re.lastIndex=0,e.group===void 0)return r.replace(e.re,s=>at(s)||e.keep?.(s)?s:Me(e.type));let t=e.group;return r.replace(e.re,(s,...n)=>{if(e.keep?.(s))return s;let o=s,i=!1;for(let a=t-1;a<n.length;a++){let d=n[a];typeof d!="string"||d.length===0||at(d)||(o=o.replace(d,Me(e.type)),i=!0)}return i?o:s})}function er(r){if(r.length===0)return 0;let e=new Map;for(let s of r)e.set(s,(e.get(s)??0)+1);let t=0;for(let s of e.values()){let n=s/r.length;t-=n*Math.log2(n)}return t}var tr=/^[0-9a-f]+$/i;function sr(r,e){return r.length<20||r.length>200||/[\s]/.test(r)||!/\d/.test(r)||!/[A-Za-z]/.test(r)||r.includes("/")||r.includes("\\")||r.length<=64&&tr.test(r)||r.includes("redacted:")?!1:er(r)>=e}var rr=/([\s"'`,;(){}\[\]<>]+)/;function nr(r,e){let t=r.split(rr);for(let s=0;s<t.length;s++){let n=t[s];n&&sr(n,e)&&(t[s]=Me("HIGH_ENTROPY"))}return t.join("")}function xe(r,e={}){if(typeof r!="string"||r.length===0)return r;try{let t=r,s=e.pii!==!1;for(let n of zs)n.category==="pii"&&!s||(t=Zs(t,n));return e.entropySweep!==!1&&(t=nr(t,e.entropyThreshold??4)),t}catch{return r}}function re(r,e={}){if(typeof r=="string")return xe(r,e);if(Array.isArray(r))return r.map(t=>re(t,e));if(r&&typeof r=="object"){let t={};for(let[s,n]of Object.entries(r))t[s]=re(n,e);return t}return r}var oe=require("fs");var we={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0,pii:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},vectorRetention:{enabled:!0,inactiveDays:90},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function ne(r){return!!r&&typeof r=="object"&&!Array.isArray(r)}function F(r,e){if(!ne(e))return{...r};let t={...r};for(let s of Object.keys(r))e[s]!==void 0&&typeof e[s]==typeof r[s]&&(t[s]=e[s]);return t}var Pe=null;function ie(r=!1){if(Pe&&!r)return Pe;let e=we,t;try{let i=$.settings();if((0,oe.existsSync)(i)){let a=JSON.parse((0,oe.readFileSync)(i,"utf-8").replace(/^﻿/,"")),d=ne(a)?a.memoryQuality??(ne(a.env)?a.env.memoryQuality:void 0):void 0;ne(d)&&(t=d)}}catch(i){l.debug("CONFIG","memoryQuality config load failed; using defaults",{},i instanceof Error?i:new Error(String(i)))}let s={redactSecrets:F(e.redactSecrets,t?.redactSecrets),scoping:F(e.scoping,t?.scoping),importance:F(e.importance,t?.importance),injection:F(e.injection,t?.injection),reconcile:F(e.reconcile,t?.reconcile),supersession:F(e.supersession,t?.supersession),expiry:F(e.expiry,t?.expiry),vectorRetention:F(e.vectorRetention,t?.vectorRetention),optimizer:F(e.optimizer,t?.optimizer)},n=v("KEEPMIND_REDACT_SECRETS");(n==="0"||n==="false")&&(s.redactSecrets.enabled=!1);let o=v("KEEPMIND_REDACT_PII");return(o==="0"||o==="false")&&(s.redactSecrets.pii=!1),Pe=s,s}var or={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function ir(r){if(Array.isArray(r))return r.length;if(typeof r=="string")try{let e=JSON.parse(r);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function ke(r){let e=or[r.type??"other"]??4;return ir(r.files_modified)>0&&(e+=1),(r.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(r.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var ar=14,dr=864e5;function dt(r,e={}){let t=e.now??Date.now(),s=(e.halfLifeDays??ar)*dr,n=(r.importance??5)/10,o=Math.max(0,t-(r.created_at_epoch??t)),i=Math.pow(.5,o/s);return n*i}var cr=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will"]);function ae(r){return r?r.toLowerCase().replace(/[^a-z0-9\s]+/g," ").split(/\s+/).filter(e=>e.length>0&&!cr.has(e)).join(" ").trim():""}function ct(r){let e=new Set,t=r.replace(/\s+/g," ");for(let s=0;s+3<=t.length;s++)e.add(t.slice(s,s+3));return e}function ur(r,e){let t=ct(r),s=ct(e);if(t.size===0&&s.size===0)return 1;if(t.size===0||s.size===0)return 0;let n=0;for(let o of t)s.has(o)&&n++;return n/(t.size+s.size-n)}function lr(r,e){let t=new Map,s=new Map;for(let a of r.split(" "))a&&t.set(a,(t.get(a)??0)+1);for(let a of e.split(" "))a&&s.set(a,(s.get(a)??0)+1);if(t.size===0||s.size===0)return 0;let n=0;for(let[a,d]of t)n+=d*(s.get(a)??0);let o=0;for(let a of t.values())o+=a*a;let i=0;for(let a of s.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function pr(r,e){let t=ae(`${r??""}`),s=ae(`${e??""}`);return Math.max(ur(t,s),lr(t,s))}function ut(r,e,t){let s=`${r.title??""} ${r.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=pr(s,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=t.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=t.updateBand&&t.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var lt=require("crypto");function Ue(r){let e=r.title??"";if(!e){if(Array.isArray(r.facts)&&r.facts.length>0)e=r.facts[0];else if(typeof r.facts=="string")try{let s=JSON.parse(r.facts);Array.isArray(s)&&s.length>0&&(e=String(s[0]))}catch{}}e||(e=(r.narrative??"").slice(0,80));let t=ae(e);return(0,lt.createHash)("sha1").update(t).digest("hex").slice(0,16)}var E="claude";function _r(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return E;let e=_r(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:E}function pt(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function _t(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(a,t,o)??void 0}var gt=["private","keepmind-context","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],mt=new RegExp(`<(${gt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Tt=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Et=100;function mr(r){let e=Object.fromEntries(gt.map(n=>[n,0]));mt.lastIndex=0;let t=0,s=r.replace(mt,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Et&&l.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Et,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ft(r){return mr(r).stripped}var Er=["task-notification"],An=new RegExp(`^\\s*<(${Er.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),yn=256*1024;var Fe=4e3;function de(r){let e=r.trim(),s=ft(r).trim()||e;return s.length<=Fe?s:(l.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:Fe}),`${s.slice(0,Fe-1)}\u2026`)}function fr(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var ce=class{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?xe(e,this.redactOpts):e}rl(e){return this.redactEnabled?re(e,this.redactOpts):e}constructor(e=U){try{this.mq=ie();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=we,this.redactEnabled=v("KEEPMIND_REDACT_SECRETS")!=="0"&&v("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof j)this.db=e;else{e!==":memory:"&&rt(A);let t=e===U?ve():e;this.db=new j(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns()}addObservationUsageChannelColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(39),t=this.db.query("PRAGMA table_info(observations)").all(),s=o=>t.some(i=>i.name===o),n=["injection_count","explicit_fetch_count","fts_hit_count","vector_hit_count"];if(!(e&&n.every(s))){for(let o of n)s(o)||this.db.run(`ALTER TABLE observations ADD COLUMN ${o} INTEGER DEFAULT 0`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(39,new Date().toISOString())}}addObservationBitemporalColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(37),t=this.db.query("PRAGMA table_info(observations)").all(),s=n=>t.some(o=>o.name===n);e&&s("valid_from")&&s("valid_to")&&s("subject_key")||(s("valid_from")||this.db.run("ALTER TABLE observations ADD COLUMN valid_from INTEGER"),s("valid_to")||this.db.run("ALTER TABLE observations ADD COLUMN valid_to INTEGER"),s("subject_key")||this.db.run("ALTER TABLE observations ADD COLUMN subject_key TEXT"),this.db.run("UPDATE observations SET valid_from = created_at_epoch WHERE valid_from IS NULL"),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_subject_valid ON observations(project, subject_key, valid_to)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(37,new Date().toISOString()))}addObservationLastUsedColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(38),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="last_used_at");e&&s||(s||this.db.run("ALTER TABLE observations ADD COLUMN last_used_at INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_obs_last_used ON observations(last_used_at)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(38,new Date().toISOString()))}addObservationImportanceColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(36),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="importance");e&&s||(s||this.db.run("ALTER TABLE observations ADD COLUMN importance INTEGER"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_importance ON observations(importance)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(36,new Date().toISOString()))}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?D(s):void 0;return n?this.db.prepare(`
    ...
    `).all(e)}getAllProjects(e){let t=e?D(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[De];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(E,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(De),t=[],s=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=pt(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return _t(this.db,e,de(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${E}') = ?`,n.push(D(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,D(t))||null:this.db.prepare(`
      ...
      ${_}
      ${m}
    `).all(...f);if(!u)return C;let L=new Map(C.map(R=>[R.id,R])),b=e.map(R=>L.get(R)).filter(R=>!!R);return n?b.slice(0,n):b}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(...s)||null}getFilesForSession(e){let s=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),n=new Set,o=new Set;for(let i of s)Le(i.files_read).forEach(a=>n.add(a)),Le(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(n),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=fr(n,o),c=d.platformSource??E,u=this.rt(de(s)),_=this.db.prepare(`
    ...
    `).get(E,c,e);if(_)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,u,d.customTitle||null,i.toISOString(),a);return Number(m.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=this.rt(de(s)),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),u=this.rt(s.title),_=this.rt(s.subtitle),m=this.rt(s.narrative),g=this.rl(s.facts),f=this.rt(s.metadata??null),N=Ce(e,u??null,m??null),O=ke({type:s.type,narrative:m,files_modified:s.files_modified}),S;if(this.mq.reconcile.enabled){let R=this.reconcileBeforeInsert(t,s.type,u??null,m??null);if(R.action==="NOOP"&&R.candidateId){let h=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE id = ?").get(R.candidateId);if(h)return{id:h.id,createdAtEpoch:h.created_at_epoch}}else R.action==="UPDATE"&&(S=R.candidateId)}let L=this.db.prepare(`
    ...
    `).run(e,t,this.rt(s.request),this.rt(s.investigated),this.rt(s.learned),this.rt(s.completed),this.rt(s.next_steps),this.rt(s.notes),n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let O of s){let S=this.rt(O.title),C=this.rt(O.subtitle),L=this.rt(O.narrative),b=this.rl(O.facts),R=Ce(e,S??null,L??null),h=g.get(e,t,O.type,S,C,JSON.stringify(b),L,JSON.stringify(O.concepts),JSON.stringify(O.files_read),JSON.stringify(O.files_modified),o||null,i,O.agent_type??null,O.agent_id??null,R,u,c,d||null,ke({type:O.type,narrative:L,files_modified:O.files_modified}),c,Ue({title:S??null,facts:b,narrative:L??null}));if(h){m.push(h.id);continue}let y=f.get(e,R);if(!y)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${R}`);m.push(y.id)}let N=null;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
`,"utf-8"),a;try{a=(0,I.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,I.openSync)(o,"w",a):(0,I.openSync)(o,"w");let c=0;for(;c<i.length;){let u=(0,I.writeSync)(d,i,c,i.length-c);if(u===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=u}if((0,I.fsyncSync)(d),(0,I.closeSync)(d),d=void 0,(0,I.renameSync)(o,t),!Ir){let u;try{u=(0,I.openSync)(s,"r"),(0,I.fsyncSync)(u)}catch{}finally{if(u!==void 0)try{(0,I.closeSync)(u)}catch{}}}}catch(c){if(d!==void 0)try{(0,I.closeSync)(d)}catch{}try{(0,I.unlinkSync)(o)}catch{}throw c}}var pe=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(At($e.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,q.join)((0,Ge.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,q.join)((0,Ge.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${v("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${v("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${v("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return v(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS)){let n=this.envOverride(s);n!==void 0&&(t[s]=n)}return t}static toCanonicalKeys(e){let t={};for(let[s,n]of Object.entries(e)){if(!s.startsWith("CLAUDE_MEM_")){t[s]=n;continue}let o="KEEPMIND_"+s.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,k.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,q.dirname)(e);(0,k.existsSync)(d)||(0,k.mkdirSync)(d,{recursive:!0}),Y(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let s=(0,k.readFileSync)(e,"utf-8"),n=JSON.parse(s.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{Y(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=se(a,o);d!==void 0&&(i[a]=d)}if(et(o))try{Y(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(s){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,s instanceof Error?s.message:String(s));let n=this.getAllDefaults();try{if((0,k.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,k.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}Y(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var J=require("fs"),_e=require("path");var x=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=nt(),t=v("KEEPMIND_MODES_DIR"),s=[...t?[t]:[],(0,_e.join)(e,"modes"),(0,_e.join)(e,"..","plugin","modes")],n=s.find(o=>(0,J.existsSync)(o));this.modesDir=n||s[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,_e.join)(this.modesDir,`${e}.json`);if(!(0,J.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,J.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,l.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch(d){d instanceof Error?l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),l.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch(d){return d instanceof Error?l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{message:d.message}):l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return l.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,l.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}};function Dt(){let r=$.settings(),e=pe.loadFromFile(r),t=x.getInstance().getActiveMode(),s=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},me=4,Be=1;function He(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/me)}function je(r){let e=r.length,t=r.reduce((i,a)=>i+He(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Or(r){return x.getInstance().getWorkEmoji(r)}function Q(r,e){let t=He(r),s=r.discovery_tokens||0,n=Or(r.type),o=s>0?`${n} ${s.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function Ee(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}function Ar(r){return Dr(r)}var yr=28;function Dr(r){let e=(r.title?.length??8)+yr;return Math.max(1,Math.ceil(e/me))}function vr(r,e){if(!Number.isFinite(e)||e<=0)return r;let t=[],s=0;for(let n of r){let o=Ar(n);s+o>e||(t.push(n),s+=o)}return t}function vt(r,e){let t=e.now??Date.now(),s=r.map(i=>({o:i,score:dt(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?s.slice(0,e.maxRows):s;return vr(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var Ct=H(require("path"),1),ge=require("fs");function Lt(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,...n,...i,t.totalObservationCount)}function Mt(r,e,t,s){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.sessionCount+Be)}function xt(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,s??null,s??null,...n,...i,t.totalObservationCount)}function Pt(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,s??null,s??null,t.sessionCount+Be)}function Cr(r){return r.replace(/[/.]/g,"-")}function Lr(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(Tt,"").trim(),t)return t}return null}function Mr(r){for(let e=r.length-1;e>=0;e--)try{let t=Lr(r[e]);if(t)return t}catch(t){t instanceof Error?l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function xr(r){try{if(!(0,ge.existsSync)(r))return{assistantMessage:""};let e=(0,ge.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:Mr(t)}}catch(e){return e instanceof Error?l.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):l.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function wt(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=Cr(s),a=Ct.default.join(G,"projects",i,`${o}.jsonl`);return xr(a)}function kt(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ut(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Ft(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Gt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Bt(r){return[`# [${r}] recent context, ${Gt()}`,""]}function Ht(){return[`Legend: \u{1F3AF}session ${x.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function jt(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${r.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString("en-US")}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Pr(r,e=new Date){let t=new Date(r);if(Number.isNaN(t.getTime()))return null;let s=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((s(e)-s(t))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function Xt(r){let e=Pr(r);return[e?`### ${r} (${e})`:`### ${r}`]}function Kt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Wt(r,e,t){let s=r.title||"Untitled",n=x.getInstance().getTypeIcon(r.type),o=e?Kt(e):'"';return`${r.id} ${o} ${n} ${s}`}function Vt(r,e,t,s){let n=[],o=r.title||"Untitled",i=x.getInstance().getTypeIcon(r.type),a=e?Kt(e):'"',{readTokens:d,discoveryDisplay:c}=Q(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let u=[];return s.showReadTokens&&u.push(`~${d}t`),s.showWorkTokens&&u.push(c),u.length>0&&n.push(u.join(" ")),n.push(""),n}function Yt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}var $t=200;function z(r,e){if(!e)return[];let t=e.length>$t?`${e.slice(0,$t).trimEnd()}\u2026`:e;return[`**${r}**: ${t}`,""]}function qt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function Jt(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Qt(r){return`# [${r}] recent context, ${Gt()}

No previous sessions found.`}function zt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Zt(r){return["",`${p.bright}${p.cyan}[${r}] recent context, ${zt()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function es(){let e=x.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function ts(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function ss(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${p.reset}`,`${p.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function rs(r,e){let t=[];if(t.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),t.push(`${p.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),t.push(`${p.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${p.green}${s}${p.reset}`)}return t.push(""),t}function ns(r){return[`${p.bright}${p.cyan}${r}${p.reset}`,""]}function os(r){return[`${p.dim}${r}${p.reset}`]}function is(r,e,t,s){let n=r.title||"Untitled",o=x.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=Q(r,s),c=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),u=s.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",_=s.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${r.id}${p.reset}  ${c}  ${o}  ${n} ${u} ${_}`}function as(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=x.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:u}=Q(r,n),_=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),m=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",g=n.showWorkTokens&&c>0?`${p.dim}(${u} ${c.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${r.id}${p.reset}  ${_}  ${a}  ${p.bright}${i}${p.reset}`),s&&o.push(`    ${p.dim}${s}${p.reset}`),(m||g)&&o.push(`    ${m} ${g}`),o.push(""),o}function ds(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${p.yellow}#S${r.id}${p.reset} ${t}`,""]}function Z(r,e,t){return e?[`${t}${r}:${p.reset} ${e}`,""]:[]}function cs(r){return r.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${r.assistantMessage}${p.reset}`,""]:[]}function us(r,e){let t=Math.round(r/1e3);return["",`${p.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${p.reset}`]}function ls(r){return`
...
`}function ps(r,e,t,s){let n=[];return s?n.push(...Zt(r)):n.push(...Bt(r)),s?n.push(...es()):n.push(...Ht()),s&&(n.push(...ts()),n.push(...ss())),Ee(t)&&(s?n.push(...rs(e,t)):n.push(...jt(e,t))),n}var be=H(require("path"),1);function Se(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Xe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ke(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ms(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function _s(r,e){return be.default.isAbsolute(r)?be.default.relative(e,r).split(be.default.sep).join("/"):r}function Es(r,e,t){let s=Se(r);if(s.length>0)return _s(s[0],e);if(t){let n=Se(t);if(n.length>0)return _s(n[0],e)}return"General"}function wr(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ms(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function gs(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Se(r.facts).join(`
`):null}function kr(r,e,t,s){let n=[];n.push(...Xt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Xe(a.displayTime);n.push(...Yt(a,d))}else{let a=i.data,d=Ke(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let m=gs(a,s);n.push(...Vt(a,u,m,s))}else n.push(Wt(a,u,s))}return n}function Ur(r,e,t,s,n){let o=[];o.push(...ns(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,u=Xe(c.displayTime);o.push(...ds(c,u))}else{let c=d.data,u=Es(c.files_modified,n,c.files_read),_=Ke(c.created_at),m=_!==a;a=_;let g=t.has(c.id);if(u!==i&&(o.push(...os(u)),i=u),g){let f=gs(c,s);o.push(...as(c,_,m,f,s))}else o.push(is(c,_,m,s))}return o.push(""),o}function Fr(r,e,t,s,n,o){return o?Ur(r,e,t,s,n):kr(r,e,t,s)}function Ts(r,e,t,s,n){let o=[],i=wr(r);for(let[a,d]of i)o.push(...Fr(a,d,e,t,s,n));return o}function fs(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function bs(r,e){let t=[];return e?(t.push(...Z("Investigated",r.investigated,p.blue)),t.push(...Z("Learned",r.learned,p.yellow)),t.push(...Z("Completed",r.completed,p.green)),t.push(...Z("Next Steps",r.next_steps,p.magenta))):(t.push(...z("Investigated",r.investigated)),t.push(...z("Learned",r.learned)),t.push(...z("Completed",r.completed)),t.push(...z("Next Steps",r.next_steps))),t}function Ss(r,e){return e?cs(r):qt(r)}function hs(r,e,t){return!Ee(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?us(r.totalDiscoveryTokens,r.totalReadTokens):Jt(r.totalDiscoveryTokens,r.totalReadTokens)}var $r=Rs.default.join((0,Is.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function Gr(){try{return new ce}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ns.unlinkSync)($r)}catch(e){e instanceof Error?l.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):l.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return l.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Br(r,e){return e?ls(r):Qt(r)}function Hr(r,e,t,s,n,o,i){let a=[],d=je(e);a.push(...ps(r,d,s,i));let c=t.slice(0,s.sessionCount),u=kt(c,t),_=Ut(e,u),m=Ft(e,s.fullObservationCount);a.push(...Ts(_,m,s,n,i));let g=t[0],f=e[0];fs(s,g,f)&&a.push(...bs(g,i));let N=wt(e,s,o,n);return a.push(...Ss(N,i)),a.push(...hs(d,s,i)),a.join(`
`).trimEnd()}var jr=new Set(["bugfix","discovery","decision","refactor","security_alert","security_note"]);function Xr(r,e,t){let s=je(r),n={bugfix:0,discovery:0,decision:0,refactor:0,security_alert:0,security_note:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=jr.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_security_alert:n.security_alert,obs_type_security_note:n.security_note,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function We(r,e=!1){let t=Dt(),s=ie(),n=r?.cwd??process.cwd(),o=Ot(n),i=r?.projects?.length?r.projects:o.allProjects,a=i[i.length-1]??o.primary,d=s.importance.enabled&&!r?.full,c=t.totalObservationCount;d&&(t.totalObservationCount=Math.max(c,c*Math.max(1,s.injection.candidateMultiplier))),r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let u=Gr();if(!u)return{text:"",stats:null};try{let _=r?.platformSource?D(r.platformSource):void 0,m=i.length>1?xt(u,i,t,_):Lt(u,a,t,_),g=d?vt(m,{tokenBudget:s.injection.tokenBudget,halfLifeDays:s.importance.halfLifeDays,maxRows:c}):m,f=i.length>1?Pt(u,i,t,_):Mt(u,a,t,_);return g.length>0&&u.markObservationsUsed(g.map(O=>O.id),"injection"),g.length===0&&f.length===0?{text:Br(a,e),stats:null}:{text:Hr(a,g,f,t,n,r?.session_id,e),stats:Xr(g,f,!!r?.full)}}finally{u.close()}}async function Os(r,e=!1){return(await We(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
