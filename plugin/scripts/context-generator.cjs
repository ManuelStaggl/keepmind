...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",_={...r,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,_,n),o}},u=new $e;var xs={};function Ns(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,Tt.fileURLToPath)(xs.url))}var Is=Ns();function Os(){let s=y("KEEPMIND_DATA_DIR");if(s)return s;let e=(0,h.join)((0,je.homedir)(),".keepmind"),t=(0,h.join)(e,"settings.json");try{if((0,L.existsSync)(t)){let r=JSON.parse((0,L.readFileSync)(t,"utf-8")),n=r.env??r,o=B("KEEPMIND_DATA_DIR",n);if(o)return o}}catch{}return e}var N=Os(),G=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,je.homedir)(),".claude"),Yn=(0,h.join)(G,"plugins","marketplaces","keepmind"),As=(0,h.join)(N,"archives"),ys=(0,h.join)(N,"logs"),Ds=(0,h.join)(N,"trash"),Cs=(0,h.join)(N,"backups"),vs=(0,h.join)(N,"modes"),qn=(0,h.join)(N,"settings.json"),j=(0,h.join)(N,"keepmind.db"),Q=(0,h.join)(N,"claude-mem.db"),Ls=(0,h.join)(N,"vector-db"),bt=(0,h.join)(N,"observer-sessions"),Ke=(0,h.basename)(bt),Jn=(0,h.join)(G,"settings.json"),Qn=(0,h.join)(G,"commands"),zn=(0,h.join)(G,"CLAUDE.md");function ht(s){(0,L.mkdirSync)(s,{recursive:!0})}function Ms(){try{if((0,L.existsSync)(j)||!(0,L.existsSync)(Q))return(0,L.existsSync)(j);for(let s of["","-wal","-shm"]){let e=Q+s,t=j+s;(0,L.existsSync)(e)&&!(0,L.existsSync)(t)&&(0,L.renameSync)(e,t)}return u.info("DB","Migrated legacy claude-mem.db to keepmind.db",{from:Q,to:j}),!0}catch(s){return u.warn("DB","Could not rename legacy claude-mem.db to keepmind.db (file may be locked) \u2014 falling back to legacy path",{},s instanceof Error?s:new Error(String(s))),!1}}function z(){return Ms(),!(0,L.existsSync)(j)&&(0,L.existsSync)(Q)?Q:j}function St(){return(0,h.join)(Is,"..")}var H={dataDir:()=>N,workerPid:()=>(0,h.join)(N,"worker.pid"),workerPort:()=>(0,h.join)(N,"worker.port"),serverPid:()=>(0,h.join)(N,".server-beta.pid"),serverPort:()=>(0,h.join)(N,".server-beta.port"),serverRuntime:()=>(0,h.join)(N,".server-beta.runtime.json"),settings:()=>(0,h.join)(N,"settings.json"),database:()=>z(),chroma:()=>(0,h.join)(N,"chroma"),combinedCerts:()=>(0,h.join)(N,"combined_certs.pem"),transcriptsConfig:()=>(0,h.join)(N,"transcript-watch.json"),transcriptsState:()=>(0,h.join)(N,"transcript-watch-state.json"),corpora:()=>(0,h.join)(N,"corpora"),supervisorRegistry:()=>(0,h.join)(N,"supervisor.json"),envFile:()=>(0,h.join)(N,".env"),logsDir:()=>ys,archives:()=>As,trash:()=>Ds,backups:()=>Cs,modes:()=>vs,vectorDb:()=>Ls,observerSessions:()=>bt};var Rt={injection:"injection_count",explicit_fetch:"explicit_fetch_count",fts:"fts_hit_count",vector:"vector_hit_count"};function Z(s){let e=typeof s=="string"?s.trim().toLowerCase():"";return e==="curated"||e==="observed"?e:"all"}function pe(s){return`COALESCE(${s?`${s}.`:""}source_kind, 'observed')`}function He(s,e){return s==="all"?null:{sql:`${pe(e)} = ?`,param:s}}var Nt=require("crypto");function Be(s,e,t){return(0,Nt.createHash)("sha256").update([s||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Ge(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[String(e)]}catch{return[s]}}var Xe=s=>`\xABredacted:${s}\xBB`,Ps=[{type:"PRIVATE_KEY",re:/-----BEGIN[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----[\s\S]{0,4000}?-----END[ A-Z0-9_-]{0,100}PRIVATE KEY(?: BLOCK)?-----/g},{type:"CONNECTION_STRING",re:/\b(?:jdbc:[a-z0-9]{1,20}:)?(?:postgres(?:ql)?|mysql|mongodb(?:\+srv)?|redis|amqp|sqlserver|oracle|https?):\/\/[^\s/@]+:[^\s/@]+@[^\s]{1,200}/gi},{type:"CREDENTIAL_ASSIGNMENT",re:/\b(?:password|pwd|passwd)\s{0,3}=\s{0,3}(?:"([^"\r\n]{1,200})"|'([^'\r\n]{1,200})'|([^;"'\r\n]{1,200}))/gi,group:1},{type:"AWS_KEY",re:/\b((?:A3T[A-Z0-9]|AKIA|ASIA|ABIA|ACCA)[A-Z2-7]{16})\b/g},{type:"GITHUB_FINE_PAT",re:/\bgithub_pat_\w{82}\b/g},{type:"GITHUB_PAT",re:/\bghp_[0-9A-Za-z]{36}\b/g},{type:"GITLAB_PAT",re:/\bglpat-[\w-]{20}\b/g},{type:"SLACK_TOKEN",re:/\bxox[baprs]-[0-9A-Za-z-]{10,200}\b/g},{type:"GOOGLE_API_KEY",re:/\bAIza[\w-]{35}\b/g},{type:"STRIPE_KEY",re:/\b(?:sk|rk|pk)_(?:test|live|prod)_[A-Za-z0-9]{10,99}\b/g},{type:"JWT",re:/\bey[A-Za-z0-9_-]{17,500}\.ey[A-Za-z0-9_/\\-]{17,500}\.[A-Za-z0-9_/\\-]{10,500}={0,2}/g},{type:"BEARER",re:/\b[Bb]earer\s+[A-Za-z0-9._~+/=-]{12,500}/g},{type:"BCRYPT",re:/\$2[aby]\$\d{2}\$[./A-Za-z0-9]{53}/g},{type:"GENERIC_SECRET",re:/(?:pass(?:word)?|secret|token|api[_-]?key|client[_-]?secret|auth)\b['"\s]{0,3}[:=>]{1,2}['"\s]{0,3}([\w./+=-]{10,150})/gi,group:1},{type:"EMAIL",category:"pii",re:/\b[\w.+-]{1,64}@[\w-]{1,63}(?:\.[\w-]{1,63}){1,4}\b/g},{type:"IP_ADDRESS",category:"pii",re:/\b(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\b/g,keep:s=>s==="0.0.0.0"||s==="255.255.255.255"||s.startsWith("127.")}];function It(s){return s.includes("redacted:")}function ws(s,e){if(e.re.lastIndex=0,e.group===void 0)return s.replace(e.re,r=>It(r)||e.keep?.(r)?r:Xe(e.type));let t=e.group;return s.replace(e.re,(r,...n)=>{if(e.keep?.(r))return r;let o=r,i=!1;for(let a=t-1;a<n.length;a++){let d=n[a];typeof d!="string"||d.length===0||It(d)||(o=o.replace(d,Xe(e.type)),i=!0)}return i?o:r})}function ks(s){if(s.length===0)return 0;let e=new Map;for(let r of s)e.set(r,(e.get(r)??0)+1);let t=0;for(let r of e.values()){let n=r/s.length;t-=n*Math.log2(n)}return t}var Us=/^[0-9a-f]+$/i;function Fs(s,e){return s.length<20||s.length>200||/[\s]/.test(s)||!/\d/.test(s)||!/[A-Za-z]/.test(s)||s.includes("/")||s.includes("\\")||s.length<=64&&Us.test(s)||s.includes("redacted:")?!1:ks(s)>=e}var $s=/([\s"'`,;(){}\[\]<>]+)/;function js(s,e){let t=s.split($s);for(let r=0;r<t.length;r++){let n=t[r];n&&Fs(n,e)&&(t[r]=Xe("HIGH_ENTROPY"))}return t.join("")}function We(s,e={}){if(typeof s!="string"||s.length===0)return s;try{let t=s,r=e.pii!==!1;for(let n of Ps)n.category==="pii"&&!r||(t=ws(t,n));return e.entropySweep!==!1&&(t=js(t,e.entropyThreshold??4)),t}catch{return s}}function _e(s,e={}){if(typeof s=="string")return We(s,e);if(Array.isArray(s))return s.map(t=>_e(t,e));if(s&&typeof s=="object"){let t={};for(let[r,n]of Object.entries(s))t[r]=_e(n,e);return t}return s}var Ee=require("fs");var Ye={redactSecrets:{enabled:!0,entropyThreshold:4,entropySweep:!0,pii:!0},scoping:{enabled:!0,includeGlobal:!0,defaultSearchScope:"project"},importance:{enabled:!0,halfLifeDays:14,llmRefine:!1},injection:{tokenBudget:1e3,candidateMultiplier:3},reconcile:{enabled:!1,noopThreshold:.92,updateBand:.75,llmAdjudicate:!1,allowHardDelete:!1},supersession:{enabled:!1},expiry:{enabled:!1,ttlDays:28,importanceFloor:7,hardDelete:!1},vectorRetention:{enabled:!0,inactiveDays:90},optimizer:{enabled:!0,tickMinutes:5,vacuumHours:24}};function me(s){return!!s&&typeof s=="object"&&!Array.isArray(s)}function K(s,e){if(!me(e))return{...s};let t={...s};for(let r of Object.keys(s))e[r]!==void 0&&typeof e[r]==typeof s[r]&&(t[r]=e[r]);return t}var Ve=null;function ge(s=!1){if(Ve&&!s)return Ve;let e=Ye,t;try{let i=H.settings();if((0,Ee.existsSync)(i)){let a=JSON.parse((0,Ee.readFileSync)(i,"utf-8").replace(/^﻿/,"")),d=me(a)?a.memoryQuality??(me(a.env)?a.env.memoryQuality:void 0):void 0;me(d)&&(t=d)}}catch(i){u.debug("CONFIG","memoryQuality config load failed; using defaults",{},i instanceof Error?i:new Error(String(i)))}let r={redactSecrets:K(e.redactSecrets,t?.redactSecrets),scoping:K(e.scoping,t?.scoping),importance:K(e.importance,t?.importance),injection:K(e.injection,t?.injection),reconcile:K(e.reconcile,t?.reconcile),supersession:K(e.supersession,t?.supersession),expiry:K(e.expiry,t?.expiry),vectorRetention:K(e.vectorRetention,t?.vectorRetention),optimizer:K(e.optimizer,t?.optimizer)},n=y("KEEPMIND_REDACT_SECRETS");(n==="0"||n==="false")&&(r.redactSecrets.enabled=!1);let o=y("KEEPMIND_REDACT_PII");return(o==="0"||o==="false")&&(r.redactSecrets.pii=!1),Ve=r,r}var Ks={decision:9,bugfix:8,refactor:6,discovery:5,global:7,other:3,trivial:1};function Hs(s){if(Array.isArray(s))return s.length;if(typeof s=="string")try{let e=JSON.parse(s);return Array.isArray(e)?e.length:0}catch{return 0}return 0}function qe(s){let e=Ks[s.type??"other"]??4;return Hs(s.files_modified)>0&&(e+=1),(s.narrative?.length??0)<40&&(e-=1),/\b(TODO|FIXME|WIP)\b/i.test(s.narrative??"")&&(e-=1),Math.max(1,Math.min(10,e))}var Bs=14,Gs=864e5;function Ot(s,e={}){let t=e.now??Date.now(),r=(e.halfLifeDays??Bs)*Gs,n=(s.importance??5)/10,o=Math.max(0,t-(s.created_at_epoch??t)),i=Math.pow(.5,o/r);return n*i}function yt(s){return s.normalize("NFC").toLowerCase().replace(/ä/g,"ae").replace(/ö/g,"oe").replace(/ü/g,"ue").replace(/ß/g,"ss")}var Xs=new Set(["the","a","an","and","or","but","to","of","in","on","for","with","is","are","was","were","be","been","it","this","that","we","i","as","at","by","from","into","over","so","then","than","will","der","die","das","den","dem","des","ein","eine","einen","einem","einer","eines","und","oder","aber","ist","sind","war","waren","wird","werden","wurde","wurden","hat","haben","hatte","hatten","f\xFCr","mit","von","vom","zu","zum","zur","im","auf","am","an","aus","bei","nach","\xFCber","unter","durch","gegen","ohne","um","als","wie","dass","sich","es","wir","man","auch","noch","nur","schon","dann","wenn","weil","damit","sowie","bereits"].map(yt));function fe(s){return s?yt(s).replace(/[^\p{L}\p{N}\s]+/gu," ").split(/\s+/).filter(e=>e.length>0&&!Xs.has(e)).join(" ").trim():""}function At(s){let e=new Set,t=s.replace(/\s+/g," ");for(let r=0;r+3<=t.length;r++)e.add(t.slice(r,r+3));return e}function Ws(s,e){let t=At(s),r=At(e);if(t.size===0&&r.size===0)return 1;if(t.size===0||r.size===0)return 0;let n=0;for(let o of t)r.has(o)&&n++;return n/(t.size+r.size-n)}function Vs(s,e){let t=new Map,r=new Map;for(let a of s.split(" "))a&&t.set(a,(t.get(a)??0)+1);for(let a of e.split(" "))a&&r.set(a,(r.get(a)??0)+1);if(t.size===0||r.size===0)return 0;let n=0;for(let[a,d]of t)n+=d*(r.get(a)??0);let o=0;for(let a of t.values())o+=a*a;let i=0;for(let a of r.values())i+=a*a;return n/(Math.sqrt(o)*Math.sqrt(i)||1)}function Ys(s,e){let t=fe(`${s??""}`),r=fe(`${e??""}`);return Math.max(Ws(t,r),Vs(t,r))}function Dt(s,e,t){let r=`${s.title??""} ${s.narrative??""}`,n={action:"ADD"},o=-1;for(let i of e){let a=Ys(r,`${i.title??""} ${i.narrative??""}`);a<=o||(o=a,a>=t.noopThreshold?n={action:"NOOP",candidateId:i.id,score:a}:a>=t.updateBand&&t.supersessionEnabled?n={action:"UPDATE",candidateId:i.id,score:a}:n={action:"ADD",score:a})}return n}var Ct=require("crypto");function Te(s){let e=s.title??"";if(!e){if(Array.isArray(s.facts)&&s.facts.length>0)e=s.facts[0];else if(typeof s.facts=="string")try{let r=JSON.parse(s.facts);Array.isArray(r)&&r.length>0&&(e=String(r[0]))}catch{}}e||(e=(s.narrative??"").slice(0,80));let t=fe(e);return(0,Ct.createHash)("sha1").update(t).digest("hex").slice(0,16)}var E="claude";function qs(s){return s.trim().toLowerCase().replace(/\s+/g,"-")}function D(s){if(!s)return E;let e=qs(s);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:E}function vt(s){let e=["claude","codex","cursor"];return[...s].sort((t,r)=>{let n=e.indexOf(t),o=e.indexOf(r);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(r)})}function Lt(s,e,t,r,n){let o=Date.now()-r,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return s.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
...
`).map(r=>r.trim()).find(r=>r.length>0)??"Session checkpoint").replace(/^#+\s*/,"").replace(/^\*+\s*/,"").replace(/\*+$/,"").trim();return t?t.length>80?`${t.slice(0,80).trimEnd()}\u2026`:t:"Session checkpoint"}var zs=/^0\d{3}$/,Zs=/^V-\d{4}$/;function en(s){let e=s?`${s}.`:"";return`COALESCE(json_extract(${e}metadata, '$.record_id'), json_extract(${e}metadata, '$.vorgang_id'))`}var w=en();function tn(s){let e=s.trim();return zs.test(e)?"akte":Zs.test(e)?"vorgang":null}function Ft(s,e){if(s)try{if(JSON.parse(s)?.kind==="vorgang")return"vorgang"}catch{}return(e&&tn(e))==="vorgang"?"vorgang":"akte"}var $t="keepmind://curated/";function nn(s,e){return{customTitle:s,platformSource:e?D(e):void 0}}var he=class s{db;redactEnabled;redactOpts;mq;rt(e){return this.redactEnabled?We(e,this.redactOpts):e}rl(e){return this.redactEnabled?_e(e,this.redactOpts):e}constructor(e=j){try{this.mq=ge();let t=this.mq.redactSecrets;this.redactEnabled=t.enabled,this.redactOpts={entropySweep:t.entropySweep,entropyThreshold:t.entropyThreshold}}catch{this.mq=Ye,this.redactEnabled=y("KEEPMIND_REDACT_SECRETS")!=="0"&&y("KEEPMIND_REDACT_SECRETS")!=="false",this.redactOpts={entropySweep:!0,entropyThreshold:4}}if(e instanceof q)this.db=e;else{e!==":memory:"&&ht(N);let t=e===j?z():e;this.db=new q(t),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run(`PRAGMA journal_size_limit = ${4194304}`),this.db.run(`PRAGMA busy_timeout = ${5e3}`)}this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationImportanceColumn(),this.addObservationBitemporalColumns(),this.addObservationLastUsedColumn(),this.addObservationUsageChannelColumns(),this.recomputeSubjectKeys(),this.addCuratedSourceColumns(),this.createDecisionEdgesTable()}createDecisionEdgesTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(42),t=this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='decision_edges'").all();e&&t.length>0||(this.db.run(`
    ...
    `).get(...r)||null}getFilesForSession(e){let r=this.db.prepare(`
      ...
      FROM observations
      WHERE memory_session_id = ?
    `).all(e),n=new Set,o=new Set;for(let i of r)Ge(i.files_read).forEach(a=>n.add(a)),Ge(i.files_modified).forEach(a=>o.add(a));return{filesRead:Array.from(n),filesModified:Array.from(o)}}getSessionById(e){return this.db.prepare(`
    ...
    `).get(e).count}createSDKSession(e,t,r,n,o){let i=new Date,a=i.getTime(),d=nn(n,o),c=d.platformSource??E,l=this.rt(be(r)),_=this.db.prepare(`
...
`,"utf-8"),a;try{a=(0,A.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,A.openSync)(o,"w",a):(0,A.openSync)(o,"w");let c=0;for(;c<i.length;){let l=(0,A.writeSync)(d,i,c,i.length-c);if(l===0)throw new Error(`writeSync stalled at ${c}/${i.length} bytes`);c+=l}if((0,A.fsyncSync)(d),(0,A.closeSync)(d),d=void 0,(0,A.renameSync)(o,t),!un){let l;try{l=(0,A.openSync)(r,"r"),(0,A.fsyncSync)(l)}catch{}finally{if(l!==void 0)try{(0,A.closeSync)(l)}catch{}}}}catch(c){if(d!==void 0)try{(0,A.closeSync)(d)}catch{}try{(0,A.unlinkSync)(o)}catch{}throw c}}var Ne=class{static DEFAULTS={KEEPMIND_MODEL:"claude-haiku-4-5-20251001",KEEPMIND_CONTEXT_OBSERVATIONS:"50",KEEPMIND_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),KEEPMIND_WORKER_HOST:"127.0.0.1",KEEPMIND_API_TIMEOUT_MS:String(Vt(Qe.API_REQUEST)),KEEPMIND_SKIP_TOOLS:["ListMcpResourcesTool","SlashCommand","Skill","TodoWrite","AskUserQuestion","ToolSearch","BashOutput","KillShell","EnterPlanMode","ExitPlanMode","TaskCreate","TaskUpdate","TaskList","TaskGet","TaskOutput","TaskStop","Glob","Grep"].join(","),KEEPMIND_PROVIDER:"claude",KEEPMIND_CLAUDE_AUTH_METHOD:"subscription",KEEPMIND_GEMINI_API_KEY:"",KEEPMIND_GEMINI_MODEL:"gemini-2.5-flash-lite",KEEPMIND_GEMINI_RATE_LIMITING_ENABLED:"true",KEEPMIND_GEMINI_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_GEMINI_MAX_TOKENS:"100000",KEEPMIND_OPENROUTER_API_KEY:"",KEEPMIND_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",KEEPMIND_OPENROUTER_BASE_URL:"",KEEPMIND_OPENROUTER_SITE_URL:"",KEEPMIND_OPENROUTER_APP_NAME:"keepmind",KEEPMIND_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",KEEPMIND_OPENROUTER_MAX_TOKENS:"100000",KEEPMIND_DATA_DIR:(0,se.join)((0,ze.homedir)(),".keepmind"),KEEPMIND_LOG_LEVEL:"INFO",CLAUDE_CODE_PATH:"",KEEPMIND_MODE:"code",KEEPMIND_CONTEXT_SHOW_READ_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_WORK_TOKENS:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT:"true",KEEPMIND_CONTEXT_FULL_COUNT:"0",KEEPMIND_CONTEXT_FULL_FIELD:"narrative",KEEPMIND_CONTEXT_SESSION_COUNT:"5",KEEPMIND_OBSERVATION_BATCH_MAX:"8",KEEPMIND_OBSERVATION_COALESCE_MS:"2500",KEEPMIND_MAX_CONTEXT_MESSAGES:"40",KEEPMIND_OBSERVER_SESSION_MODE:"stateless",KEEPMIND_OBS_FIELD_MAX_CHARS:"2000",KEEPMIND_CAPTURE_PROFILE:"",KEEPMIND_OBSERVE_TRIGGER:"batched",KEEPMIND_ENABLED:"true",KEEPMIND_FILE_CONTEXT_ENABLED:"true",KEEPMIND_DECISION_CHECK_ENABLED:"true",KEEPMIND_DECISION_CHECK_MAX_ROWS:"3",KEEPMIND_CURATED_PROJECT:"",KEEPMIND_FILE_CONTEXT_MIN_BYTES:"1500",KEEPMIND_FILE_CONTEXT_MAX_ROWS:"3",KEEPMIND_FILE_CONTEXT_MIN_SCORE:"2",KEEPMIND_SESSION_START_INJECT:"true",KEEPMIND_SESSION_START_MAX_CHARS:"4500",KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY:"true",KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE:"false",KEEPMIND_INJECT_SOURCE_KIND:"all",KEEPMIND_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",KEEPMIND_WELCOME_HINT_ENABLED:"true",KEEPMIND_UPDATE_CHECK_ENABLED:"true",KEEPMIND_MCP_SMART_TOOLS:"false",KEEPMIND_MCP_CORPUS_TOOLS:"false",KEEPMIND_FOLDER_CLAUDEMD_ENABLED:"false",KEEPMIND_FOLDER_USE_LOCAL_MD:"false",KEEPMIND_TRANSCRIPTS_ENABLED:"true",KEEPMIND_TRANSCRIPTS_CONFIG_PATH:(0,se.join)((0,ze.homedir)(),".keepmind","transcript-watch.json"),KEEPMIND_CODEX_TRANSCRIPT_INGESTION:"false",KEEPMIND_MAX_CONCURRENT_AGENTS:"2",KEEPMIND_HOOK_FAIL_LOUD_THRESHOLD:"3",KEEPMIND_EXCLUDED_PROJECTS:"",KEEPMIND_FOLDER_MD_EXCLUDE:"[]",KEEPMIND_FOLDER_MD_SKELETON_DENYLIST:"[]",KEEPMIND_SEMANTIC_INJECT:"false",KEEPMIND_SEMANTIC_INJECT_LIMIT:"5",KEEPMIND_TIER_ROUTING_ENABLED:"false",KEEPMIND_TIER_SIMPLE_MODEL:"haiku",KEEPMIND_TIER_SUMMARY_MODEL:"",KEEPMIND_TIER_FAST_MODEL:"haiku",KEEPMIND_TIER_SMART_MODEL:"sonnet",KEEPMIND_CHROMA_ENABLED:"true",KEEPMIND_TELEGRAM_ENABLED:"true",KEEPMIND_TELEGRAM_BOT_TOKEN:"",KEEPMIND_TELEGRAM_CHAT_ID:"",KEEPMIND_TELEGRAM_TRIGGER_TYPES:"security_alert",KEEPMIND_TELEGRAM_TRIGGER_CONCEPTS:"",KEEPMIND_QUEUE_ENGINE:"sqlite",KEEPMIND_REDIS_URL:"",KEEPMIND_REDIS_HOST:"127.0.0.1",KEEPMIND_REDIS_PORT:"6379",KEEPMIND_REDIS_MODE:"external",KEEPMIND_QUEUE_REDIS_PREFIX:`keepmind_${y("KEEPMIND_WORKER_PORT")??String(37700+(process.getuid?.()??77)%100)}`,KEEPMIND_AUTH_MODE:"api-key",KEEPMIND_RUNTIME:"worker",KEEPMIND_SERVER_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_API_KEY:"",KEEPMIND_SERVER_PROJECT_ID:"",KEEPMIND_SERVER_BETA_URL:`http://127.0.0.1:${y("KEEPMIND_SERVER_PORT")??String(37877+(process.getuid?.()??77)%100)}`,KEEPMIND_SERVER_BETA_API_KEY:"",KEEPMIND_SERVER_BETA_PROJECT_ID:""};static getAllDefaults(){return{...this.DEFAULTS}}static envOverride(e){return y(e)}static get(e){return this.envOverride(e)??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let r of Object.keys(this.DEFAULTS)){let n=this.envOverride(r);n!==void 0&&(t[r]=n)}return t}static toCanonicalKeys(e){let t={};for(let[r,n]of Object.entries(e)){if(!r.startsWith("CLAUDE_MEM_")){t[r]=n;continue}let o="KEEPMIND_"+r.slice(11);e[o]===void 0&&(t[o]=n)}return t}static loadFromFile(e,t=!0){try{if(!(0,F.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,se.dirname)(e);(0,F.existsSync)(d)||(0,F.mkdirSync)(d,{recursive:!0}),re(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let r=(0,F.readFileSync)(e,"utf-8"),n=JSON.parse(r.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{re(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS)){let d=B(a,o);d!==void 0&&(i[a]=d)}if(ft(o))try{re(e,this.toCanonicalKeys(o)),console.warn("[SETTINGS] Migrated settings file to the KEEPMIND_* key prefix:",e)}catch(a){console.warn("[SETTINGS] Failed to migrate settings keys (legacy names still honored):",e,a instanceof Error?a.message:String(a))}return t?this.applyEnvOverrides(i):i}catch(r){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,r instanceof Error?r.message:String(r));let n=this.getAllDefaults();try{if((0,F.existsSync)(e)){let o=`${e}.corrupt-${Date.now()}`;(0,F.renameSync)(e,o),console.warn("[SETTINGS] Backed up corrupt settings file to:",o)}re(e,n),console.warn("[SETTINGS] Recovered settings file with defaults:",e)}catch(o){console.warn("[SETTINGS] Failed to recover corrupt settings file:",e,o instanceof Error?o.message:String(o))}return t?this.applyEnvOverrides(n):n}}};var ne=require("fs"),Ie=require("path");var M=class s{static instance=null;activeMode=null;modesDir;constructor(){let e=St(),t=y("KEEPMIND_MODES_DIR"),r=[...t?[t]:[],(0,Ie.join)(e,"modes"),(0,Ie.join)(e,"..","plugin","modes")],n=r.find(o=>(0,ne.existsSync)(o));this.modesDir=n||r[0]}static getInstance(){return s.instance||(s.instance=new s),s.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let r={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?r[n]=this.deepMerge(i,o):r[n]=o}return r}loadModeFile(e){let t=(0,Ie.join)(this.modesDir,`${e}.json`);if(!(0,ne.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let r=(0,ne.readFileSync)(t,"utf-8");return JSON.parse(r)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,u.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:r,overrideId:n}=t,o;try{o=this.loadMode(r)}catch(d){d instanceof Error?u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{message:d.message}):u.warn("WORKER",`Parent mode '${r}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),u.debug("SYSTEM",`Loaded override file: ${n} for parent ${r}`)}catch(d){return d instanceof Error?u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{message:d.message}):u.warn("WORKER",`Override file '${n}' not found, using parent mode '${r}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return u.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${r}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,u.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${r} + ${n})`,void 0,{parent:r,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(r=>r.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(r=>r.id===e)?.work_emoji||"\u{1F4DD}"}};function qt(){let s=H.settings(),e=Ne.loadFromFile(s),t=M.getInstance().getActiveMode(),r=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.KEEPMIND_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.KEEPMIND_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.KEEPMIND_CONTEXT_SESSION_COUNT,10),showReadTokens:e.KEEPMIND_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.KEEPMIND_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.KEEPMIND_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:r,observationConcepts:n,fullObservationField:e.KEEPMIND_CONTEXT_FULL_FIELD,showLastSummary:e.KEEPMIND_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.KEEPMIND_CONTEXT_SHOW_LAST_MESSAGE==="true",injectSourceKind:Z(e.KEEPMIND_INJECT_SOURCE_KIND)}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},Oe=4,Ze=1;function et(s){let e=(s.title?.length||0)+(s.subtitle?.length||0)+(s.narrative?.length||0)+JSON.stringify(s.facts||[]).length;return Math.ceil(e/Oe)}function tt(s){let e=s.length,t=s.reduce((i,a)=>i+et(a),0),r=s.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=r-t,o=r>0?Math.round(n/r*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:r,savings:n,savingsPercent:o}}function pn(s){return M.getInstance().getWorkEmoji(s)}function oe(s,e){let t=et(s),r=s.discovery_tokens||0,n=pn(s.type),o=r>0?`${n} ${r.toLocaleString("en-US")}`:"-";return{readTokens:t,discoveryTokens:r,discoveryDisplay:o,workEmoji:n}}function Ae(s){return s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent}function _n(s){return En(s)}var mn=28;function En(s){let e=(s.title?.length??8)+mn;return Math.max(1,Math.ceil(e/Oe))}function gn(s,e){if(!Number.isFinite(e)||e<=0)return s;let t=[],r=0;for(let n of s){let o=_n(n);r+o>e||(t.push(n),r+=o)}return t}function Jt(s,e){let t=e.now??Date.now(),r=s.map(i=>({o:i,score:Ot(i,{now:t,halfLifeDays:e.halfLifeDays})})).sort((i,a)=>a.score-i.score).map(i=>i.o),n=e.maxRows>0?r.slice(0,e.maxRows):r;return gn(n,e.tokenBudget).sort((i,a)=>(a.created_at_epoch??0)-(i.created_at_epoch??0))}var Qt=Y(require("path"),1),ye=require("fs");function zt(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(",");return s.db.prepare(`
  ...
  `).all(e,e,r??null,r??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function Zt(s,e,t,r){return s.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,r??null,r??null,t.sessionCount+Ze)}function er(s,e,t,r){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return s.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,r??null,r??null,t.injectSourceKind??"all",t.injectSourceKind??"all",...n,...i,t.totalObservationCount)}function tr(s,e,t,r){let n=e.map(()=>"?").join(",");return s.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,r??null,r??null,t.sessionCount+Ze)}function fn(s){return s.replace(/[/.]/g,"-")}function Tn(s){if(!s.includes('"type":"assistant"'))return null;let e=JSON.parse(s);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let r of e.message.content)r.type==="text"&&(t+=r.text);if(t=t.replace(wt,"").trim(),t)return t}return null}function bn(s){for(let e=s.length-1;e>=0;e--)try{let t=Tn(s[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function hn(s){try{if(!(0,ye.existsSync)(s))return{assistantMessage:""};let e=(0,ye.readFileSync)(s,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:bn(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:s},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:s,error:String(e)}),{assistantMessage:""}}}function rr(s,e,t,r){if(!e.showLastMessage||s.length===0)return{assistantMessage:""};let n=s.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=fn(r),a=Qt.default.join(G,"projects",i,`${o}.jsonl`);return hn(a)}function sr(s,e){let t=e[0]?.id;return s.map((r,n)=>{let o=n===0?null:e[n+1];return{...r,displayEpoch:o?o.created_at_epoch:r.created_at_epoch,displayTime:o?o.created_at:r.created_at,shouldShowLink:r.id!==t}})}function nr(s,e){let t=[...s.map(r=>({type:"observation",data:r})),...e.map(r=>({type:"summary",data:r}))];return t.sort((r,n)=>{let o=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function or(s,e){return new Set(s.slice(0,e).map(t=>t.id))}function ar(){let s=new Date,e=s.toLocaleDateString("en-CA"),t=s.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),r=s.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${r}`}function dr(s){return[`# [${s}] recent context, ${ar()}`,""]}function cr(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function ur(s,e){let t=[],r=[`${s.totalObservations} obs (${s.totalReadTokens.toLocaleString("en-US")}t indexed)`,`${s.totalDiscoveryTokens.toLocaleString("en-US")}t work`];return s.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?r.push(`${s.savingsPercent}% savings`):e.showSavingsAmount&&r.push(`${s.savings.toLocaleString("en-US")}t saved`)),t.push(`Stats: ${r.join(" | ")}`),t.push(""),t}function rt(s,e=new Date){let t=new Date(s);if(Number.isNaN(t.getTime()))return null;let r=i=>Date.UTC(i.getFullYear(),i.getMonth(),i.getDate()),n=Math.round((r(e)-r(t))/864e5);return n<=0?"today":n===1?"yesterday":n<7?`${n} days ago`:n<14?"last week":n<60?`${n} days ago`:`~${Math.round(n/30)} months ago`}function lr(s){let e=rt(s);return[e?`### ${s} (${e})`:`### ${s}`]}function pr(s){return s.toLowerCase().replace(" am","a").replace(" pm","p")}function _r(s,e,t){let r=s.title||"Untitled",n=M.getInstance().getTypeIcon(s.type),o=e?pr(e):'"';return`${s.id} ${o} ${n} ${r}`}function mr(s,e,t,r){let n=[],o=s.title||"Untitled",i=M.getInstance().getTypeIcon(s.type),a=e?pr(e):'"',{readTokens:d,discoveryDisplay:c}=oe(s,r);n.push(`**${s.id}** ${a} ${i} **${o}**`),t&&n.push(t);let l=[];return r.showReadTokens&&l.push(`~${d}t`),r.showWorkTokens&&l.push(c),l.length>0&&n.push(l.join(" ")),n.push(""),n}function Er(s,e){return[`S${s.id} ${s.request||"Session started"} (${e})`]}var ir=200;function ie(s,e){if(!e)return[];let t=e.length>ir?`${e.slice(0,ir).trimEnd()}\u2026`:e;return[`**${s}**: ${t}`,""]}function gr(s){return s.assistantMessage?["","---","","**Previously**","",`A: ${s.assistantMessage}`,""]:[]}function fr(s,e){return["",`Access ${Math.round(s/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Tr(s){return`# [${s}] recent context, ${ar()}

No previous sessions found.`}function br(){let s=new Date,e=s.toLocaleDateString("en-CA"),t=s.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),r=s.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${r}`}function hr(s){return["",`${p.bright}${p.cyan}[${s}] recent context, ${br()}${p.reset}`,`${p.gray}${"\u2500".repeat(60)}${p.reset}`,""]}function Sr(){let e=M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${p.dim}Legend: session-request | ${e}${p.reset}`,""]}function Rr(){return[`${p.bright}Column Key${p.reset}`,`${p.dim}  Read: Tokens to read this observation (cost to learn it now)${p.reset}`,`${p.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${p.reset}`,""]}function Nr(){return[`${p.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${p.reset}`,"",`${p.dim}When you need implementation details, rationale, or debugging context:${p.reset}`,`${p.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${p.reset}`,`${p.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${p.reset}`,`${p.dim}  - Trust this index over re-reading code for past decisions and learnings${p.reset}`,""]}function Ir(s,e){let t=[];if(t.push(`${p.bright}${p.cyan}Context Economics${p.reset}`),t.push(`${p.dim}  Loading: ${s.totalObservations} observations (${s.totalReadTokens.toLocaleString()} tokens to read)${p.reset}`),t.push(`${p.dim}  Work investment: ${s.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${p.reset}`),s.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let r="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?r+=`${s.savings.toLocaleString()} tokens (${s.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?r+=`${s.savings.toLocaleString()} tokens`:r+=`${s.savingsPercent}% reduction from reuse`,t.push(`${p.green}${r}${p.reset}`)}return t.push(""),t}function Or(s){return[`${p.bright}${p.cyan}${s}${p.reset}`,""]}function Ar(s){return[`${p.dim}${s}${p.reset}`]}function yr(s,e,t,r){let n=s.title||"Untitled",o=M.getInstance().getTypeIcon(s.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=oe(s,r),c=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),l=r.showReadTokens&&i>0?`${p.dim}(~${i}t)${p.reset}`:"",_=r.showWorkTokens&&a>0?`${p.dim}(${d} ${a.toLocaleString()}t)${p.reset}`:"";return`  ${p.dim}#${s.id}${p.reset}  ${c}  ${o}  ${n} ${l} ${_}`}function Dr(s,e,t,r,n){let o=[],i=s.title||"Untitled",a=M.getInstance().getTypeIcon(s.type),{readTokens:d,discoveryTokens:c,workEmoji:l}=oe(s,n),_=t?`${p.dim}${e}${p.reset}`:" ".repeat(e.length),m=n.showReadTokens&&d>0?`${p.dim}(~${d}t)${p.reset}`:"",g=n.showWorkTokens&&c>0?`${p.dim}(${l} ${c.toLocaleString()}t)${p.reset}`:"";return o.push(`  ${p.dim}#${s.id}${p.reset}  ${_}  ${a}  ${p.bright}${i}${p.reset}`),r&&o.push(`    ${p.dim}${r}${p.reset}`),(m||g)&&o.push(`    ${m} ${g}`),o.push(""),o}function Cr(s,e){let t=`${s.request||"Session started"} (${e})`;return[`${p.yellow}#S${s.id}${p.reset} ${t}`,""]}function ae(s,e,t){return e?[`${t}${s}:${p.reset} ${e}`,""]:[]}function vr(s){return s.assistantMessage?["","---","",`${p.bright}${p.magenta}Previously${p.reset}`,"",`${p.dim}A: ${s.assistantMessage}${p.reset}`,""]:[]}function Lr(s,e){let t=Math.round(s/1e3);return["",`${p.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use get_observations([IDs]) or the mem-search skill.${p.reset}`]}function Mr(s){return`
${p.bright}${p.cyan}[${s}] recent context, ${br()}${p.reset}
${p.gray}${"\u2500".repeat(60)}${p.reset}

${p.dim}No previous sessions found for this project yet.${p.reset}
`}function xr(s,e,t,r){let n=[];return r?n.push(...hr(s)):n.push(...dr(s)),r?n.push(...Sr()):n.push(...cr()),r&&(n.push(...Rr()),n.push(...Nr())),Ae(t)&&(r?n.push(...Ir(e,t)):n.push(...ur(e,t))),n}function Pr(s){if(!s||s.length===0)return[];let e=[];for(let t of s){let r=(t.created_at??"").slice(0,10),n=rt(r),o=n?`${r} \xB7 ${n}`:r,i=null;try{let a=t.metadata?JSON.parse(t.metadata):null;a&&typeof a.focus=="string"&&a.focus.trim()&&(i=a.focus.trim())}catch{}e.push(`# \u23F3 CHECKPOINT \u2014 ${t.project} (${o})`),e.push("Curated hand-off from the previous session. Resume from here before anything else."),i&&e.push(`_Focus: ${i}_`),e.push(""),t.narrative&&t.narrative.trim()&&(e.push(t.narrative.trim()),e.push("")),e.push("---"),e.push("")}return e}var x=require("node:fs"),st=require("node:path");var Sn="curated-import-state.json",de=1;function Rn(s){return(0,st.join)(s,Sn)}function Nn(s){let e=Rn(s);if(!(0,x.existsSync)(e))return{version:de,projects:{}};try{let t=JSON.parse((0,x.readFileSync)(e,"utf8"));return t?.version!==de?{version:de,projects:{}}:{version:de,projects:t.projects??{}}}catch(t){return u.warn("DB","Curated import state unreadable \u2014 treating as absent",{path:e},t instanceof Error?t:void 0),{version:de,projects:{}}}}function wr(s=N){return Object.values(Nn(s).projects)}function In(s){let e=0,t=0,r=[s];for(;r.length>0;){let n=r.pop(),o;try{o=(0,x.readdirSync)(n,{withFileTypes:!0}),t=Math.max(t,(0,x.statSync)(n).mtimeMs)}catch{continue}for(let i of o){let a=(0,st.join)(n,i.name);if(i.isDirectory()){r.push(a);continue}if(i.isFile()){e+=1;try{t=Math.max(t,(0,x.statSync)(a).mtimeMs)}catch{}}}}return{files:e,newest:t}}function kr(s){return s.map(e=>{let t=!1;try{t=(0,x.statSync)(e.path).isDirectory()}catch{t=!1}if(!t)return{path:e.path,kind:e.kind,files:0,newestMtimeEpoch:0,present:!1};let{files:r,newest:n}=In(e.path);return{path:e.path,kind:e.kind,files:r,newestMtimeEpoch:Math.round(n),present:!0}})}function Ur(s,e){if(!s||s.lastSuccessEpoch===null)return{stale:!0,reason:"never imported successfully"};if(!s.indexed)return{stale:!0,reason:"the last import did not get as far as verifying the semantic index"};let t=new Map(s.sources.map(r=>[r.path,r]));for(let r of e){let n=t.get(r.path);if(!n)return{stale:!0,reason:`a source was added: ${r.path}`};if(!r.present)return{stale:!0,reason:`a source is missing: ${r.path}`};if(r.files!==n.files)return{stale:!0,reason:`${r.path} holds ${r.files} file(s), ${n.files} at the last import`};if(r.newestMtimeEpoch>n.newestMtimeEpoch)return{stale:!0,reason:`${r.path} was changed after the last import`}}for(let r of s.sources)if(!e.some(n=>n.path===r.path))return{stale:!0,reason:`a source was removed from the configuration: ${r.path}`};return{stale:!1,reason:null}}var $=require("node:fs"),ve=require("node:path");var ot=require("node:path");var $r="settings.json",Fr="curatedSources",ce="KEEPMIND_CURATED_SOURCES";function nt(s,e){if(!Array.isArray(s))return e.push({entry:s,reason:`expected an array, got ${typeof s}`}),[];let t=[];for(let r of s){if(typeof r!="object"||r===null){e.push({entry:r,reason:"not an object"});continue}let n=r,o=n.path,i=n.kind;if(typeof o!="string"||o.trim().length===0){e.push({entry:r,reason:"missing `path`"});continue}if(i!=="akten"&&i!=="vorgaenge"){e.push({entry:r,reason:`\`kind\` must be "akten" or "vorgaenge", got ${JSON.stringify(i)}`});continue}if(!(0,ve.isAbsolute)(o)){e.push({entry:r,reason:`\`path\` must be absolute: ${o}`});continue}let a=n.project;if(a!==void 0&&(typeof a!="string"||a.trim().length===0)){e.push({entry:r,reason:`\`project\` must be a non-empty string when given, got ${JSON.stringify(a)}`});continue}t.push({path:(0,ve.resolve)(o),kind:i,...a?{project:a.trim()}:{}})}return t}function jr(s,e){let t=new Map;for(let r of s){let n=r.project??e,o=t.get(n);o?o.push(r):t.set(n,[r])}return t}function Kr(s=N){let e=[],t=process.env[ce];if(t&&t.trim().length>0){let n=t.trim();try{return n.startsWith("[")?{sources:nt(JSON.parse(n),e),origin:`${ce} (inline)`,rejected:e}:(0,$.existsSync)(n)?{sources:nt(JSON.parse((0,$.readFileSync)(n,"utf8")),e),origin:n,rejected:e}:(e.push({entry:n,reason:`${ce} is neither JSON nor an existing file`}),{sources:[],origin:ce,rejected:e})}catch(o){return e.push({entry:n,reason:`unreadable: ${o instanceof Error?o.message:o}`}),{sources:[],origin:ce,rejected:e}}}let r=(0,ot.join)(s,$r);if(!(0,$.existsSync)(r))return{sources:[],origin:r,rejected:e};try{let n=JSON.parse((0,$.readFileSync)(r,"utf8"));return Fr in n?{sources:nt(n[Fr],e),origin:r,rejected:e}:{sources:[],origin:r,rejected:e}}catch(n){return u.warn("DB","Could not read curated source set",{settingsPath:r},n instanceof Error?n:void 0),e.push({entry:r,reason:`unreadable: ${n instanceof Error?n.message:n}`}),{sources:[],origin:r,rejected:e}}}function Hr(s=N){let e=y("KEEPMIND_CURATED_PROJECT");if(e&&e.trim().length>0)return e.trim();let t=(0,ot.join)(s,$r);if(!(0,$.existsSync)(t))return null;try{let r=JSON.parse((0,$.readFileSync)(t,"utf8")),n=r.env??r,o=B("KEEPMIND_CURATED_PROJECT",n);return typeof o=="string"&&o.trim().length>0?o.trim():null}catch{return null}}function Br(s){return s.filter(e=>{try{return!(0,$.statSync)(e.path).isDirectory()}catch{return!0}})}function Gr(s=N,e={}){let t=new Map;for(let a of wr(s))t.set(a.project,a);let r=Kr(s),n=new Map;if(r.sources.length>0){let a=r.sources.filter(c=>c.project);for(let[c,l]of jr(a,"(unattributed)"))c!=="(unattributed)"&&n.set(c,l);let d=r.sources.filter(c=>!c.project);if(d.length>0){let c=Hr(s),l=c?[c]:t.size>0?[...t.keys()]:[];for(let _ of l)n.set(_,[...n.get(_)??[],...d]);l.length===0&&n.set("(no project configured)",d)}}let o=new Set([...t.keys(),...n.keys()]),i=[];for(let a of o){let d=t.get(a)??null,c=n.get(a)??[],l=c.length>0?Ur(d,kr(c)):{stale:d===null||d.lastSuccessEpoch===null,reason:d?null:"never imported"},_=Br(c),m=e.storedRecords?e.storedRecords.get(a)??0:null,g=On(c,_,m);i.push({project:a,lastSuccessEpoch:d?.lastSuccessEpoch??null,lastAttemptEpoch:d?.lastAttemptEpoch??0,records:d?.records??0,edges:d?.edges??0,indexed:d?.indexed??!1,failure:d?.failure??null,stale:l.stale,staleReason:l.reason,ok:d!==null&&d.lastSuccessEpoch!==null&&d.indexed&&!d.failure&&!l.stale,sources:c,absentSources:_,storedRecords:m,presence:g})}return i.sort((a,d)=>a.project.localeCompare(d.project))}function On(s,e,t){return s.length===0||e.length===0||e.length<s.length?"present":t===null?"unknown":t>0?"detached":"absent"}function An(s,e=Date.now()){if(s.lastSuccessEpoch===null)return"never";let t=new Date(s.lastSuccessEpoch).toISOString().slice(0,10),r=Math.floor((e-s.lastSuccessEpoch)/864e5);return r<=0?`${t} \xB7 today`:r===1?`${t} \xB7 yesterday`:`${t} \xB7 ${r} days ago`}function V(s,e=Date.now()){let t=An(s,e);if(s.ok)return`last imported ${t} \xB7 ${s.records} record(s), ${s.edges} relation(s) \xB7 index in sync`;if(s.presence==="detached")return`${s.storedRecords??0} record(s) held here, searchable \xB7 sources not reachable from this machine (${s.absentSources.map(o=>o.path).join(", ")}) \u2014 nothing refreshes them here`;if(s.presence==="absent")return"configured for a corpus this machine does not have";let r=new Set;return s.lastSuccessEpoch===null&&r.add("never imported successfully"),s.failure&&r.add(s.failure),s.indexed||r.add("the last import did not get as far as verifying the semantic index"),s.stale&&s.staleReason&&r.add(s.staleReason),`last imported ${t} \u2014 ${[...r].join("; ")}`}var Xr=require("node:fs"),Wr=require("node:sqlite");function Vr(s=z()){if(!(0,Xr.existsSync)(s))return null;let e=null;try{e=new Wr.DatabaseSync(s,{readOnly:!0});let t=e.prepare(`
      SELECT project, COUNT(*) AS n
        FROM observations
       WHERE source_kind = 'curated' AND project IS NOT NULL AND project != ''
       GROUP BY project
    `).all();return new Map(t.map(r=>[String(r.project),Number(r.n)]))}catch(t){return u.debug("DB","Curated record counts could not be read",{},t instanceof Error?t:void 0),null}finally{try{e?.close()}catch{}}}function Yr(s={}){let e=s.now??Date.now(),t;try{t=s.entries??Gr(void 0,{storedRecords:Vr()})}catch(c){return u.debug("WORKER","Curated health could not be read",{},c instanceof Error?c:void 0),[]}if(t.length===0)return[];if(t=t.filter(c=>c.presence!=="absent"),t.length===0)return[];let r=t.filter(c=>c.presence==="detached"),n=t.filter(c=>c.presence!=="detached"),o=r.map(c=>`Curated corpus [${c.project}]: ${V(c,e)}`);if(n.length===0)return[...o,""];t=n;let i=t.filter(c=>!c.ok),a=[];if(i.length===0){for(let c of t)a.push(`Curated corpus [${c.project}]: ${V(c,e)}`);return a.push(...o),a.push(""),a}a.push("# \u26A0 CURATED CORPUS OUT OF STEP"),a.push("The lasting entries below are not in step with their source files. Answers drawn from them may be out of date."),a.push("");for(let c of i)a.push(`- **${c.project}** \u2014 ${V(c,e)}`);let d=t.filter(c=>c.ok);for(let c of d)a.push(`- ${c.project} \u2014 ${V(c,e)}`);for(let c of r)a.push(`- ${c.project} \u2014 ${V(c,e)}`);return a.push(""),a.push("Fix it with `npx keepmind curated:import` (add `--project <name>`), then `npx keepmind doctor`."),a.push(""),a.push("---"),a.push(""),a}var Le=Y(require("path"),1);function Me(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:s?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function it(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function at(s){return new Date(s).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Jr(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function qr(s,e){return Le.default.isAbsolute(s)?Le.default.relative(e,s).split(Le.default.sep).join("/"):s}function Qr(s,e,t){let r=Me(s);if(r.length>0)return qr(r[0],e);if(t){let n=Me(t);if(n.length>0)return qr(n[0],e)}return"General"}function yn(s){let e=new Map;for(let r of s){let n=r.type==="observation"?r.data.created_at:r.data.displayTime,o=Jr(n);e.has(o)||e.set(o,[]),e.get(o).push(r)}let t=Array.from(e.entries()).sort((r,n)=>{let o=new Date(r[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function zr(s,e){return e.fullObservationField==="narrative"?s.narrative:s.facts?Me(s.facts).join(`
`):null}function Dn(s,e,t,r){let n=[];n.push(...lr(s));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=it(a.displayTime);n.push(...Er(a,d))}else{let a=i.data,d=at(a.created_at),l=d!==o?d:"";if(o=d,t.has(a.id)){let m=zr(a,r);n.push(...mr(a,l,m,r))}else n.push(_r(a,l,r))}return n}function Cn(s,e,t,r,n){let o=[];o.push(...Or(s));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,l=it(c.displayTime);o.push(...Cr(c,l))}else{let c=d.data,l=Qr(c.files_modified,n,c.files_read),_=at(c.created_at),m=_!==a;a=_;let g=t.has(c.id);if(l!==i&&(o.push(...Ar(l)),i=l),g){let I=zr(c,r);o.push(...Dr(c,_,m,I,r))}else o.push(yr(c,_,m,r))}return o.push(""),o}function vn(s,e,t,r,n,o){return o?Cn(s,e,t,r,n):Dn(s,e,t,r)}function Zr(s,e,t,r,n){let o=[],i=yn(s);for(let[a,d]of i)o.push(...vn(a,d,e,t,r,n));return o}function es(s,e,t){return!(!s.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ts(s,e){let t=[];return e?(t.push(...ae("Investigated",s.investigated,p.blue)),t.push(...ae("Learned",s.learned,p.yellow)),t.push(...ae("Completed",s.completed,p.green)),t.push(...ae("Next Steps",s.next_steps,p.magenta))):(t.push(...ie("Investigated",s.investigated)),t.push(...ie("Learned",s.learned)),t.push(...ie("Completed",s.completed)),t.push(...ie("Next Steps",s.next_steps))),t}function rs(s,e){return e?vr(s):gr(s)}function ss(s,e,t){return!Ae(e)||s.totalDiscoveryTokens<=0||s.savings<=0?[]:t?Lr(s.totalDiscoveryTokens,s.totalReadTokens):fr(s.totalDiscoveryTokens,s.totalReadTokens)}var Ln=ns.default.join((0,os.homedir)(),".claude","plugins","marketplaces","keepmind","plugin",".install-version");function Mn(){try{return new he}catch(s){if(s instanceof Error&&s.code==="ERR_DLOPEN_FAILED"){try{(0,is.unlinkSync)(Ln)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw s}}function xn(s,e){return e?Mr(s):Tr(s)}function Pn(s,e,t,r,n,o,i,a){let d=[],c=tt(e);d.push(...xr(s,c,n,a)),d.push(...Yr()),d.push(...Pr(r));let l=t.slice(0,n.sessionCount),_=sr(l,t),m=nr(e,_),g=or(e,n.fullObservationCount);d.push(...Zr(m,g,n,o,a));let I=t[0],O=e[0];es(n,I,O)&&d.push(...ts(I,a));let T=rr(e,n,i,o);return d.push(...rs(T,a)),d.push(...ss(c,n,a)),d.join(`
`).trimEnd()}var wn=new Set(["bugfix","discovery","decision","refactor","security_alert","security_note"]);function kn(s,e,t){let r=tt(s),n={bugfix:0,discovery:0,decision:0,refactor:0,security_alert:0,security_note:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of s){let c=wn.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:s.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_security_alert:n.security_alert,obs_type_security_note:n.security_note,obs_type_other:n.other,tokens_injected:r.totalReadTokens,tokens_saved_vs_naive:r.savings,search_strategy:t?"full":"timeline"}}async function dt(s,e=!1){let t=qt(),r=ge(),n=s?.cwd??process.cwd(),o=Wt(n),i=s?.projects?.length?s.projects:o.allProjects,a=i[i.length-1]??o.primary,d=r.importance.enabled&&!s?.full,c=t.totalObservationCount;d&&(t.totalObservationCount=Math.max(c,c*Math.max(1,r.injection.candidateMultiplier))),s?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let l=Mn();if(!l)return{text:"",stats:null};try{let _=s?.platformSource?D(s.platformSource):void 0,m=i.length>1?er(l,i,t,_):zt(l,a,t,_),g=d?Jt(m,{tokenBudget:r.injection.tokenBudget,halfLifeDays:r.importance.halfLifeDays,maxRows:c}):m,I=i.length>1?tr(l,i,t,_):Zt(l,a,t,_),O=l.getActiveCheckpoints(i);return g.length>0&&l.markObservationsUsed(g.map(f=>f.id),"injection"),g.length===0&&I.length===0&&O.length===0?{text:xn(a,e),stats:null}:{text:Pn(a,g,I,O,t,n,s?.session_id,e),stats:kn(g,I,!!s?.full)}}finally{l.close()}}async function as(s,e=!1){return(await dt(s,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
