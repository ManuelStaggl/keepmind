...
// turns to a single shared markdown file (default ~/.keepmind/STANDUP.md).
...
//   --file <path>   | STANDUP_FILE  | ~/.keepmind/STANDUP.md
...
function defaultFile() {
  return (
    ...
    join(homedir(), ".keepmind", "STANDUP.md")
  );
}
...
file defaults to ~/.keepmind/STANDUP.md; override with --file or STANDUP_FILE.`;
